...
Begin VB.Form M_FRM_PCS 
   ...
   Begin MSComctlLib.Toolbar Toolbar1 
      ...
      Begin VB.ListBox text1 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRM_PCS (PCS).frx":0442
         Left            =   7080
         List            =   "M_FRM_PCS (PCS).frx":045B
         TabIndex        =   104
         TabStop         =   0   'False
         Top             =   50
         Visible         =   0   'False
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "M_FRM_PCS (PCS).frx":049F
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "Label20"
      Tab(0).Control(1)=   "Label19"
      Tab(0).Control(2)=   "M_DBT_MCL"
      ...
      Tab(0).Control(13)=   "M_PRV_NUM"
      Tab(0).Control(14)=   "M_CST_NME"
      Tab(0).Control(15)=   "M_CST_AD1"
      Tab(0).Control(16)=   "M_CST_AD2"
      Tab(0).Control(17)=   "M_CST_AD3"
      Tab(0).Control(18)=   "M_CST_AD4"
      Tab(0).Control(19)=   "M_SMN_NME"
      Tab(0).Control(20)=   "M_ACT_NME"
      Tab(0).Control(21)=   "Line1(0)"
      Tab(0).Control(22)=   "Line2(0)"
      Tab(0).Control(23)=   "Shape1"
      Tab(0).Control(24)=   "Shape2"
      Tab(0).Control(25)=   "DBT_MCP"
      Tab(0).Control(26)=   "M_DBT_MCP"
      Tab(0).Control(27)=   "M_INV_DAT"
      Tab(0).Control(28)=   "M_INV_IDY"
      Tab(0).Control(28).Enabled=   0   'False
      Tab(0).Control(29)=   "M_DCH_DAT"
      Tab(0).Control(30)=   "M_DCH_IDY"
      Tab(0).Control(30).Enabled=   0   'False
      Tab(0).Control(31)=   "M_ACT_IDY"
      Tab(0).Control(31).Enabled=   0   'False
      Tab(0).Control(32)=   "M_SMN_IDY"
      Tab(0).Control(32).Enabled=   0   'False
      Tab(0).Control(33)=   "M_CST_IDY"
      Tab(0).Control(33).Enabled=   0   'False
      Tab(0).Control(34)=   "ImageList1"
      Tab(0).ControlCount=   35
      TabCaption(1)   =   "&Products"
      TabPicture(1)   =   "M_FRM_PCS (PCS).frx":04BB
      ...
      Tab(1).Control(4)=   "List6"
      Tab(1).Control(4).Enabled=   0   'False
      Tab(1).ControlCount=   5
      TabCaption(2)   =   "&Taxes and  Levies"
      TabPicture(2)   =   "M_FRM_PCS (PCS).frx":04D7
      ...
      TabPicture(3)   =   "M_FRM_PCS (PCS).frx":04F3
      ...
      TabCaption(4)   =   "View"
      TabPicture(4)   =   "M_FRM_PCS (PCS).frx":050F
      ...
      Begin VB.ListBox List6 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRM_PCS (PCS).frx":052B
         Left            =   2040
         List            =   "M_FRM_PCS (PCS).frx":0538
         TabIndex        =   65
         TabStop         =   0   'False
         Top             =   720
         Visible         =   0   'False
      ...
      Begin VB.ListBox M_ROU_IDY 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRM_PCS (PCS).frx":0545
         Left            =   -70080
         List            =   "M_FRM_PCS (PCS).frx":05B5
         TabIndex        =   61
         TabStop         =   0   'False
         Top             =   2640
         Width           =   495
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_PCS (PCS).frx":0625
               Key             =   "p"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_PCS (PCS).frx":0B69
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_PCS (PCS).frx":0F31
               Key             =   "c"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_PCS (PCS).frx":1285
               Key             =   "e"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_PCS (PCS).frx":18BD
               Key             =   "s"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_PCS (PCS).frx":1C11
               Key             =   "h"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_PCS (PCS).frx":2071
               Key             =   ""
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_PCS (PCS).frx":2365
               Key             =   "pr"
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_PCS (PCS).frx":2771
               Key             =   "d"
            EndProperty
            BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_PCS (PCS).frx":287D
               Key             =   "pre"
            EndProperty
            BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_PCS (PCS).frx":2BD1
               Key             =   "brw"
            EndProperty
            BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_PCS (PCS).frx":2FE5
               Key             =   "cpy"
            EndProperty
            BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_PCS (PCS).frx":3531
               Key             =   ""
            EndProperty
         EndProperty
      End
...
M_CSD_AMT = convert(amt(Round(M_PRD_AMT * M_CSD_PCG / 100, 2)))
M_CSD_DED = convert(amt(Round((M_GRS_AMT - M_CSD_AMT), 2)))
M_SPD_AMT = convert(amt(Round(M_CSD_DED * M_SPD_PCG / 100, 2)))
...
REC_SET.Open "SELECT * FROM PRD", con, adOpenKeyset, adLockOptimistic
For A = 1 To MS.Rows - 1
    If Trim(MS.TextMatrix(A, 0)) <> "" Then
        REC_SET.Find "PRD_IDY='" & Trim(MS.TextMatrix(A, 0)) & "'"
        If REC_SET.EOF = False Then
            CUR_UNT = P_SUB_UNT(QTY(REC_SET("CUR_LEV") & ""), REC_SET("SUB_UNT"))
            INV_UNT = P_SUB_UNT(QTY(MS.TextMatrix(A, 2)), REC_SET("SUB_UNT"))
            If (Val(CUR_UNT) - Val(INV_UNT)) < 0 Then
            MsgBox "Stock Out of Range", vbInformation
            SSTab1.Tab = 1
            MS.Row = A
            MS.SetFocus
            Exit Sub
...
If MOD_REC = True Then
    If REC_SET.State = 1 Then REC_SET.Close
    con.BeginTrans
    REC_SET.Open "select * from inv where inv_idy like '" & Sincrement(M_INV_IDY) & "' and txn_typ like 'LSL'", con, adOpenKeyset
    For A = 1 To REC_SET.RecordCount
        con.Execute "update prd where prd_idy like '" & REC_SET("prd_idy") & "' set cur_lev = " & ADDQTY(Val(REC_SET("ISS_qty")), REC_SET("prd_idy"))
        REC_SET.MoveNext
    Next
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "SELECT * FROM PRD", con, adOpenKeyset, adLockOptimistic
    ...
    Next
    con.CommitTrans
    con.Execute "delete from inv where inv_idy like '" & Sincrement(M_INV_IDY) & "' and txn_typ like 'LSL'"
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from inl where inv_idy like '" & Sincrement(M_INV_IDY) & "' and txn_typ like 'LSL'", con, adOpenKeyset, adLockOptimistic
    INC = Sincrement(M_INV_IDY)
Else
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from inl", con, adOpenKeyset, adLockOptimistic
    REC_SET.AddNew
    REC_SET("inv_idy") = "LSL" & T7increment("IDY_LSL")
    INC = REC_SET("inv_idy")
    INVIDY = INC
End If
...
For A = 1 To MS.Rows - 1
    If Trim(MS.TextMatrix(A, 0)) <> "" Then
        ...
        REC_SET("prd_qty") = QTY(Val(MS.TextMatrix(A, 4)))
        REC_SET("prd_rat") = convert(amt(Val(MS.TextMatrix(A, 7))))
        If Len(Trim(MS.TextMatrix(A, 6))) <> 0 Then
            REC_SET("rat_app") = MS.TextMatrix(A, 6) & ""
        Else
            REC_SET("rat_app") = "A"
        End If
        REC_SET("OPN_QTY") = QTY(MS.TextMatrix(A, 1))
        REC_SET("ISS_QTY") = QTY(MS.TextMatrix(A, 2))
        REC_SET("TOT_QTY") = QTY(MS.TextMatrix(A, 3))
        REC_SET("RET_QTY") = QTY(MS.TextMatrix(A, 5))
        REC_SET("txn_typ") = "LSL"
        REC_SET("COL_AMT") = convert(amt(MS.TextMatrix(A, 8)))
        REC_SET.Update
        con.Execute "update prd where prd_idy like '" & Trim(MS.TextMatrix(A, 0)) & "' set cur_lev = " & CONQTY(Trim(MS.TextMatrix(A, 2)), Trim(MS.TextMatrix(A, 0)))
    End If
Next
If MOD_REC = False Then MsgBox "New Cash Sales ID is " & INC, vbExclamation, "Effmcg"
M_PRV_NUM = labdisp("IDY_LSL")
If check("PRT", "PRT_NME", "M_FRM_PCS") = True Then
    con.Execute "update dir where dir_idy like 'INV' AND DIR_IDX LIKE 'NUM' set dir_als = '" & INC & "'"
    con.Execute "update dir where dir_idy like 'DOC' AND DIR_IDX LIKE 'TYP' set dir_als = 'LSL'"
...
If Check1.Value = 1 Then
    If Toolbar1.Buttons(31).Value = tbrPressed And Toolbar1.Buttons(30).Value = 1 Then
        REC_SET.Open "select ACT.*,MAR.MAR_NME,act.ROU_IDY,smn.smn_nme from act,MAR,smn where (act.ACT_TYP LIKE 'BOT' OR act.ACT_TYP LIKE 'SAL') and act_nme like '" & Trim(M_CST_IDY) & "%' AND ACT.MAR_IDY LIKE MAR.MAR_IDY AND ACT.SMN_IDY LIKE SMN.SMN_IDY AND MAR_VDA LIKE '" & UCase(Text1) & "' AND SMN.SMN_IDY LIKE '" & Trim(Text2) & "'", con, adOpenKeyset, adLockOptimistic
    ElseIf Toolbar1.Buttons(31).Value = 1 Then
        REC_SET.Open "select ACT.*,MAR.MAR_NME,act.ROU_IDY,smn.smn_nme from act,MAR,smn where (act.ACT_TYP LIKE 'BOT' OR act.ACT_TYP LIKE 'SAL') and act_NME like '" & Trim(M_CST_IDY) & "%' AND ACT.MAR_IDY LIKE MAR.MAR_IDY AND ACT.SMN_IDY LIKE SMN.SMN_IDY AND MAR_VDA LIKE '" & UCase(Text1) & "'", con, adOpenKeyset, adLockOptimistic
    ElseIf Toolbar1.Buttons(30).Value = 1 Then
        REC_SET.Open "select ACT.*,MAR.MAR_NME,act.ROU_IDY,smn.smn_nme from act,MAR,smn where (act.ACT_TYP LIKE 'BOT' OR act.ACT_TYP LIKE 'SAL') and act_NME like '" & Trim(M_CST_IDY) & "%' AND ACT.MAR_IDY LIKE MAR.MAR_IDY AND ACT.SMN_IDY LIKE SMN.SMN_IDY AND SMN.SMN_IDY LIKE '" & Trim(Text2) & "'", con, adOpenKeyset, adLockOptimistic
    Else
        REC_SET.Open "select ACT.*,MAR.MAR_NME,act.ROU_IDY,smn.smn_nme from act,MAR,smn where (ACT_TYP LIKE 'BOT' OR ACT_TYP LIKE 'SAL') and act_nme like '" & Trim(M_CST_IDY) & "%' AND ACT.MAR_IDY LIKE MAR.MAR_IDY AND ACT.SMN_IDY LIKE SMN.SMN_IDY", con, adOpenKeyset, adLockOptimistic
    End If
ElseIf Check2.Value = 1 Then
    If Toolbar1.Buttons(31).Value = tbrPressed And Toolbar1.Buttons(30).Value = 1 Then
        REC_SET.Open "select ACT.*,MAR.MAR_NME,act.ROU_IDY,smn.smn_nme from act,MAR,smn where (act.ACT_TYP LIKE 'BOT' OR act.ACT_TYP LIKE 'SAL') and act_ad4 like '" & Trim(M_CST_IDY) & "%' AND ACT.MAR_IDY LIKE MAR.MAR_IDY AND ACT.SMN_IDY LIKE SMN.SMN_IDY AND MAR_VDA LIKE '" & UCase(Text1) & "' AND SMN.SMN_IDY LIKE '" & Trim(Text2) & "'", con, adOpenKeyset, adLockOptimistic
    ElseIf Toolbar1.Buttons(31).Value = 1 Then
        REC_SET.Open "select ACT.*,MAR.MAR_NME,act.ROU_IDY,smn.smn_nme from act,MAR,smn where (act.ACT_TYP LIKE 'BOT' OR ACT_TYP LIKE 'SAL') and act_ad4 like '" & Trim(M_CST_IDY) & "%' AND ACT.MAR_IDY LIKE MAR.MAR_IDY AND ACT.SMN_IDY LIKE SMN.SMN_IDY AND MAR.MAR_VDA LIKE '" & UCase(Text1) & "'", con, adOpenKeyset, adLockOptimistic
    ElseIf Toolbar1.Buttons(30).Value = 1 Then
        REC_SET.Open "select ACT.*,MAR.MAR_NME,act.ROU_IDY,smn.smn_nme from act,MAR,smn where (act.ACT_TYP LIKE 'BOT' OR act.ACT_TYP LIKE 'SAL') and act_ad4 like '" & Trim(M_CST_IDY) & "%' AND ACT.MAR_IDY LIKE MAR.MAR_IDY AND ACT.SMN_IDY LIKE SMN.SMN_IDY AND SMN.SMN_IDY LIKE '" & Trim(Text2) & "'", con, adOpenKeyset, adLockOptimistic
    Else
        REC_SET.Open "select ACT.*,MAR.MAR_NME,act.ROU_IDY,smn.smn_nme from act,MAR,smn where (act.ACT_TYP LIKE 'BOT' OR ACT_TYP LIKE 'SAL') and act_ad4 like '" & Trim(M_CST_IDY) & "%' AND ACT.MAR_IDY LIKE MAR.MAR_IDY AND ACT.SMN_IDY LIKE SMN.SMN_IDY", con, adOpenKeyset, adLockOptimistic
    End If
End If
...
If KeyAscii = 13 Then
    ...
    If REC_SET.RecordCount > 0 Then
        If List6 = "A" Then
            MS.TextMatrix(MS.Row, 7) = amt(REC_SET("pur_rat") & "")
        ElseIf List6 = "B" Then
            MS.TextMatrix(MS.Row, 7) = amt(REC_SET("sal_rat") & "")
        ElseIf List6 = "C" Then
            MS.TextMatrix(MS.Row, 7) = amt(REC_SET("mrp_rat") & "")
        End If
    End If
    P_DIS_CAL
    MS.Col = 8
...
If k = 13 Or k = 40 Or k = 38 Then
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from act where act_idy like '" & Sincrement(Trim(M_CST_IDY)) & "' AND (ACT_TYP LIKE 'BOT' OR ACT_TYP LIKE 'SAL')", con, adOpenKeyset, adLockOptimistic
    If REC_SET.RecordCount > 0 Then
        If MOD_REC = True And Trim(dlr_idy) = Trim(M_CST_IDY) Then
        ElseIf MOD_REC = False Then
        Else
            MsgBox "Cannot Change Party...!", vbExclamation, "Effmcg"
            SSTab1.Tab = 0
            M_CST_IDY.SetFocus
            M_CST_IDY = Trim(dlr_idy)
            Exit Sub
        End If
...
If REC_SET.State = 1 Then REC_SET.Close
If Check1.Value = 1 Then
REC_SET.Open "select inl.inv_idy,inl.inv_dat,act.act_nme,act.act_ad4 from act,inl where act_nme like '" & Trim(M_INV_IDY) & "%' and inl.cst_idy=act.act_idy and inl.txn_typ ='LSL' and ord_idy like '1'", con, adOpenKeyset, adLockOptimistic
Else
REC_SET.Open "select inl.inv_idy,inl.inv_dat,act.act_nme,act.act_ad4 from act,inl where act_ad4 like '" & Trim(M_INV_IDY) & "%' and inl.cst_idy=act.act_idy and inl.txn_typ ='LSL' and ord_idy like '1'", con, adOpenKeyset, adLockOptimistic
End If
...
If REC_SET.RecordCount > 0 Then
    ...
    Next
    SSTab1.Tab = 4
    V_LST_CAP = "Select Push Cart Challan"
    list5.Visible = True
    list5.SetFocus
Else
    If SSTab1.Tab = 0 Then
...
If list1.Visible = False And list2.Visible = False And LIST3.Visible = False And list4.Visible = False And list5.Visible = False Then
    ...
    If KeyCode = 69 And Shift = 2 Then
        ...
        If M_FRM_PCS.ActiveControl.name = "M_INV_IDY" Then
            V_INV_LST
        ElseIf M_FRM_PCS.ActiveControl.name = "M_CST_IDY" Then
            V_DLR_LST
        ElseIf M_FRM_PCS.ActiveControl.name = "M_SMN_IDY" Then
            V_SMN_LST
        ElseIf M_FRM_PCS.ActiveControl.name = "M_ACT_IDY" Then
            V_ACT_LST
        ElseIf M_FRM_PCS.ActiveControl.name = "Text3" Then
            V_PRD_LST
        End If
    End If
End If
If KeyCode > 111 And KeyCode < 120 Then If TypeOf M_FRM_PCS.ActiveControl Is TextBox Then M_FRM_PCS.ActiveControl.Text = FUNKEY(KeyCode)
End Sub
...
MS.TextMatrix(0, 1) = "Opg.Stk"
MS.TextMatrix(0, 2) = "New Stk"
MS.TextMatrix(0, 3) = "Tot.Stk"
MS.TextMatrix(0, 4) = "Sal.Stk"
MS.TextMatrix(0, 5) = "Cls.Stk"
MS.TextMatrix(0, 6) = "Rate ID"
MS.TextMatrix(0, 7) = "Rate"
MS.TextMatrix(0, 8) = "Amount"
MS.TextMatrix(0, 9) = "Product Name"
MS.TextMatrix(0, 10) = "  Short Name"
...
If KeyAscii = 13 Then
If V_LST_CAP = "Select Push Cart Challan" Then
    Dim RS As New ADODB.Recordset
    RS.Open "select * from inv,PRD where inv_idy like '" & Trim(list5.SelectedItem) & "' and txn_typ like 'LSL' AND PRD.PRD_IDY LIKE INV.PRD_IDY", con, adOpenKeyset, adLockOptimistic
    If RS.RecordCount > 0 Then
        MS.Rows = 1
        For A = 1 To RS.RecordCount
            MS.AddItem ""
            MS.TextMatrix(A, 0) = Trim(RS("PRD_IDY") & "")
            MS.TextMatrix(A, 1) = QTY(RS("RET_QTY") & "")
            MS.TextMatrix(A, 3) = QTY(RS("RET_QTY") & "")
            MS.TextMatrix(A, 6) = Trim(RS("RAT_APP") & "")
            MS.TextMatrix(A, 7) = convert(amt((RS("PRD_RAT") & "")))
            MS.TextMatrix(A, 9) = Trim(RS("PRD_NME") & "")
            MS.TextMatrix(A, 10) = Trim(RS("PRD_PRN") & "")
            RS.MoveNext
        Next
        Toolbar1.Buttons(12).Enabled = False
        SSTab1.Tab = 1
...
M_FRM_PRE.Caption = "Prefix Cash Sales"
M_FRM_PRE.Show 1
...
ElseIf Button.KEY = "ed" Then
    ...
    ElseIf M_FRM_PCS.ActiveControl.name = "M_ACT_IDY" Then
        V_LST_CAP = "Select Account"
        V_ACT_LST
    ElseIf M_FRM_PCS.ActiveControl.name = "Text3" Or (MS.Col = 0 And SSTab1.Tab = 1) Then
        V_PRD_LST
    End If
...
If check("prt", "prt_nme", "M_FRM_PCS") = False Then
CHECK3.Value = 0
Else
CHECK3.Value = 1
End If
...
REC_SET.Open "select * from inl where inv_idy like 'LSL" & Tincrement(Trim(M_INV_IDY)) & "' and txn_typ like 'LSL' and ord_idy like '1'", con, adOpenKeyset
Else
REC_SET.Open "select * from inl where inv_idy like '" & Tincrement(Trim(M_INV_IDY)) & "' and txn_typ like 'LSL' and ord_idy like '1'", con, adOpenKeyset
End If
If REC_SET.RecordCount > 0 Then
    If Len(Trim(M_INV_IDY)) <> 10 Then
    M_INV_IDY = "LSL" & Tincrement(Trim(M_INV_IDY))
    End If
    M_INV_IDY.Enabled = False
    MOD_REC = True
    ...
    M_FRT_TYP = discount(Val(REC_SET("EXD_PCG") & ""))
    ...
    End If
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from inv,PRD where PRD.PRD_IDY LIKE INV.PRD_IDY AND inv_idy like '" & Sincrement(M_INV_IDY) & "' and txn_typ = 'LSL'", con, adOpenKeyset, adLockOptimistic
    MS.Rows = REC_SET.RecordCount + 1
    For A = 1 To MS.Rows - 1
        MS.TextMatrix(A, 0) = Trim(REC_SET("prd_idy"))
        MS.TextMatrix(A, 1) = QTY(Val(REC_SET("OPN_QTY")))
        MS.TextMatrix(A, 2) = QTY(Val(REC_SET("ISS_QTY")))
        MS.TextMatrix(A, 3) = QTY(Val(REC_SET("TOT_QTY")))
        MS.TextMatrix(A, 4) = QTY(Val(REC_SET("prd_qty")))
        MS.TextMatrix(A, 5) = QTY(Val(REC_SET("RET_qty")))
        MS.TextMatrix(A, 6) = Trim(REC_SET("rat_app") & "")
        MS.TextMatrix(A, 7) = convert(amt(REC_SET("prd_rat") & ""))
        MS.TextMatrix(A, 9) = Trim(REC_SET("PRD_NME"))
        MS.TextMatrix(A, 10) = Trim(REC_SET("PRD_PRN"))
        REC_SET.MoveNext
    Next
    P_DIS_CAL
    GRS_CAL
...
If MS.Row <> 0 Then
    If MS.Col = 0 Then
        ...
        End If
    ElseIf MS.Col = 1 Or MS.Col = 2 Or MS.Col = 5 Then
    ...
    ElseIf MS.Col = 6 Then
        If MS.TextMatrix(MS.Row, 0) <> "" Then
            ...
            End If
        End If
    ElseIf MS.Col = 8 Or MS.Col = 9 Or MS.Col = 10 Then
        If MS.TextMatrix(MS.Rows - 1, 0) <> "" Then
            MS.AddItem ""
            MS.Col = 0
            MS.Row = MS.Rows - 1
...
ElseIf k = 13 Then
    If MS.Col = 2 Or MS.Col = 1 Then
        ...
        If Trim(M_INV_IDY) <> "" Then
            REC_SET2.Open "select * from inv where prd_idy like '" & Trim(MS.TextMatrix(MS.Row, 0)) & "' and inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ like 'LSL'", con, adOpenKeyset, adLockOptimistic
            If REC_SET2.RecordCount > 0 Then
                invtot = QTY(REC_SET2("ISS_QTY"))
            End If
        End If
        B = InStr(M_FLX_AMT, ".")
        ...
        If B > 0 And Val(REC_SET("sub_unt")) > 0 Then
            ...
            Else
                If MS.Col = 2 Then
                    OPG_UNT = P_SUB_UNT(QTY(MS.TextMatrix(MS.Row, 1)), REC_SET("SUB_UNT"))
                ElseIf MS.Col = 1 Then
                    OPG_UNT = P_SUB_UNT(QTY(MS.TextMatrix(MS.Row, 2)), REC_SET("SUB_UNT"))
                End If
                M_QTY = QTY(M_FLX_AMT)
            End If
        Else
            If Val(MS.TextMatrix(MS.Row, 1)) = 0 Then
                M_QTY = M_FLX_AMT
            Else
                OPG_UNT = P_SUB_UNT(QTY(MS.TextMatrix(MS.Row, 1)), REC_SET("SUB_UNT"))
                NEW_UNT = P_SUB_UNT(QTY(MS.TextMatrix(MS.Row, 2)), REC_SET("SUB_UNT"))
                M_QTY = QTY(M_FLX_AMT)
            End If
        End If
        If REC_SET.RecordCount > 0 Then
            ...
            OPG_UNT = P_SUB_UNT(QTY(MS.TextMatrix(MS.Row, 1)), REC_SET("SUB_UNT"))
            NEW_UNT = P_SUB_UNT(QTY(MS.TextMatrix(MS.Row, 2)), REC_SET("SUB_UNT"))
            MS.TextMatrix(MS.Row, 3) = P_QTY_UNT(Val(OPG_UNT) + Val(NEW_UNT), REC_SET("SUB_UNT"))
            M_FLX_AMT.Visible = False
            If MS.TextMatrix(MS.Rows - 1, 0) <> "" Then
                MS.AddItem ""
                MS.Col = 0
...
ElseIf MS.Col = 5 Then
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select SUB_UNT from PRD where PRD_IDY like '" & Trim(MS.TextMatrix(MS.Row, 0)) & "'", con, adOpenKeyset, adLockOptimistic
    If REC_SET.RecordCount > 0 Then
        TOT_UNT = P_SUB_UNT(QTY(MS.TextMatrix(MS.Row, 3)), REC_SET("SUB_UNT"))
        SAL_UNT = P_SUB_UNT(QTY(M_FLX_AMT), REC_SET("SUB_UNT"))
    End If
    If (Val(TOT_UNT) - Val(SAL_UNT)) < 0 Then
        MsgBox "Invalid Stock", vbInformation
        SendKeys "{home}+{end}"
        M_FLX_AMT.SetFocus
        Exit Sub
    End If
    If MS.Col = 4 Then
        MS.TextMatrix(MS.Row, 5) = P_QTY_UNT(Val(TOT_UNT) - Val(SAL_UNT), REC_SET("SUB_UNT"))
    Else
        MS.TextMatrix(MS.Row, 4) = P_QTY_UNT(Val(TOT_UNT) - Val(SAL_UNT), REC_SET("SUB_UNT"))
    End If
...
If REC_SET.RecordCount > 0 Then
    ...
    MS.TextMatrix(MS.Row, 5) = "0.000"
    MS.TextMatrix(MS.Row, 6) = M_DBT_RAP
    If Trim(M_DBT_RAP) = "A" Then
    MS.TextMatrix(MS.Row, 7) = convert(amt(REC_SET("PUR_rat") & ""))
    ElseIf Trim(M_DBT_RAP) = "B" Then
    MS.TextMatrix(MS.Row, 7) = convert(amt(REC_SET("SAL_rat") & ""))
    ElseIf Trim(M_DBT_RAP) = "C" Then
    MS.TextMatrix(MS.Row, 7) = convert(amt(REC_SET("mrp_rat") & ""))
    Else
    MS.TextMatrix(MS.Row, 7) = convert(amt(REC_SET("SAL_rat") & ""))
    End If
    MS.TextMatrix(MS.Row, 9) = Trim(REC_SET("prd_prn"))
...
For A = 1 To MS.Rows - 1
    ...
    TOT_UNT = P_SUB_UNT(QTY(MS.TextMatrix(A, 3)), REC_SET(0))
    SAL_UNT = P_SUB_UNT(QTY(MS.TextMatrix(A, 4)), REC_SET(0))
    If SAL_UNT > 0 Then
        If (Val(TOT_UNT) - Val(SAL_UNT)) < 0 Then
            MS.TextMatrix(A, 4) = "0.000"
            MS.TextMatrix(A, 5) = "0.000"
        Else
            MS.TextMatrix(A, 5) = P_QTY_UNT(Val(TOT_UNT) - Val(SAL_UNT), REC_SET(0))
        End If
    End If
    If REC_SET.RecordCount > 0 Then
        If Val(REC_SET(0)) > 0 Then
            MS.TextMatrix(A, 8) = RATCAL(Val(MS.TextMatrix(A, 4) & ""), Val(MS.TextMatrix(A, 7) & ""), REC_SET(0))
        Else
            MS.TextMatrix(A, 8) = convert(amt(Round(Val(MS.TextMatrix(A, 4) & "") * Val(MS.TextMatrix(A, 7) & ""), 2)))
        End If
    End If
    M_PRD_AMT = convert(amt(Val(M_PRD_AMT) + MS.TextMatrix(A, 8)))
    End If
Next
...
Dim REC_SET As New ADODB.Recordset
If REC_SET.State = 1 Then REC_SET.Close
REC_SET.Open "select rou_off from inl where inv_idy like '" & Trim(M_INV_IDY) & "' AND TXN_TYP LIKE 'LSL'", con, adOpenKeyset, adLockOptimistic
...
If ButtonMenu.KEY = "dt" Then
    If MOD_REC = True Then
        OpenDocument CURDIR & "\vouch.rp1", "Push Cart Challan", 2, M_INV_IDY, M_INV_IDY, 6, CURDIR & "\inv.cdx,c,inv_idy"
    End If
End If
End Sub
