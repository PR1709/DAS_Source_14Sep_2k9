...
Begin VB.Form M_FRM_AST_OUT 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Asset Outward Entry"
   ClientHeight    =   5625
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   8820
   Icon            =   "M_FRM_AST_OUT.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "M_FRM_AST_OUT.frx":0442
      ...
      Tab(0).Control(11)=   "ptyidy"
      Tab(0).Control(11).Enabled=   0   'False
      Tab(0).Control(12)=   "list1"
      Tab(0).Control(12).Enabled=   0   'False
      Tab(0).ControlCount=   13
      TabCaption(1)   =   "View"
      TabPicture(1)   =   "M_FRM_AST_OUT.frx":045E
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_AST_OUT.frx":047A
            Key             =   "p"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_AST_OUT.frx":09BE
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_AST_OUT.frx":0D86
            Key             =   "c"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_AST_OUT.frx":10DA
            Key             =   "e"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_AST_OUT.frx":1712
            Key             =   "s"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_AST_OUT.frx":1A66
            Key             =   "h"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_AST_OUT.frx":1EC6
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_AST_OUT.frx":21BA
            Key             =   "pr"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_AST_OUT.frx":25C6
            Key             =   "d"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_AST_OUT.frx":26D2
            Key             =   "pre"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_AST_OUT.frx":2A26
            Key             =   "brw"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_AST_OUT.frx":2E3A
            Key             =   "cpy"
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "M_FRM_AST_OUT"
...
If K = 13 Or K = 40 Or K = 38 Then
    ...
    If REC_SET.RecordCount > 0 Then
        ...
        If Trim(REC_SET!ind_idy) = "Y" And MOD1 = False Then
            indidy = "Y"
            LOADASSETS
            list1.SetFocus
            Exit Sub
        ElseIf Trim(REC_SET!ind_idy) = "Y" And MOD1 = True Then
            indidy = "Y"
            list1.SetFocus
            Exit Sub
        End If
...
If K = 13 Or K = 40 Or K = 38 Then
    ...
    Else
        ...
        rs.Open "SELECT * FROM ASM WHERE ASM_IDY LIKE '" & Trim(ASTIDY) & "'", con, adOpenKeyset, adLockPessimistic
        If rs.RecordCount > 0 Then
            If Val(astqty) > Val(rs!ASM_QTY & "") Then
...
If K > 111 And K < 120 Then If TypeOf M_FRM_AST_OUT.ActiveControl Is TextBox Then M_FRM_AST_OUT.ActiveControl.Text = Trim(FUNKEY(K))
...
ElseIf K = 80 And s = 2 Then
    ...
    If check("PRT", "PRT_NME", "M_FRM_AST_OUT") = True Then M_FRM_PRV.Check3.Value = 1
    M_FRM_PRV.Show 1
...
If KeyAscii = 13 Then
    If list4.ListItems.count > 0 Then
        ...
        ElseIf Label20.Caption = "Select Asset" Then
            ...
            If list4.SelectedItem.ListSubItems.Item(3) = "Y" And MOD1 = False Then
                indidy = "Y"
                LOADASSETS
                SSTab1.Tab = 0
                list4.Visible = False
                list1.SetFocus
                Exit Sub
            ElseIf Trim(list4.SelectedItem.ListSubItems.Item(3)) = "Y" And MOD1 = True Then
                indidy = "Y"
                SSTab1.Tab = 0
                list4.Visible = False
                list1.SetFocus
...
list4.ColumnHeaders.Add , , "Company ID", 1500
...
SAL_QRY = "AST->TXN_TYP = 'AOU'"
OpenReport CURDIR & "\Assets.RP1", "Asset Outward Entry", 2, SAL_QRY, 6
End Sub
...
If MsgBox("Confirm Transaction Save?", vbQuestion + vbYesNo, "DAS Version 4.0") = vbNo Then
    ...
    Exit Sub
End If
If CHECKTB("asm.dbf,act.dbf,ast.dbf,prt.dbf") = 1 Then
    MsgBox UCase(TNAME) & " Missing in " & Me.Caption
    cancel
    Exit Sub
End If
...
If MOD1 = True Then
    ...
    GoTo n
End If
STK = GetValue("asm_qty", "asm where asM_idy like '" & Trim(ASTIDY) & "'")
If Val(STK) < Val(astqty) Then
    MsgBox "Stock Out of Range, Check Stock", vbExclamation
    SendKeys "{home}+{end}"
    astqty.SetFocus
Exit Sub
...
INC = "AOU" & T7increment("IDY_AOU")
If indidy = "Y" Then
    For CTR = 1 To list1.ListItems.count
        If list1.ListItems.Item(CTR).Checked = True Then
            CTR1 = CTR1 + 1
            rs.AddNew
            rs("TXN_IDY") = INC
            ...
            rs("ASM_COD") = Trim(list1.ListItems.Item(CTR).Text)
            rs("AST_QTY") = 1
            rs!chk_flg = "Y"
            rs!TXN_TYP = "AOU"
            rs!AST_IDY = ""
...
Else
    con.Execute "UPDATE ASM SET ASM_QTY= ASM_QTY - " & Val(CTR1) & "WHERE ASM_IDY LIKE '" & Trim(ASTIDY) & "'"
End If
MsgBox "New Transaction ID " & INC, vbExclamation
n:
cancel
If check("PRT", "PRT_NME", "M_FRM_AST_OUT") = True Then OpenDocument CURDIR & "\VOUCH.RP1", "New Assets Outward Voucher", 2, Trim(INC), Trim(INC), 6, CURDIR & "\AST.cdx,c,TXN_IDY"
End Sub
...
If Len(Trim(TXNIDY)) <> 10 Then
    rs.Open "select * from AST where txn_idy like 'AOU" & Tincrement(TXNIDY) & "' and txn_typ like 'AOU'", con, adOpenStatic
Else
    rs.Open "select * from AST where txn_idy like '" & Trim(TXNIDY) & "' and txn_typ like 'AOU'", con, adOpenStatic
End If
If rs.RecordCount > 0 Then
    If Len(Trim(TXNIDY)) <> 10 Then TXNIDY = "AOU" & Tincrement(TXNIDY)
    MOD1 = True
    ...
    If rs!chk_flg = "Y" Then
        indidy = rs!chk_flg
        list1.CheckBoxes = False
        For A = 1 To rs.RecordCount
            list1.ListItems.Add , , Trim(rs!asm_cod)
            rs.MoveNext
        Next
        astqty.Enabled = False
    Else
...
Dim rs As New ADODB.Recordset
If rs.State = 1 Then rs.Close
rs.Open "select ast.txn_idy,ast.txn_dat,act_nme,asm_nme from ast,act,asm where ast.txn_typ like 'AOU' and act.act_idy like AST.PTY_idy AND AST.ASM_IDY LIKE ASM.ASM_IDY GROUP BY TXN_IDY", con, adOpenKeyset, adLockPessimistic
list4.ListItems.CLEAR
list4.ColumnHeaders.CLEAR
...
If CHECKTB("ast.dbf") = 1 Then
    MsgBox UCase(TNAME) & " Missing in " & Me.Caption
    cancel
    Exit Sub
End If
list1.CheckBoxes = True
list1.ListItems.CLEAR
list1.ColumnHeaders.CLEAR
list1.ColumnHeaders.Add , , "ID", list1.Width - 50
Dim rs As New ADODB.Recordset
