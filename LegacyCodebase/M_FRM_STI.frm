...
Begin VB.Form M_FRM_STI 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Unplanned Receipt - Stock Transfer Inward Entry"
   ClientHeight    =   5625
   ClientLeft      =   1455
   ClientTop       =   330
   ClientWidth     =   8820
   ForeColor       =   &H00FFFFFF&
   Icon            =   "M_FRM_STI.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "M_FRM_STI.frx":0442
      ...
      TabPicture(1)   =   "M_FRM_STI.frx":045E
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "List7"
      ...
      TabPicture(2)   =   "M_FRM_STI.frx":047A
      ...
      TabPicture(3)   =   "M_FRM_STI.frx":0496
      ...
      TabCaption(4)   =   "View"
      TabPicture(4)   =   "M_FRM_STI.frx":04B2
      ...
      Begin VB.ListBox List7 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRM_STI.frx":04CE
         Left            =   -71640
         List            =   "M_FRM_STI.frx":04E1
         TabIndex        =   133
         TabStop         =   0   'False
         Top             =   1080
         Visible         =   0   'False
      ...
      Begin VB.ListBox List6 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRM_STI.frx":050F
         Left            =   -72960
         List            =   "M_FRM_STI.frx":0511
         TabIndex        =   27
         TabStop         =   0   'False
         Top             =   720
         Visible         =   0   'False
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_STI.frx":0513
            Key             =   "p"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_STI.frx":0A57
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_STI.frx":0E1F
            Key             =   "c"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_STI.frx":1173
            Key             =   "e"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_STI.frx":17AB
            Key             =   "s"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_STI.frx":1AFF
            Key             =   "h"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_STI.frx":1F5F
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_STI.frx":2253
            Key             =   "pr"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_STI.frx":265F
            Key             =   "d"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_STI.frx":276B
            Key             =   "pre"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_STI.frx":2ABF
            Key             =   "brw"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_STI.frx":2ED3
            Key             =   "cpy"
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_STI.frx":341F
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Else
    ...
    End If
End If
If CHECKTB("act.dbf,inv.dbf,inl.dbf,pnv.dbf,pnl.dbf,prd.dbf,brd.dbf,dir.dbf,rri.dbf,mar.dbf,smn.dbf,loc.dbf,cat.dbf") = 1 Then
...
If check("act", "(grp_clf like 'Stock Receipts ' and ACT_TYP LIKE '') AND act_idy", Trim(M_ACT_IDY)) = False Then
    MsgBox "Stock Receipts Account Not Found, Define Account of Type Stock Receipts!", vbExclamation, "DAS Version 4.0"
    M_ACT_IDY.SetFocus
    SSTab1.Tab = 0
    Exit Sub
End If
...
If Val(T_NET_AMT) < 0 Then
    MsgBox "Can't Save this Voucher, Invalid Net Amount!", vbExclamation, "DAS Version 4.0"
    SSTab1.Tab = 2
    M_EXD_AMT.SetFocus
    Exit Sub
End If
...
If MOD_REC = True Then
    If Check3.Value = 1 Then
        ...
        REC_SET.Open "select * from inv where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ like 'STI'", con, adOpenKeyset
        ...
        Next
    End If
    TxnMoveBackup "INV", "BNV", Trim(M_INV_IDY), "STI"
    TxnMoveBackup "INL", "BNL", Trim(M_INV_IDY), "STI"
    
    con.Execute "delete from inv where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ like 'STI'"
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from inl where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ like 'STI'", con, adOpenKeyset, adLockPessimistic
    INC = Trim(M_INV_IDY)
Else
    REC_SET.Open "select * from inl where inv_idy = ''", con, adOpenKeyset, adLockPessimistic
    REC_SET.AddNew
    REC_SET("inv_idy") = "STI" & T7increment("IDY_STI")
    INC = REC_SET("inv_idy")
    INVIDY = INC
End If
...
If MOD_REC = True Then
    TxnMoveBackup "PNV", "XNV", Trim(INC), "STI"
    TxnMoveBackup "PNL", "XNL", Trim(INC), "STI"
...
For A = 1 To MS.Rows - 1
    If Trim(MS.TextMatrix(A, 0)) <> "" And Val(MS.TextMatrix(A, 1)) > 0 Then
        ...
        INCAMT = RATCAL(Val(MS.TextMatrix(A, 1) & ""), Val(MS.TextMatrix(A, 22) & ""), Val(MS.TextMatrix(A, 12)))
        ...
        REC_SET("TAX_AMT") = Val(Val(TRDTAX & ""))
        REC_SET("txn_typ") = "STI"
        ...
        REC_SET("COL_AMT") = Val((MS.TextMatrix(A, 7)))
        REC_SET("STK_TYP") = Trim(MS.TextMatrix(A, 21))
        REC_SET("LST_RAT") = Trim(MS.TextMatrix(A, 24))
        REC_SET("LST_DIS") = Trim(MS.TextMatrix(A, 25))
        REC_SET("CPN_AMT") = Round(Val(M_CPN_AMT), 2)
        If Check3.Value = 1 Then
            REC_SET!stk_upd = "Y"
        Else
            REC_SET!stk_upd = "N"
...
For A = 1 To MS.Rows - 1
    If Trim(MS.TextMatrix(A, 0)) <> "" And Val(MS.TextMatrix(A, 1)) > 0 Then
        ...
        REC_PNL("COL_AMT") = Val(MS.TextMatrix(A, 7))
        REC_PNL("LST_RAT") = Val(MS.TextMatrix(A, 24))
        REC_PNL("LST_DIS") = Val(MS.TextMatrix(A, 25))
        If Check3.Value = 1 Then
            REC_PNL!stk_upd = "Y"
        Else
            REC_PNL!stk_upd = "N"
        ...
        REC_PNL("rat_app") = ""
        REC_PNL("cpn_rat") = 0
        REC_PNL("cpn_amt") = Round(Val(M_CPN_AMT), 2)
        REC_PNL("add_dis") = 0
        REC_PNL("fst_flg") = ""
        REC_PNL("opn_qty") = 0
        REC_PNL("sch_amt") = 0
    ...
    End If
Next
AddShells Trim(INC), "STI", M_SUP_IDY, "Y", "", ""
If MOD_REC = False Then MsgBox "New Stock Receipts Voucher ID is " & INC, vbExclamation, "DAS Version 4.0"
If check("PRT", "PRT_NME", "STI_SHL") Then LOADSHELLS "STI", Trim(INC)
'pnv update close
Label23 = labdisp("IDY_STI")
If check("PRT", "PRT_NME", "M_FRM_STI") = True Then
    con.Execute "update dir where dir_idy like 'INV' AND DIR_IDX LIKE 'NUM' set dir_als = '" & INC & "'"
    con.Execute "update dir where dir_idy like 'DOC' AND DIR_IDX LIKE 'TYP' set dir_als = 'STI'"
        If querycheck("DIR", "DIR_MSG", "D", "AND DIR_IDY LIKE 'SYS' AND DIR_IDX LIKE 'DOS'") = True Then
        If REC_PNL.State = 1 Then REC_PNL.Close
        REC_PNL.Open "SELECT * FROM RRI WHERE RI_REPORT LIKE 'Transfer Inward Note'", PNL, adOpenKeyset, adLockPessimistic
    ...
    Else
        OpenDocument CURDIR & "\DOS_VCH.RP1", "Transfer Inward Note", 2, Trim(INC), Trim(INC), 6, CURDIR & "\pnv.cdx,c,inv_idy"
    End If
    CANCELRECORD
End If
CANCELRECORD
...
If Check1.Value = 1 Then
    'REC_SET.Open "select * from act where (ACT_TYP LIKE 'BOT' OR ACT_TYP LIKE 'SAL' OR ACT_TYP LIKE 'PUR') and act_nme like '" & Trim(M_SUP_IDY) & "%' AND DBT_TYP='Y'", CON, adOpenKeyset, adlockpessimistic
    REC_SET.Open "SELECT * FROM ACT WHERE ACT_NME LIKE '" & Trim(M_SUP_IDY) & "%'", con, adOpenKeyset, adLockPessimistic
    '(ACT_TYP LIKE 'BOT' OR ACT_TYP LIKE 'SAL' OR ACT_TYP LIKE 'PUR') and act_nme like '" & Trim(M_SUP_IDY) & "%' AND DBT_TYP='Y'", CON, adOpenKeyset, adlockpessimistic
ElseIf Check2.Value = 1 Then
    'REC_SET.Open "select * from act where (ACT_TYP LIKE 'BOT' OR ACT_TYP LIKE 'SAL' OR ACT_TYP LIKE 'PUR') and act_ad4 like '" & Trim(M_SUP_IDY) & "%' AND DBT_TYP='Y'", CON, adOpenKeyset, adlockpessimistic
...
If REC_SET.State = 1 Then REC_SET.Close
If Check1.Value = 1 Then
    REC_SET.Open "select * from act where grp_clf like 'Stock Receipts ' and ACT_NME LIKE '" & Trim(M_ACT_IDY) & "%' and ACT_TYP LIKE '' ", con, adOpenKeyset, adLockPessimistic
Else
    REC_SET.Open "select * from act where grp_clf like 'Stock Receipts ' and ACT_AD4 LIKE '" & Trim(M_ACT_IDY) & "%' and ACT_TYP LIKE '' ", con, adOpenKeyset, adLockPessimistic
End If
...
If K = 13 Then
    For A = 1 To MS.Rows - 1
        If MS.TextMatrix(MS.Row, 13) = MS.TextMatrix(A, 13) And Trim(List7) = MS.TextMatrix(A, 21) And A <> MS.Row Then
            SSTab1.Tab = 1
            list4.Visible = False
...
If KeyAscii = 13 Then
    ...
    If REC_SET.RecordCount > 0 Then
        ...
        End If
    End If
    MS.TextMatrix(MS.Row, 24) = amt(REC_SET("LST_RAT") & "")
    MS.TextMatrix(MS.Row, 25) = amt(REC_SET("LST_DIS") & "")
    P_DIS_CAL
    MS.Col = 10
    MS.SetFocus
End If
...
M_MDI.STS_BAR.Panels(1).Text = "Enter Stock Receipts  Account ID or Press <Enter> to View Existing Accounts"
End Sub
...
If K = 13 Or K = 40 Or K = 38 Then
    ...
    End If
    If REC_SET.State = 1 Then REC_SET.Close
    'REC_SET.Open "select * from act where act_idy like '" & Sincrement(Trim(M_SUP_IDY)) & "' AND (ACT_TYP LIKE 'BOT' OR ACT_TYP LIKE 'SAL' OR ACT_TYP LIKE 'PUR') AND DBT_TYP='Y'", CON, adOpenKeyset, adlockpessimistic
...
If REC_SET.State = 1 Then REC_SET.Close
If Check1.Value = 1 Then
REC_SET.Open "select inl.inv_idy,inl.inv_dat,act.act_nme,act.act_ad4 from act,inl where act_nme like '" & Trim(M_INV_IDY) & "%' and inl.cst_idy=act.act_idy and inl.txn_typ ='STI'", con, adOpenKeyset, adLockPessimistic
Else
REC_SET.Open "select inl.inv_idy,inl.inv_dat,act.act_nme,act.act_ad4 from act,inl where act_ad4 like '" & Trim(M_INV_IDY) & "%' and inl.cst_idy=act.act_idy and inl.txn_typ ='STI'", con, adOpenKeyset, adLockPessimistic
End If
...
If list1.Visible = False And list2.Visible = False And list3.Visible = False And list4.Visible = False And list5.Visible = False Then
    ...
    If KeyCode = 69 And Shift = 2 Then
        ...
        If M_FRM_STI.ActiveControl.name = "M_INV_IDY" Then
            V_INV_LST
        ElseIf M_FRM_STI.ActiveControl.name = "M_SUP_IDY" Then
            V_SUP_LST
        ElseIf M_FRM_STI.ActiveControl.name = "M_SMN_IDY" Then
            V_SMN_LST
        ElseIf M_FRM_STI.ActiveControl.name = "M_ACT_IDY" Then
            V_ACT_LST
        ElseIf M_FRM_STI.ActiveControl.name = "Text3" Then
            V_PRD_LST
        End If
    End If
End If
If KeyCode > 111 And KeyCode < 120 Then If TypeOf M_FRM_STI.ActiveControl Is TextBox Then M_FRM_STI.ActiveControl.Text = FUNKEY(KeyCode)
End Sub
...
SCl MS, 4
MS.TextMatrix(0, 5) = "          Dis. %"
SCl MS, 5
MS.TextMatrix(0, 6) = "        Tax %"
SCl MS, 6
...
MS.TextMatrix(0, 22) = "Inc'tve"
MS.ColAlignment(23) = 7
MS.TextMatrix(0, 23) = "Inc'TTL"
MS.TextMatrix(0, 24) = "List Rate"
MS.ColAlignment(24) = 7
MS.TextMatrix(0, 25) = "List %+"
...
M_MDI.STS_BAR.Panels(1).Text = "Press Ctrl+N to Generate New Stock Receipts Voucher ID by System, Press <Enter> to View Existing Vouchers"
End Sub
...
ElseIf MS.Col = 2 Then
    M_MDI.STS_BAR.Panels(1).Text = "Stock Receipts Voucher Rate"
...
ElseIf MS.Col = 5 Then
    M_MDI.STS_BAR.Panels(1).Text = "Discount %"
...
ElseIf Button.KEY = "ed" Then
    ...
    ElseIf M_FRM_STI.ActiveControl.name = "M_ACT_IDY" Then
        Label49 = "Select Account"
        V_ACT_LST
    ElseIf M_FRM_STI.ActiveControl.name = "Text3" Or (MS.Col = 0 And SSTab1.Tab = 1) Then
        V_PRD_LST
    End If
...
ElseIf Button.KEY = "pre" Then
    ...
    If check("prt", "prt_nme", "M_FRM_STI") = False Then
        Check3.Value = 0
    Else
        Check3.Value = 1
    End If
...
REC_SET.Open "select * from inl where inv_idy like 'STI" & Tincrement(Trim(M_INV_IDY)) & "' and txn_typ like 'STI'", con, adOpenKeyset, adLockPessimistic
Else
REC_SET.Open "select * from inl where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ like 'STI'", con, adOpenKeyset, adLockPessimistic
End If
If REC_SET.RecordCount > 0 Then
    If Len(Trim(M_INV_IDY)) <> 10 Then
    M_INV_IDY = "STI" & Tincrement(Trim(M_INV_IDY))
    End If
    ...
    End If
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from inv where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ = 'STI'", con, adOpenKeyset, adLockPessimistic
    ...
    For A = 1 To MS.Rows - 1
        ...
        If REC_SET2.RecordCount > 0 Then
            ...
            MS.TextMatrix(A, 24) = Trim(REC_SET2!LST_RAT)
            MS.TextMatrix(A, 25) = Trim(REC_SET2!LST_DIS)
        End If
        REC_SET.MoveNext
...
If err.Number = 35773 Then
    MsgBox "Invalid Voucher Selected for this Financial Year!", vbInformation, "DAS Version 4.0"
    CANCELRECORD
Else
...
If K = 13 Or K = 40 Or K = 38 Then
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from act where act_idy like '" & Sincrement(Trim(M_ACT_IDY)) & "' AND GRP_CLF LIKE 'Stock Receipts' AND ACT_TYP LIKE ''", con, adOpenKeyset
    If REC_SET.RecordCount > 0 Then
    ...
    ElseIf MS.Col = 21 Then
        If MS.TextMatrix(MS.Row, 0) <> "" Then
            ...
            If K <> 0 Then
                List7 = Chr(K)
                List7.Visible = True
                List7.Top = MS.Top + MS.CellTop
                List7.Left = MS.CellLeft + MS.Left
                List7.Width = MS.CellWidth
                List7.Height = MS.CellHeight
                List7.Visible = True
                List7.Visible = True
                List7.SetFocus
            End If
...
ElseIf K = 13 Then
    If MS.Col = 1 Then                                                  'QUANTIY
        ...
        If Trim(M_INV_IDY) <> "" Then
            REC_SET2.Open "select PRD_QTY from inv where BAT_idy like '" & Trim(MS.TextMatrix(MS.Row, 13)) & "' and inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ like 'STI'", con, adOpenKeyset, adLockPessimistic
            If REC_SET2.RecordCount > 0 Then
...
If REC_SET.RecordCount > 0 Then
    ...
    MS.TextMatrix(MS.Row, 24) = amt(convert(REC_SET("LST_RAT")))
    MS.TextMatrix(MS.Row, 25) = amt(convert(REC_SET("LST_DIS")))
...
For A = 1 To MS.Rows - 1
    ...
    If Trim(MS.TextMatrix(A, 0)) <> "" Then
        M_INC_AMT = RATCAL(Val(MS.TextMatrix(A, 1) & ""), Val(MS.TextMatrix(A, 22) & ""), Val(MS.TextMatrix(A, 12)))
        MS.TextMatrix(A, 7) = RATCAL(Val(MS.TextMatrix(A, 1) & ""), Val(MS.TextMatrix(A, 2) & ""), Val(MS.TextMatrix(A, 12)))
        PRD_TOT = Val(MS.TextMatrix(A, 7)) - (Val(MS.TextMatrix(A, 4) + M_INC_AMT))
        MS.TextMatrix(A, 23) = convert(Val(M_INC_AMT))
                    
        
        LST_TOT = MTS(Val(MS.TextMatrix(A, 1)), Val(MS.TextMatrix(A, 12)))
        LST_TOT = (LST_TOT * (Val(MS.TextMatrix(A, 24)) / Val(MS.TextMatrix(A, 12))))
        M_CPN_AMT = ((LST_TOT * Val(MS.TextMatrix(A, 25))) / 100)
        ...
        PRD_TOT = Val(PRD_TOT) - Val(M_INC_AMT)
        ...
        TAX_TOT = convert(Val(TAX_TOT) + Val(TAXTOT) + Val(M_CPN_AMT))
        UNT_TOT = QTY(Val(UNT_TOT) + Val(MS.TextMatrix(A, 1)))
        ADD_TOT = convert(Val(ADD_TOT) + Val(ADDTOT))
        AMT_TOT = convert(amt(Val(AMT_TOT) + Val(MS.TextMatrix(A, 7)) + Val(LST_TOT)))
        If Val(MS.TextMatrix(MS.Row, 6)) <> 0 And Val(MS.TextMatrix(MS.Row, 9)) <> 0 And Val(MS.TextMatrix(MS.Row, 2)) <> 0 Then
            MS.TextMatrix(MS.Row, 15) = discount(Round((Val(MS.TextMatrix(MS.Row, 2)) * Val(MS.TextMatrix(MS.Row, 6)) / 100), 2))
            MS.TextMatrix(MS.Row, 15) = discount(Round(((Val(MS.TextMatrix(MS.Row, 9)) / (Val(MS.TextMatrix(MS.Row, 15)) + Val(MS.TextMatrix(MS.Row, 2)))) * 100) - 100, 2))
        ElseIf Val(MS.TextMatrix(MS.Row, 9)) <> 0 And Val(MS.TextMatrix(MS.Row, 2)) <> 0 Then
...
Dim REC_SET As New ADODB.Recordset
If REC_SET.State = 1 Then REC_SET.Close
REC_SET.Open "SELECT * FROM brd,prd WHERE BRD.PRD_IDY LIKE PRD.PRD_IDY AND PRD.PRD_IDY LIKE '" & Trim(Text3) & "%' ORDER BY BRW_SEQ", con, adOpenKeyset
...
If REC_SET.State = 1 Then REC_SET.Close
If Check1.Value = 1 Then
    REC_SET.Open "SELECT * FROM prd,BRD WHERE BRD.PRD_IDY LIKE PRD.PRD_IDY AND PRD_NME LIKE '" & Trim(Text3) & "%' ORDER BY BRW_SEQ", con, adOpenKeyset
Else
    REC_SET.Open "SELECT * FROM brd,prd WHERE BRD.PRD_IDY LIKE PRD.PRD_IDY AND PRD_PRN LIKE '" & Trim(Text3) & "%' ORDER BY BRW_SEQ", con, adOpenKeyset
End If
list4.ListItems.CLEAR
If REC_SET.RecordCount > 0 Then
    For A = 1 To REC_SET.RecordCount
...
Dim REC_SET As New ADODB.Recordset
If REC_SET.State = 1 Then REC_SET.Close
REC_SET.Open "select rou_off from inl where inv_idy like '" & Trim(M_INV_IDY) & "' AND TXN_TYP LIKE 'STI'", con, adOpenKeyset, adLockPessimistic
