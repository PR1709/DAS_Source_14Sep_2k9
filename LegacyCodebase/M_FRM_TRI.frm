...
Begin VB.Form M_FRM_TRI 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "M_FRM_TRI.frx":0442
      ...
      Tab(0).Control(8)=   "M_SUP_AD1"
      Tab(0).Control(8).Enabled=   0   'False
      Tab(0).Control(9)=   "M_SUP_AD2"
      Tab(0).Control(9).Enabled=   0   'False
      Tab(0).Control(10)=   "M_SUP_AD3"
      Tab(0).Control(10).Enabled=   0   'False
      Tab(0).Control(11)=   "M_SUP_AD4"
      Tab(0).Control(11).Enabled=   0   'False
      Tab(0).Control(12)=   "M_FFR_NME"
      ...
      TabPicture(2)   =   "M_FRM_TRI.frx":047A
      ...
      TabPicture(3)   =   "M_FRM_TRI.frx":0496
      ...
      TabCaption(4)   =   "View"
      TabPicture(4)   =   "M_FRM_TRI.frx":04B2
      ...
      Begin VB.ListBox M_FRT_TYP 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRM_TRI.frx":04CE
         Left            =   -71760
         List            =   "M_FRM_TRI.frx":04D8
         TabIndex        =   71
         Top             =   3000
         Width           =   495
      End
      ...
      Begin VB.ListBox List6 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRM_TRI.frx":04E2
         Left            =   -72960
         List            =   "M_FRM_TRI.frx":04EF
         TabIndex        =   57
         TabStop         =   0   'False
         Top             =   720
         Visible         =   0   'False
      ...
      Begin VB.ListBox M_ROU_IDY 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRM_TRI.frx":04FC
         Left            =   -70080
         List            =   "M_FRM_TRI.frx":056C
         TabIndex        =   53
         TabStop         =   0   'False
         Top             =   2640
         Width           =   495
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_TRI.frx":05DC
               Key             =   "p"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_TRI.frx":0B20
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_TRI.frx":0EE8
               Key             =   "c"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_TRI.frx":123C
               Key             =   "e"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_TRI.frx":1874
               Key             =   "s"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_TRI.frx":1BC8
               Key             =   "h"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_TRI.frx":2028
               Key             =   ""
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_TRI.frx":231C
               Key             =   "pr"
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_TRI.frx":2728
               Key             =   "d"
            EndProperty
            BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_TRI.frx":2834
               Key             =   "pre"
            EndProperty
            BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_TRI.frx":2B88
               Key             =   "brw"
            EndProperty
            BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_TRI.frx":2F9C
               Key             =   "cpy"
            EndProperty
            BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_TRI.frx":34E8
               Key             =   ""
            EndProperty
         EndProperty
      End
...
Else
    ...
    REC_SET.AddNew
    REC_SET("inv_idy") = "PUR" & T7increment("IDY_TRI")
    INC = REC_SET("inv_idy")
    INVIDY = INC
End If
...
Label23 = labdisp("IDY_TRI")
If check("PRT", "PRT_NME", "m_frm_tri") = True Then
    ...
    MDIForm1.RRReport1.ReportName = App.Path & "\CASH INVOICE.RRW"
...
If list1.Visible = False And list2.Visible = False And list3.Visible = False And list4.Visible = False And list5.Visible = False Then
    ...
    If KeyCode = 69 And Shift = 2 Then
        ...
        If M_FRM_TRI.ActiveControl.name = "M_INV_IDY" Then
            V_INV_LST
        ElseIf M_FRM_TRI.ActiveControl.name = "M_SUP_IDY" Then
            V_SUP_LST
        ElseIf M_FRM_TRI.ActiveControl.name = "M_SMN_IDY" Then
            V_SMN_LST
        ElseIf M_FRM_TRI.ActiveControl.name = "M_ACT_IDY" Then
            V_ACT_LST
        ElseIf M_FRM_TRI.ActiveControl.name = "Text3" Then
            V_PRD_LST
        End If
    End If
End If
If KeyCode > 111 And KeyCode < 120 Then If TypeOf M_FRM_TRI.ActiveControl Is TextBox Then M_FRM_TRI.ActiveControl.Text = FUNKEY(KeyCode)
End Sub
...
ElseIf Button.KEY = "ed" Then
    ...
    ElseIf M_FRM_TRI.ActiveControl.name = "M_ACT_IDY" Then
        Label49 = "Select Account"
        V_ACT_LST
    ElseIf M_FRM_TRI.ActiveControl.name = "Text3" Or (MS.Col = 0 And SSTab1.Tab = 1) Then
        V_PRD_LST
    End If
...
If check("prt", "prt_nme", "m_frm_tri") = False Then
CHECK3.Value = 0
Else
CHECK3.Value = 1
End If
