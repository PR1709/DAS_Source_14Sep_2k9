...
Begin VB.Form M_FRM_DMR 
   BackColor       =   &H8000000A&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Non Salable Stock Receipts"
   ClientHeight    =   5625
   ClientLeft      =   1425
   ClientTop       =   1845
   ClientWidth     =   8820
   ForeColor       =   &H00FFFFFF&
   Icon            =   "M_FRM_DMR.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "M_FRM_DMR.frx":0442
      ...
      Tab(0).Control(9)=   "Shape2"
      Tab(0).Control(9).Enabled=   0   'False
      Tab(0).Control(10)=   "Shape1"
      Tab(0).Control(10).Enabled=   0   'False
      Tab(0).Control(11)=   "Line2(0)"
      Tab(0).Control(11).Enabled=   0   'False
      Tab(0).Control(12)=   "Line1(0)"
      Tab(0).Control(12).Enabled=   0   'False
      Tab(0).Control(13)=   "M_ACT_NME"
      Tab(0).Control(13).Enabled=   0   'False
      Tab(0).Control(14)=   "M_FFR_NME"
      Tab(0).Control(14).Enabled=   0   'False
      Tab(0).Control(15)=   "M_SUP_AD4"
      Tab(0).Control(15).Enabled=   0   'False
      Tab(0).Control(16)=   "M_SUP_AD3"
      Tab(0).Control(16).Enabled=   0   'False
      Tab(0).Control(17)=   "M_SUP_AD2"
      Tab(0).Control(17).Enabled=   0   'False
      Tab(0).Control(18)=   "M_SUP_AD1"
      Tab(0).Control(18).Enabled=   0   'False
      Tab(0).Control(19)=   "M_SUP_NME"
      ...
      TabPicture(1)   =   "M_FRM_DMR.frx":045E
      ...
      TabPicture(2)   =   "M_FRM_DMR.frx":047A
      ...
      TabCaption(4)   =   "View"
      TabPicture(4)   =   "M_FRM_DMR.frx":04B2
      ...
      Begin VB.ListBox M_FRT_TYP 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRM_DMR.frx":04CE
         Left            =   -71760
         List            =   "M_FRM_DMR.frx":04D8
         TabIndex        =   71
         Top             =   3000
         Width           =   495
      End
      ...
      Begin VB.ListBox List6 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRM_DMR.frx":04E2
         Left            =   2040
         List            =   "M_FRM_DMR.frx":04EF
         TabIndex        =   57
         TabStop         =   0   'False
         Top             =   720
         Visible         =   0   'False
      ...
      Begin VB.ListBox M_ROU_IDY 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRM_DMR.frx":04FC
         Left            =   -70080
         List            =   "M_FRM_DMR.frx":056C
         TabIndex        =   53
         TabStop         =   0   'False
         Top             =   2640
         Width           =   495
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_DMR.frx":05DC
               Key             =   "p"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_DMR.frx":0B20
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_DMR.frx":0EE8
               Key             =   "c"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_DMR.frx":123C
               Key             =   "e"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_DMR.frx":1874
               Key             =   "s"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_DMR.frx":1BC8
               Key             =   "h"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_DMR.frx":2028
               Key             =   ""
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_DMR.frx":231C
               Key             =   "pr"
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_DMR.frx":2728
               Key             =   "d"
            EndProperty
            BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_DMR.frx":2834
               Key             =   "pre"
            EndProperty
            BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_DMR.frx":2B88
               Key             =   "brw"
            EndProperty
            BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_DMR.frx":2F9C
               Key             =   "cpy"
            EndProperty
            BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_DMR.frx":34E8
               Key             =   ""
            EndProperty
         EndProperty
      End
...
If MOD_REC = True Then
    ...
    REC_SET.Open "select * from inv where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ like 'DMR'", con, adOpenKeyset
    For A = 1 To REC_SET.RecordCount
        ...
        REC_SET.MoveNext
    Next
    con.Execute "delete from inv where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ like 'DMR'"
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from inl where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ like 'DMR'", con, adOpenKeyset, adLockOptimistic
    INC = Trim(M_INV_IDY)
Else
    REC_SET.Open "select * from inl", con, adOpenKeyset, adLockOptimistic
    REC_SET.AddNew
    REC_SET("inv_idy") = "DMR" & T7increment("IDY_ORD")
    INC = REC_SET("inv_idy")
    INVIDY = INC
End If
...
For A = 1 To MS.Rows - 1
    ...
    End If
Next
If MOD_REC = False Then MsgBox "New Transfer Inward ID is " & INC, vbExclamation, "Effmcg"
Label23 = labdisp("IDY_ORD")
If check("PRT", "PRT_NME", "M_FRM_DMR") = True Then
    ...
    OpenDocument CURDIR & "\VOUCH.RP1", "DMR Note", 2, Trim(INC), Trim(INC), 2, CURDIR & "\inv.cdx,c,inv_idy"
    Cancelrecord
End If
Cancelrecord
End Sub
...
If Check1.Value = 1 Then
    REC_SET.Open "select * from act where act_nme like '" & Trim(M_SUP_IDY) & "%'", con, adOpenKeyset, adLockOptimistic
ElseIf Check2.Value = 1 Then
    REC_SET.Open "select * from act where act_ad4 like '" & Trim(M_SUP_IDY) & "%'", con, adOpenKeyset, adLockOptimistic
End If
...
If REC_SET.State = 1 Then REC_SET.Close
If Check1.Value = 1 Then
    REC_SET.Open "select * from act where grp_clf like 'Stock Receipts' and ACT_NME LIKE '" & Trim(M_ACT_IDY) & "%' and ACT_TYP LIKE '' ", con, adOpenKeyset, adLockOptimistic
Else
    REC_SET.Open "select * from act where grp_clf like 'Stock Receipts' and ACT_AD4 LIKE '" & Trim(M_ACT_IDY) & "%' and ACT_TYP LIKE '' ", con, adOpenKeyset, adLockOptimistic
End If
...
Else
If SSTab1.Tab = 0 Then
    MsgBox "Stock Receipts Account Not Found, Define Account...!", vbExclamation, "Effmcg"
    SSTab1.Tab = 0
    M_ACT_IDY.SetFocus
End If
End If
...
If k = 13 Or k = 40 Or k = 38 Then
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from act where act_idy like '" & Sincrement(Trim(M_SUP_IDY)) & "'", con, adOpenKeyset, adLockOptimistic
    If REC_SET.RecordCount > 0 Then
...
If REC_SET.State = 1 Then REC_SET.Close
If Check1.Value = 1 Then
REC_SET.Open "select inl.inv_idy,inl.inv_dat,act.act_nme,act.act_ad4 from act,inl where act_nme like '" & Trim(M_INV_IDY) & "%' and inl.cst_idy=act.act_idy and inl.txn_typ ='DMR'", con, adOpenKeyset, adLockOptimistic
Else
REC_SET.Open "select inl.inv_idy,inl.inv_dat,act.act_nme,act.act_ad4 from act,inl where act_ad4 like '" & Trim(M_INV_IDY) & "%' and inl.cst_idy=act.act_idy and inl.txn_typ ='DMR'", con, adOpenKeyset, adLockOptimistic
End If
...
If REC_SET.RecordCount > 0 Then
    ...
    Next
    SSTab1.Tab = 4
    Label49 = "Select Transfer In Document"
    list5.Visible = True
    list5.SetFocus
Else
    If SSTab1.Tab = 0 Then
        MsgBox "Transfer In Number Not Found...!", vbExclamation, "Effmcg"
        SSTab1.Tab = 0
        M_INV_IDY.Enabled = True
        SendKeys "{HOME}+{END}"
        M_INV_IDY.SetFocus
...
If list1.Visible = False And List2.Visible = False And list3.Visible = False And list4.Visible = False And list5.Visible = False Then
    ...
    If KeyCode = 69 And Shift = 2 Then
        ...
        If M_FRM_DMR.ActiveControl.name = "M_INV_IDY" Then
            V_INV_LST
        ElseIf M_FRM_DMR.ActiveControl.name = "M_SUP_IDY" Then
            V_SUP_LST
        ElseIf M_FRM_DMR.ActiveControl.name = "M_SMN_IDY" Then
            V_SMN_LST
        ElseIf M_FRM_DMR.ActiveControl.name = "M_ACT_IDY" Then
            V_ACT_LST
        ElseIf M_FRM_DMR.ActiveControl.name = "Text3" Then
            V_PRD_LST
        End If
    End If
End If
If KeyCode > 111 And KeyCode < 120 Then If TypeOf M_FRM_DMR.ActiveControl Is TextBox Then M_FRM_DMR.ActiveControl.Text = FUNKEY(KeyCode)
End Sub
...
ElseIf Button.KEY = "ed" Then
    ...
    ElseIf M_FRM_DMR.ActiveControl.name = "M_ACT_IDY" Then
        Label49 = "Select Account"
        V_ACT_LST
    ElseIf M_FRM_DMR.ActiveControl.name = "Text3" Or (MS.Col = 0 And SSTab1.Tab = 1) Then
        V_PRD_LST
    End If
...
If check("prt", "prt_nme", "M_FRM_DMR") = False Then
Check3.Value = 0
Else
Check3.Value = 1
End If
...
REC_SET.Open "select * from inl where inv_idy like 'DMR" & Tincrement(Trim(M_INV_IDY)) & "' and txn_typ like 'DMR'", con, adOpenKeyset
Else
REC_SET.Open "select * from inl where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ like 'DMR'", con, adOpenKeyset
End If
If REC_SET.RecordCount > 0 Then
    If Len(Trim(M_INV_IDY)) <> 10 Then
    M_INV_IDY = "DMR" & Tincrement(Trim(M_INV_IDY))
    End If
    M_INV_IDY.Enabled = False
    MOD_REC = True
    ...
    End If
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from inv where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ = 'DMR'", con, adOpenKeyset, adLockOptimistic
...
ElseIf k = 13 Then
    If MS.Col = 3 Then
            ...
            If Trim(M_INV_IDY) <> "" Then
                REC_SET2.Open "select prd_qty from inv where prd_idy like '" & Trim(MS.TextMatrix(MS.Row, 0)) & "' and inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ like 'DMR'", con, adOpenKeyset, adLockOptimistic
...
Dim REC_SET As New ADODB.Recordset
If REC_SET.State = 1 Then REC_SET.Close
REC_SET.Open "select rou_off from inl where inv_idy like '" & Trim(M_INV_IDY) & "' AND TXN_TYP LIKE 'DMR'", con, adOpenKeyset, adLockOptimistic
