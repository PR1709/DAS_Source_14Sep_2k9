...
Begin VB.Form M_FRM_LSL 
   ...
   Begin MSComctlLib.Toolbar Toolbar1 
      ...
      Begin VB.ListBox text1 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRM_LSL.frx":0442
         Left            =   6960
         List            =   "M_FRM_LSL.frx":045B
         TabIndex        =   106
         TabStop         =   0   'False
         Top             =   50
         Visible         =   0   'False
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "M_FRM_LSL.frx":049F
      ...
      TabPicture(1)   =   "M_FRM_LSL.frx":04BB
      ...
      TabPicture(2)   =   "M_FRM_LSL.frx":04D7
      ...
      TabPicture(3)   =   "M_FRM_LSL.frx":04F3
      ...
      TabCaption(4)   =   "View"
      TabPicture(4)   =   "M_FRM_LSL.frx":050F
      ...
      Begin VB.ListBox List6 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRM_LSL.frx":052B
         Left            =   2040
         List            =   "M_FRM_LSL.frx":0538
         TabIndex        =   67
         TabStop         =   0   'False
         Top             =   720
         Visible         =   0   'False
      ...
      Begin VB.ListBox M_ROU_IDY 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRM_LSL.frx":0545
         Left            =   -70080
         List            =   "M_FRM_LSL.frx":05B5
         TabIndex        =   63
         TabStop         =   0   'False
         Top             =   2640
         Width           =   495
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_LSL.frx":0625
               Key             =   "p"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_LSL.frx":0B69
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_LSL.frx":0F31
               Key             =   "c"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_LSL.frx":1285
               Key             =   "e"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_LSL.frx":18BD
               Key             =   "s"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_LSL.frx":1C11
               Key             =   "h"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_LSL.frx":2071
               Key             =   ""
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_LSL.frx":2365
               Key             =   "pr"
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_LSL.frx":2771
               Key             =   "d"
            EndProperty
            BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_LSL.frx":287D
               Key             =   "pre"
            EndProperty
            BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_LSL.frx":2BD1
               Key             =   "brw"
            EndProperty
            BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_LSL.frx":2FE5
               Key             =   "cpy"
            EndProperty
            BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_LSL.frx":3531
               Key             =   ""
            EndProperty
         EndProperty
      End
...
If check("dir", "dir_idy like 'SYS' AND DIR_IDX LIKE 'PSW' AND DIR_MSG", "Y") = True Then
    ...
    For A = 1 To MS.Rows - 1
        If Trim(MS.TextMatrix(A, 0)) <> "" Then
            If check("prd", "bas_rat > " & Val(MS.TextMatrix(A, 4)) & " and prd_idy ", Trim(MS.TextMatrix(A, 0))) = True Then
                MsgBox "Cannot Save Invoice! Billing Rate is Less Than Purchase Rate", vbExclamation, "Effmcg"
                MS.SetFocus
                MS.Row = A
                SSTab1.Tab = 1
                Exit Sub
...
If MOD_REC = True Then
    ...
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from inl where inv_idy like '" & Sincrement(M_INV_IDY) & "' and txn_typ like 'LSL'", con, adOpenKeyset, adLockPessimistic
    INC = Sincrement(M_INV_IDY)
Else
    REC_SET.Open "select * from inl", con, adOpenKeyset, adLockPessimistic
    REC_SET.AddNew
...
For A = 1 To MS.Rows - 1
    If Trim(MS.TextMatrix(A, 0)) <> "" Then
        ...
        REC_SET("TAX_AMT") = convert(amt(Val(TRDTAX)))
        REC_SET("txn_typ") = "LSL"
...
If check("PRT", "PRT_NME", "M_FRM_LSL") = True Then
...
If Check1.Value = 1 Then
    If Toolbar1.Buttons(31).Value = tbrPressed And Toolbar1.Buttons(30).Value = 1 Then
        REC_SET.Open "select ACT.*,MAR.MAR_NME,act.ROU_IDY,smn.smn_nme from act,MAR,smn where (act.ACT_TYP LIKE 'BOT' OR act.ACT_TYP LIKE 'SAL') and DBT_TYP='Y' AND act_nme like '" & Trim(M_CST_IDY) & "%' AND ACT.MAR_IDY LIKE MAR.MAR_IDY AND ACT.SMN_IDY LIKE SMN.SMN_IDY AND MAR_VDA LIKE '" & UCase(text1) & "' AND SMN.SMN_IDY LIKE '" & Trim(Text2) & "'", con, adOpenKeyset, adLockOptimistic
    ElseIf Toolbar1.Buttons(31).Value = 1 Then
        REC_SET.Open "select ACT.*,MAR.MAR_NME,act.ROU_IDY,smn.smn_nme from act,MAR,smn where (act.ACT_TYP LIKE 'BOT' OR act.ACT_TYP LIKE 'SAL') and DBT_TYP='Y' AND act_NME like '" & Trim(M_CST_IDY) & "%' AND ACT.MAR_IDY LIKE MAR.MAR_IDY AND ACT.SMN_IDY LIKE SMN.SMN_IDY AND MAR_VDA LIKE '" & UCase(text1) & "'", con, adOpenKeyset, adLockOptimistic
    ElseIf Toolbar1.Buttons(30).Value = 1 Then
        REC_SET.Open "select ACT.*,MAR.MAR_NME,act.ROU_IDY,smn.smn_nme from act,MAR,smn where (act.ACT_TYP LIKE 'BOT' OR act.ACT_TYP LIKE 'SAL') andCact_NME like '" & Trim(M_CST_IDY) & "%' AND ACT.MAR_IDY LIKE MAR.MAR_IDY AND ACT.SMN_IDY LIKE SMN.SMN_IDY AND SMN.SMN_IDY LIKE '" & Trim(Text2) & "'", con, adOpenKeyset, adLockOptimistic
    Else
        REC_SET.Open "select ACT.*,MAR.MAR_NME,act.ROU_IDY,smn.smn_nme from act,MAR,smn where (ACT_TYP LIKE 'BOT' OR ACT_TYP LIKE 'SAL') and DBT_TYP='Y' AND act_nme like '" & Trim(M_CST_IDY) & "%' AND ACT.MAR_IDY LIKE MAR.MAR_IDY AND ACT.SMN_IDY LIKE SMN.SMN_IDY", con, adOpenKeyset, adLockOptimistic
    End If
ElseIf Check2.Value = 1 Then
    If Toolbar1.Buttons(31).Value = tbrPressed And Toolbar1.Buttons(30).Value = 1 Then
        REC_SET.Open "select ACT.*,MAR.MAR_NME,act.ROU_IDY,smn.smn_nme from act,MAR,smn where (act.ACT_TYP LIKE 'BOT' OR act.ACT_TYP LIKE 'SAL') and DBT_TYP='Y' AND act_ad4 like '" & Trim(M_CST_IDY) & "%' AND ACT.MAR_IDY LIKE MAR.MAR_IDY AND ACT.SMN_IDY LIKE SMN.SMN_IDY AND MAR_VDA LIKE '" & UCase(text1) & "' AND SMN.SMN_IDY LIKE '" & Trim(Text2) & "'", con, adOpenKeyset, adLockOptimistic
    ElseIf Toolbar1.Buttons(31).Value = 1 Then
        REC_SET.Open "select ACT.*,MAR.MAR_NME,act.ROU_IDY,smn.smn_nme from act,MAR,smn where (act.ACT_TYP LIKE 'BOT' OR ACT_TYP LIKE 'SAL') and  DBT_TYP='Y' AND act_ad4 like '" & Trim(M_CST_IDY) & "%' AND ACT.MAR_IDY LIKE MAR.MAR_IDY AND ACT.SMN_IDY LIKE SMN.SMN_IDY AND MAR.MAR_VDA LIKE '" & UCase(text1) & "'", con, adOpenKeyset, adLockOptimistic
    ElseIf Toolbar1.Buttons(30).Value = 1 Then
        REC_SET.Open "select ACT.*,MAR.MAR_NME,act.ROU_IDY,smn.smn_nme from act,MAR,smn where (act.ACT_TYP LIKE 'BOT' OR act.ACT_TYP LIKE 'SAL') and DBT_TYP='Y' AND act_ad4 like '" & Trim(M_CST_IDY) & "%' AND ACT.MAR_IDY LIKE MAR.MAR_IDY AND ACT.SMN_IDY LIKE SMN.SMN_IDY AND SMN.SMN_IDY LIKE '" & Trim(Text2) & "'", con, adOpenKeyset, adLockOptimistic
    Else
        REC_SET.Open "select ACT.*,MAR.MAR_NME,act.ROU_IDY,smn.smn_nme from act,MAR,smn where (act.ACT_TYP LIKE 'BOT' OR ACT_TYP LIKE 'SAL') and  DBT_TYP='Y' AND act_ad4 like '" & Trim(M_CST_IDY) & "%' AND ACT.MAR_IDY LIKE MAR.MAR_IDY AND ACT.SMN_IDY LIKE SMN.SMN_IDY", con, adOpenKeyset, adLockOptimistic
    End If
End If
...
If KeyAscii = 13 Then
    ...
    List6.Visible = False
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from prd where prd_idy like '" & MS.TextMatrix(MS.Row, 0) & "' AND STK_TYP IN('Free','Salable')", con, adOpenKeyset, adLockOptimistic
    If REC_SET.RecordCount > 0 Then
        If List6 = "A" Then
...
If REC_SET.State = 1 Then REC_SET.Close
If Check1.Value = 1 Then
REC_SET.Open "select inl.inv_idy,inl.inv_dat,act.act_nme,act.act_ad4 from act,inl where act_nme like '" & Trim(M_INV_IDY) & "%' and inl.cst_idy=act.act_idy and inl.txn_typ ='LSL' and ord_idy like '0'", con, adOpenKeyset, adLockOptimistic
Else
REC_SET.Open "select inl.inv_idy,inl.inv_dat,act.act_nme,act.act_ad4 from act,inl where act_ad4 like '" & Trim(M_INV_IDY) & "%' and inl.cst_idy=act.act_idy and inl.txn_typ ='LSL' and ord_idy like '0'", con, adOpenKeyset, adLockOptimistic
End If
...
If list1.Visible = False And list2.Visible = False And list3.Visible = False And list4.Visible = False And list5.Visible = False Then
    ...
    If KeyCode = 69 And Shift = 2 Then
        ...
        If M_FRM_LSL.ActiveControl.name = "M_INV_IDY" Then
            V_INV_LST
        ElseIf M_FRM_LSL.ActiveControl.name = "M_CST_IDY" Then
            V_DLR_LST
        ElseIf M_FRM_LSL.ActiveControl.name = "M_SMN_IDY" Then
            V_SMN_LST
        ElseIf M_FRM_LSL.ActiveControl.name = "M_ACT_IDY" Then
            V_ACT_LST
        ElseIf M_FRM_LSL.ActiveControl.name = "Text3" Then
            V_PRD_LST
        End If
    End If
End If
If KeyCode > 111 And KeyCode < 120 Then If TypeOf M_FRM_LSL.ActiveControl Is TextBox Then M_FRM_LSL.ActiveControl.Text = FUNKEY(KeyCode)
End Sub
...
ElseIf Button.KEY = "ed" Then
    ...
    ElseIf M_FRM_LSL.ActiveControl.name = "M_ACT_IDY" Then
        V_LST_CAP = "Select Account"
        V_ACT_LST
    ElseIf M_FRM_LSL.ActiveControl.name = "Text3" Or (MS.Col = 0 And SSTab1.Tab = 1) Then
        V_PRD_LST
    End If
...
If check("prt", "prt_nme", "M_FRM_LSL") = False Then
Check3.Value = 0
Else
Check3.Value = 1
End If
...
REC_SET.Open "select * from inl where inv_idy like 'LSL" & Tincrement(Trim(M_INV_IDY)) & "' and txn_typ like 'LSL' and ord_idy like '0'", con, adOpenKeyset
Else
REC_SET.Open "select * from inl where inv_idy like '" & Tincrement(Trim(M_INV_IDY)) & "' and txn_typ like 'LSL' and ord_idy like '0'", con, adOpenKeyset
End If
If REC_SET.RecordCount > 0 Then
    If Len(Trim(M_INV_IDY)) <> 10 Then
    ...
    End If
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from inv where inv_idy like '" & Sincrement(M_INV_IDY) & "' and txn_typ = 'LSL'", con, adOpenKeyset, adLockOptimistic
...
ElseIf k = 13 Then
    If MS.Col = 3 Then
        ...
        REC_SET.Open "select * from PRD where PRD_IDY like '" & Trim(MS.TextMatrix(MS.Row, 0)) & "'AND STK_TYP IN('Free','Salable')", con, adOpenKeyset, adLockOptimistic
        If Trim(M_INV_IDY) <> "" Then
            REC_SET2.Open "select prd_qty from inv where prd_idy like '" & Trim(MS.TextMatrix(MS.Row, 0)) & "' and inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ like 'LSL'", con, adOpenKeyset, adLockOptimistic
...
For A = 1 To MS.Rows - 1
    ...
    End If
Next
REC_SET.Open "select * from PRD where prd_idy like '" & Trim(prdid) & "' AND STK_TYP IN('Free','Salable')", con, adOpenKeyset
If REC_SET.RecordCount > 0 Then
    list4.Visible = False
...
For A = 1 To MS.Rows - 1
    ...
    If REC_SET.State = 1 Then REC_SET.Close
    If Trim(MS.TextMatrix(A, 0)) <> "" Then
    REC_SET.Open "select sub_unt,bas_rat from prd where prd_idy like '" & Trim(MS.TextMatrix(A, 0)) & "'", con, adOpenKeyset, adLockOptimistic
    If REC_SET.RecordCount > 0 Then
