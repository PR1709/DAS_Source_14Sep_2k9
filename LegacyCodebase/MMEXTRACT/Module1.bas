...
Private Sub MM_EX_FILE()
    ...
    PNL.Open "Driver={Microsoft Visual FoxPro Driver};UID=;PWD=;SourceDB=" & App.Path & "\mm.dbf;SourceType=DBF;Exclusive=No;BackgroundFetch=Yes;Collate=Machine;Null=Yes;Deleted=Yes;"
    
    REC.Open sqlstatment, con, adOpenKeyset, adLockPessimistic
