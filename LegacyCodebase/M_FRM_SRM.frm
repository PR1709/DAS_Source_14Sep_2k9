...
Begin VB.Form M_FRM_SRM 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "M_FRM_SRM.frx":0442
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "M_CST_IDY"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).Control(1)=   "M_SMN_IDY"
      Tab(0).Control(1).Enabled=   0   'False
      Tab(0).Control(2)=   "M_ACT_IDY"
      Tab(0).Control(2).Enabled=   0   'False
      Tab(0).Control(3)=   "M_DCH_IDY"
      Tab(0).Control(3).Enabled=   0   'False
      Tab(0).Control(4)=   "M_DCH_DAT"
      Tab(0).Control(5)=   "M_INV_IDY"
      Tab(0).Control(5).Enabled=   0   'False
      Tab(0).Control(6)=   "M_INV_DAT"
      Tab(0).Control(7)=   "Label20"
      Tab(0).Control(8)=   "Label19"
      Tab(0).Control(9)=   "M_DBT_MCL"
      Tab(0).Control(10)=   "Label15"
      Tab(0).Control(11)=   "Label14"
      Tab(0).Control(12)=   "Label12"
      Tab(0).Control(13)=   "DBT_MCP"
      Tab(0).Control(14)=   "M_DBT_MCP"
      Tab(0).Control(15)=   "Shape2"
      Tab(0).Control(16)=   "Shape1"
      Tab(0).Control(17)=   "Line2(0)"
      Tab(0).Control(18)=   "Line1(0)"
      Tab(0).Control(19)=   "M_ACT_NME"
      Tab(0).Control(20)=   "M_smn_NME"
      Tab(0).Control(21)=   "M_SUP_AD4"
      Tab(0).Control(22)=   "M_SUP_AD3"
      Tab(0).Control(23)=   "M_SUP_AD2"
      Tab(0).Control(24)=   "M_SUP_AD1"
      Tab(0).Control(25)=   "M_SUP_NME"
      Tab(0).Control(26)=   "Label23"
      Tab(0).Control(27)=   "Label16"
      Tab(0).Control(28)=   "Label21"
      ...
      Tab(1).Control(3)=   "MS"
      Tab(1).Control(4)=   "tax"
      Tab(1).Control(5)=   "units"
      Tab(1).Control(6)=   "M_PRD_TOT"
      ...
      Begin VB.ListBox M_FRT_TYP 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRM_SRM.frx":045E
         Left            =   3240
         List            =   "M_FRM_SRM.frx":0468
         TabIndex        =   72
         Top             =   3000
         Width           =   495
      End
      ...
      Begin VB.ListBox M_ROU_IDY 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRM_SRM.frx":0472
         Left            =   4920
         List            =   "M_FRM_SRM.frx":04C4
         TabIndex        =   54
         TabStop         =   0   'False
         Top             =   2640
         Width           =   495
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SRM.frx":0516
            Key             =   "p"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SRM.frx":0A5A
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SRM.frx":0E22
            Key             =   "c"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SRM.frx":1176
            Key             =   "e"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SRM.frx":17AE
            Key             =   "s"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SRM.frx":1B02
            Key             =   "h"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SRM.frx":1F62
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SRM.frx":2256
            Key             =   "pr"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SRM.frx":2662
            Key             =   "d"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SRM.frx":276E
            Key             =   "pre"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SRM.frx":2AC2
            Key             =   "brw"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SRM.frx":2ED6
            Key             =   "cpy"
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SRM.frx":3422
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.Toolbar Toolbar1 
      ...
      Begin VB.ListBox text1 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRM_SRM.frx":3876
         Left            =   6960
         List            =   "M_FRM_SRM.frx":388F
         TabIndex        =   106
         TabStop         =   0   'False
         Top             =   50
         Visible         =   0   'False
...
If check("ACT", "(ACT_TYP LIKE 'BOT' OR ACT_TYP LIKE 'SAL') AND ACT_idy", Trim(M_CST_IDY)) = False Then
    MsgBox "Dealer Not Found ,Define Suppliers !", vbExclamation, "Effmcg"
    SSTab1.Tab = 0
    M_CST_IDY.SetFocus
    Exit Sub
End If

If check("act", "(grp_clf like 'Sales Return' and ACT_TYP LIKE '') AND act_idy", Trim(M_ACT_IDY)) = False Then
    MsgBox "Sales Return Account Not Found, Define Sales Return Account...!", vbExclamation, "Effmcg"
    M_ACT_IDY.SetFocus
    SSTab1.Tab = 0
    Exit Sub
End If
...
If MOD_REC = True Then
    ...
    REC_SET.Open "select * from inv where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ like 'SRN'", con, adOpenKeyset
    For A = 1 To REC_SET.RecordCount
        ...
        REC_SET.MoveNext
    Next
    con.Execute "delete from inv where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ like 'SRN'"
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from inl where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ like 'SRN'", con, adOpenKeyset, adLockOptimistic
    INC = Trim(M_INV_IDY)
Else
    REC_SET.Open "select * from inl", con, adOpenKeyset, adLockOptimistic
    REC_SET.AddNew
    REC_SET("inv_idy") = "SRN" & T7increment("IDY_SRN")
    INC = REC_SET("inv_idy")
    INVIDY = INC
End If
...
For A = 1 To MS.Rows - 1
    ...
    End If
Next
If MOD_REC = False Then MsgBox "New Purchase ID is " & INC, vbExclamation, "Effmcg"
Label23 = labdisp("IDY_SRN")
If check("PRT", "PRT_NME", "M_FRM_SRN") = True Then
    ...
    Openreport App.Path & "\VOUCH.RP1", "Credit Note", 2, "inv->inv_idy='" & Trim(INC) & "'inv->txn_typ='SRN'", 2
    Cancelrecord
End If
Cancelrecord
End Sub
...
If REC_SET.State = 1 Then REC_SET.Close
If Check1.Value = 1 Then
    REC_SET.Open "select * from act where grp_clf like 'Sales Return' and ACT_NME LIKE '" & Trim(M_ACT_IDY) & "%' and ACT_TYP LIKE '' ", con, adOpenKeyset, adLockOptimistic
Else
    REC_SET.Open "select * from act where grp_clf like 'Sales Return' and ACT_AD4 LIKE '" & Trim(M_ACT_IDY) & "%' and ACT_TYP LIKE '' ", con, adOpenKeyset, adLockOptimistic
End If
...
If REC_SET.State = 1 Then REC_SET.Close
If Check1.Value = 1 Then
REC_SET.Open "select inl.inv_idy,inl.inv_dat,act.act_nme,act.act_ad4 from act,inl where act_nme like '" & Trim(M_INV_IDY) & "%' and inl.cst_idy=act.act_idy and inl.txn_typ ='SRN'", con, adOpenKeyset, adLockOptimistic
Else
REC_SET.Open "select inl.inv_idy,inl.inv_dat,act.act_nme,act.act_ad4 from act,inl where act_ad4 like '" & Trim(M_INV_IDY) & "%' and inl.cst_idy=act.act_idy and inl.txn_typ ='SRN'", con, adOpenKeyset, adLockOptimistic
End If
...
If REC_SET.RecordCount > 0 Then
    ...
    Next
    SSTab1.Tab = 4
    Label49 = "Select Credit Note"
    list5.Visible = True
    list5.SetFocus
Else
    If SSTab1.Tab = 0 Then
        MsgBox "Credit Note Number Not Found...!", vbExclamation, "Effmcg"
        SSTab1.Tab = 0
        M_INV_IDY.Enabled = True
        SendKeys "{HOME}+{END}"
        M_INV_IDY.SetFocus
...
If list1.Visible = False And List2.Visible = False And LIST3.Visible = False And list4.Visible = False And list5.Visible = False Then
    ...
    If KeyCode = 69 And Shift = 2 Then
        ...
        If M_FRM_SRn.ActiveControl.name = "M_INV_IDY" Then
            V_INV_LST
        ElseIf M_FRM_SRn.ActiveControl.name = "M_CST_IDY" Then
            V_DLR_LST
        ElseIf M_FRM_SRn.ActiveControl.name = "M_SMN_IDY" Then
            V_SMN_LST
        ElseIf M_FRM_SRn.ActiveControl.name = "M_ACT_IDY" Then
            V_ACT_LST
        ElseIf M_FRM_SRn.ActiveControl.name = "Text3" Then
            V_PRD_LST
        End If
    End If
End If
If KeyCode > 111 And KeyCode < 120 Then If TypeOf M_FRM_SRn.ActiveControl Is TextBox Then M_FRM_SRn.ActiveControl.Text = FUNKEY(KeyCode)
End Sub
...
If Label49.Caption = "Select Salesman" Then
    V_SMN_LST
ElseIf Label49.Caption = "Select Dealer" Then
    V_DLR_LST
...
ElseIf Button.KEY = "ed" Then
    ...
    ElseIf M_FRM_SRn.ActiveControl.name = "M_ACT_IDY" Then
        Label49 = "Select Account"
        V_ACT_LST
    ElseIf M_FRM_SRn.ActiveControl.name = "Text3" Or (MS.Col = 0 And SSTab1.Tab = 1) Then
        V_PRD_LST
    End If
...
If check("prt", "prt_nme", "M_FRM_SRN") = False Then
CHECK3.Value = 0
Else
CHECK3.Value = 1
End If
...
REC_SET.Open "select * from inl where inv_idy like 'SRN" & Tincrement(Trim(M_INV_IDY)) & "' and txn_typ like 'SRN'", con, adOpenKeyset
Else
REC_SET.Open "select * from inl where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ like 'SRN'", con, adOpenKeyset
End If
If REC_SET.RecordCount > 0 Then
    If Len(Trim(M_INV_IDY)) <> 10 Then
    M_INV_IDY = "SRN" & Tincrement(Trim(M_INV_IDY))
    End If
    M_INV_IDY.Enabled = False
    MOD_REC = True
    ...
    End If
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from inv where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ = 'SRN'", con, adOpenKeyset, adLockOptimistic
...
If K = 13 Or K = 40 Or K = 38 Then
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from act where act_idy like '" & Sincrement(Trim(M_ACT_IDY)) & "' AND GRP_CLF LIKE 'Sales Return' AND ACT_TYP LIKE ''", con, adOpenKeyset
    If REC_SET.RecordCount > 0 Then
...
ElseIf K = 13 Then
    If MS.Col = 3 Then
            ...
            If Trim(M_INV_IDY) <> "" Then
                REC_SET2.Open "select prd_qty from inv where prd_idy like '" & Trim(MS.TextMatrix(MS.Row, 0)) & "' and inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ like 'SRN'", con, adOpenKeyset, adLockOptimistic
...
Dim REC_SET As New ADODB.Recordset
If REC_SET.State = 1 Then REC_SET.Close
REC_SET.Open "select rou_off from inl where inv_idy like '" & Trim(M_INV_IDY) & "' AND TXN_TYP LIKE 'SRN'", con, adOpenKeyset, adLockOptimistic
