...
Begin VB.Form M_FRM_STO 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Unplanned Issue - Stock Transfer Outward Entry"
   ClientHeight    =   5625
   ClientLeft      =   1455
   ClientTop       =   330
   ClientWidth     =   8820
   ForeColor       =   &H00FFFFFF&
   Icon            =   "M_FRM_STO.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "M_FRM_STO.frx":0442
      ...
      TabPicture(1)   =   "M_FRM_STO.frx":045E
      ...
      Tab(1).Control(6)=   "List7"
      Tab(1).Control(6).Enabled=   0   'False
      Tab(1).ControlCount=   7
      TabCaption(2)   =   "&Taxes and  Levies"
      TabPicture(2)   =   "M_FRM_STO.frx":047A
      ...
      TabPicture(3)   =   "M_FRM_STO.frx":0496
      ...
      TabCaption(4)   =   "View"
      TabPicture(4)   =   "M_FRM_STO.frx":04B2
      ...
      Begin VB.ListBox List7 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRM_STO.frx":04CE
         Left            =   -71520
         List            =   "M_FRM_STO.frx":0514
         TabIndex        =   133
         TabStop         =   0   'False
         Top             =   2160
         Visible         =   0   'False
      ...
      Begin VB.ListBox List6 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRM_STO.frx":0682
         Left            =   -72960
         List            =   "M_FRM_STO.frx":0684
         TabIndex        =   27
         TabStop         =   0   'False
         Top             =   720
         Visible         =   0   'False
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_STO.frx":0686
            Key             =   "p"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_STO.frx":0BCA
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_STO.frx":0F92
            Key             =   "c"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_STO.frx":12E6
            Key             =   "e"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_STO.frx":191E
            Key             =   "s"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_STO.frx":1C72
            Key             =   "h"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_STO.frx":20D2
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_STO.frx":23C6
            Key             =   "pr"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_STO.frx":27D2
            Key             =   "d"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_STO.frx":28DE
            Key             =   "pre"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_STO.frx":2C32
            Key             =   "brw"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_STO.frx":3046
            Key             =   "cpy"
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_STO.frx":3592
            Key             =   ""
         EndProperty
      EndProperty
   End
...
If MOD_REC = True Then
    If Check3.Value = 1 Then
        ...
        REC_SET.Open "select * from inv where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ like 'STO'", con, adOpenKeyset
        ...
        Next
    End If
    TxnMoveBackup "INV", "BNV", Trim(M_INV_IDY), "STO"
    TxnMoveBackup "INL", "BNL", Trim(M_INV_IDY), "STO"
    
    con.Execute "delete from inv where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ like 'STO'"
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from inl where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ like 'STO'", con, adOpenKeyset, adLockPessimistic
    INC = Trim(M_INV_IDY)
Else
    REC_SET.Open "select * from inl where inv_idy = ''", con, adOpenKeyset, adLockPessimistic
    REC_SET.AddNew
    REC_SET("inv_idy") = "STO" & T7increment("IDY_STO")
    INC = REC_SET("inv_idy")
    INVIDY = INC
End If
...
If MOD_REC = True Then
    TxnMoveBackup "PNV", "XNV", Trim(INC), "STO"
    TxnMoveBackup "PNL", "XNL", Trim(INC), "STO"
...
For A = 1 To MS.Rows - 1
    If Trim(MS.TextMatrix(A, 0)) <> "" And Val(MS.TextMatrix(A, 1)) > 0 Then
        ...
        REC_SET("LST_RAT") = Val(MS.TextMatrix(A, 24))
        REC_SET("LST_DIS") = Val(MS.TextMatrix(A, 25))
...
If MOD_REC = False Then MsgBox "New Stock Issues Voucher ID is " & INC, vbExclamation, "DAS Version 4.0"
If check("PRT", "PRT_NME", "STO_SHL") Then LOADSHELLS "STO", Trim(INC)
'pnv update close
Label23 = labdisp("IDY_STO")
If check("PRT", "PRT_NME", "M_FRM_STO") = True Then
    con.Execute "update dir where dir_idy like 'INV' AND DIR_IDX LIKE 'NUM' set dir_als = '" & INC & "'"
    con.Execute "update dir where dir_idy like 'DOC' AND DIR_IDX LIKE 'TYP' set dir_als = 'STO'"
        If querycheck("DIR", "DIR_MSG", "D", "AND DIR_IDY LIKE 'SYS' AND DIR_IDX LIKE 'DOS'") = True Then
        If REC_PNL.State = 1 Then REC_PNL.Close
        REC_PNL.Open "SELECT * FROM RRI WHERE RI_REPORT LIKE 'Transfer Outward Note'", PNL, adOpenKeyset, adLockPessimistic
    ...
    Else
        OpenDocument CURDIR & "\DOS_VCH.RP1", "Transfer Outward Note", 2, Trim(INC), Trim(INC), 6, CURDIR & "\pnv.cdx,c,inv_idy"
    End If
    CANCELRECORD
End If
CANCELRECORD
...
If list1.Visible = False And list2.Visible = False And list3.Visible = False And list4.Visible = False And list5.Visible = False Then
    ...
    If KeyCode = 69 And Shift = 2 Then
        ...
        If M_FRM_STO.ActiveControl.name = "M_INV_IDY" Then
            V_INV_LST
        ElseIf M_FRM_STO.ActiveControl.name = "M_SUP_IDY" Then
            V_SUP_LST
        ElseIf M_FRM_STO.ActiveControl.name = "M_SMN_IDY" Then
            V_SMN_LST
        ElseIf M_FRM_STO.ActiveControl.name = "M_ACT_IDY" Then
            V_ACT_LST
        ElseIf M_FRM_STO.ActiveControl.name = "Text3" Then
            V_PRD_LST
        End If
    End If
End If
If KeyCode > 111 And KeyCode < 120 Then If TypeOf M_FRM_STO.ActiveControl Is TextBox Then M_FRM_STO.ActiveControl.Text = FUNKEY(KeyCode)
End Sub
...
ElseIf MS.Col = 2 Then
    M_MDI.STS_BAR.Panels(1).Text = "Stock Issues Voucher Rate"
...
ElseIf Button.KEY = "ed" Then
    ...
    ElseIf M_FRM_STO.ActiveControl.name = "M_ACT_IDY" Then
        Label49 = "Select Account"
        V_ACT_LST
    ElseIf M_FRM_STO.ActiveControl.name = "Text3" Or (MS.Col = 0 And SSTab1.Tab = 1) Then
        V_PRD_LST
    End If
...
ElseIf Button.KEY = "pre" Then
    ...
    If check("prt", "prt_nme", "M_FRM_STO") = False Then
    Check3.Value = 0
    Else
    Check3.Value = 1
    End If
...
REC_SET.Open "select * from inl where inv_idy like 'STO" & Tincrement(Trim(M_INV_IDY)) & "' and txn_typ like 'STO'", con, adOpenKeyset, adLockPessimistic
Else
REC_SET.Open "select * from inl where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ like 'STO'", con, adOpenKeyset, adLockPessimistic
End If
If REC_SET.RecordCount > 0 Then
...
ElseIf K = 13 Then
    If MS.Col = 1 Then                                                  'QUANTIY
        ...
        If Trim(M_INV_IDY) <> "" Then
            REC_SET2.Open "select PRD_QTY from inv where BAT_idy like '" & Trim(MS.TextMatrix(MS.Row, 13)) & "' and inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ like 'STO'", con, adOpenKeyset, adLockPessimistic
            If REC_SET2.RecordCount > 0 Then
...
For A = 1 To MS.Rows - 1
    ...
    If Trim(MS.TextMatrix(A, 0)) <> "" Then
        ...
        PRD_TOT = Val(MS.TextMatrix(A, 7)) - Val(MS.TextMatrix(A, 4))
...
Dim REC_SET As New ADODB.Recordset
If REC_SET.State = 1 Then REC_SET.Close
REC_SET.Open "SELECT * FROM brd,prd WHERE BRD.PRD_IDY LIKE PRD.PRD_IDY AND PRD.PRD_IDY LIKE '" & Trim(Text3) & "%' and BRD.PRD_QTY>0 ORDER BY BRW_SEQ", con, adOpenKeyset
