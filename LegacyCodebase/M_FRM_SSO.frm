...
Begin VB.Form M_FRM_SAL 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "M_FRM_SSO.frx":0442
      ...
      TabPicture(1)   =   "M_FRM_SSO.frx":045E
      ...
      TabPicture(2)   =   "M_FRM_SSO.frx":047A
      ...
      TabPicture(3)   =   "M_FRM_SSO.frx":0496
      ...
      TabCaption(4)   =   "View"
      TabPicture(4)   =   "M_FRM_SSO.frx":04B2
      Tab(4).ControlEnabled=   0   'False
      Tab(4).Control(0)=   "V_LST_CAP"
      Tab(4).Control(1)=   "list4"
      Tab(4).Control(2)=   "list3"
      Tab(4).Control(3)=   "list1"
      Tab(4).Control(4)=   "list2"
      Tab(4).Control(5)=   "list5"
      Tab(4).Control(6)=   "Frame1"
      Tab(4).Control(7)=   "LIST8"
      Tab(4).ControlCount=   8
      TabCaption(5)   =   "Fr&ee and Takebacks"
      TabPicture(5)   =   "M_FRM_SSO.frx":04CE
      Tab(5).ControlEnabled=   0   'False
      Tab(5).Control(0)=   "MSF"
      Tab(5).Control(1)=   "List7"
      Tab(5).Control(1).Enabled=   0   'False
      Tab(5).Control(2)=   "Picture2"
      Tab(5).Control(3)=   "Text4"
      Tab(5).Control(3).Enabled=   0   'False
      Tab(5).Control(4)=   "Text5"
      Tab(5).Control(4).Enabled=   0   'False
      Tab(5).ControlCount=   5
      TabCaption(6)   =   "Sc&hemes"
      TabPicture(6)   =   "M_FRM_SSO.frx":04EA
      Tab(6).ControlEnabled=   0   'False
      Tab(6).Control(0)=   "MSS"
      Tab(6).Control(1)=   "SCHLST"
      Tab(6).Control(2)=   "Frame2"
      Tab(6).Control(3)=   "Frame6"
      Tab(6).Control(4)=   "TXT_SCH"
      Tab(6).Control(5)=   "SC"
      ...
      Begin VB.ListBox List7 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRM_SSO.frx":0506
         Left            =   -73920
         List            =   "M_FRM_SSO.frx":051F
         TabIndex        =   92
         TabStop         =   0   'False
         Top             =   1440
         Visible         =   0   'False
      ...
      Begin VB.ListBox List6 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRM_SSO.frx":0560
         Left            =   -72960
         List            =   "M_FRM_SSO.frx":0570
         TabIndex        =   22
         TabStop         =   0   'False
         Top             =   720
         Visible         =   0   'False
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SSO.frx":0580
            Key             =   "p"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SSO.frx":0AC4
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SSO.frx":0E8C
            Key             =   "c"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SSO.frx":11E0
            Key             =   "e"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SSO.frx":1818
            Key             =   "s"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SSO.frx":1B6C
            Key             =   "h"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SSO.frx":1FCC
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SSO.frx":22C0
            Key             =   "pr"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SSO.frx":26CC
            Key             =   "d"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SSO.frx":27D8
            Key             =   "pre"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SSO.frx":2B2C
            Key             =   "brw"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SSO.frx":2F40
            Key             =   "cpy"
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SSO.frx":348C
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.Toolbar Toolbar1 
      ...
      Begin VB.ListBox List10 
         ...
         Enabled         =   0   'False
         Height          =   225
         ItemData        =   "M_FRM_SSO.frx":38E0
         Left            =   6840
         List            =   "M_FRM_SSO.frx":38E7
         TabIndex        =   146
         Top             =   80
         Width           =   615
      End
      Begin VB.ListBox List9 
         Appearance      =   0  'Flat
         Height          =   225
         ItemData        =   "M_FRM_SSO.frx":38F3
         Left            =   7560
         List            =   "M_FRM_SSO.frx":38F5
         TabIndex        =   145
         TabStop         =   0   'False
      ...
      Begin VB.ListBox text1 
         Appearance      =   0  'Flat
         Height          =   225
         ItemData        =   "M_FRM_SSO.frx":38F7
         Left            =   5880
         List            =   "M_FRM_SSO.frx":3910
         TabIndex        =   85
         TabStop         =   0   'False
         Top             =   80
         Visible         =   0   'False
...
If SYS_NUM = False Then
    If MOD_REC = False Then
        ...
        RSINL.Open "select * from inv where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ like 'SAL'", CON, adOpenKeyset, adLockPessimistic
...
If MOD_REC = True Then
    ...
    REC_SET.Open "select * from inv where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ like 'SAL'", CON, adOpenKeyset, adLockPessimistic
...
ElseIf K = 13 Then
    If MS.Col = 2 Then
        ...
        If Trim(M_INV_IDY) <> "" Then
            REC_SET2.Open "select SUM(TOT_PCS),SUB_UNT from inv where BAT_IDY LIKE '" & Trim(MS.TextMatrix(MS.Row, 15)) & "' and inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ LIKE 'SAL' and stk_typ in('Salable','Free') GROUP BY BAT_IDY", CON, adOpenKeyset, adLockPessimistic
...
Else
    If pcs_chk.value = 1 Then
        .TextMatrix(.Row, 5) = convert(GetValue("PRD_RAT", "CSR where BAT_IDY LIKE '" & Trim(REC_SET("bat_idy")) & "' AND ACT_IDY LIKE '" & Trim(M_CST_IDY) & "'"))
    Else
        .TextMatrix(.Row, 5) = convert(Val(GetValue("PRD_RAT", "CSR where BAT_IDY LIKE '" & Trim(REC_SET("bat_idy")) & "' AND ACT_IDY LIKE '" & Trim(M_CST_IDY) & "'")) / Val(REC_SET("sub_unt")))
    End If
End If
...
For A = 1 To MS.Rows - 1
    ...
    If Trim(MS.TextMatrix(A, 0)) <> "" Then
        ...
        DIS_TOT = convert(Val(DIS_TOT) + Val(MS.TextMatrix(A, 6)))
