...
Begin VB.Form M_FRM_PCR 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(1)   =   "M_FRM_PCR.frx":0442
      ...
      TabCaption(2)   =   "a"
      TabPicture(2)   =   "M_FRM_PCR.frx":045E
      Tab(2).ControlEnabled=   0   'False
      Tab(2).ControlCount=   0
      TabCaption(3)   =   "View"
      TabPicture(3)   =   "M_FRM_PCR.frx":047A
      ...
      Begin VB.ListBox List6 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRM_PCR.frx":0496
         Left            =   -72000
         List            =   "M_FRM_PCR.frx":04A3
         TabIndex        =   25
         TabStop         =   0   'False
         Top             =   840
         Visible         =   0   'False
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_PCR.frx":04B0
            Key             =   "p"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_PCR.frx":09F4
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_PCR.frx":0DBC
            Key             =   "c"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_PCR.frx":1110
            Key             =   "e"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_PCR.frx":1748
            Key             =   "s"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_PCR.frx":1A9C
            Key             =   "h"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_PCR.frx":1EFC
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_PCR.frx":21F0
            Key             =   "pr"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_PCR.frx":25FC
            Key             =   "d"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_PCR.frx":2708
            Key             =   "pre"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_PCR.frx":2A5C
            Key             =   "brw"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_PCR.frx":2E70
            Key             =   "cpy"
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_PCR.frx":33BC
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Public Sub GRS_CAL()
M_GRS_AMT = convert(amt(Val(M_GRS_AMT)))
...
If MOD_REC = True Then
    ...
    REC_SET.Open "select * from inv where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ like 'PCR'", con, adOpenKeyset
...
For a = 1 To MS.Rows - 1
    If Trim(MS.TextMatrix(a, 0)) <> "" Then
        ...
        REC_SET("prd_qty") = QTY(Val(MS.TextMatrix(a, 2)))
        REC_SET("RET_QTY") = QTY(Val(MS.TextMatrix(a, 1)))
        REC_SET("prd_rat") = convert(amt(Val(MS.TextMatrix(a, 5))))
        If Len(Trim(MS.TextMatrix(a, 0))) <> 0 Then
            REC_SET("rat_app") = MS.TextMatrix(a, 4) & ""
        Else
            REC_SET("rat_app") = "A"
        End If
        REC_SET("txn_typ") = "PCR"
        REC_SET("COL_AMT") = convert(amt(MS.TextMatrix(a, 6)))
        REC_SET.Update
        con.Execute "update prd where prd_idy like '" & Trim(MS.TextMatrix(a, 0)) & "' set cur_lev = " & ADDQTY(Trim(MS.TextMatrix(a, 2)), Trim(MS.TextMatrix(a, 0)))
    End If
Next
MAKEINVOICE
If REC_SET1.State = 1 Then REC_SET1.Close
...
If check("PRT", "PRT_NME", "M_FRM_PCR") = True Then
    ...
    'Openreport CURDIR & "\VOUCH.RP1", "Van Challan Ret", 2, "inv->inv_idy='" & Trim(INC) & "'.and.inv->txn_typ='PCR'", 2
    Cancelrecord
End If
Cancelrecord
End Sub
...
If REC_SET.RecordCount > 0 Then
    ...
    Next
    SSTab1.Tab = 3
    Label49 = "Select Push Cart Challan"
    list5.ColumnHeaders.Item(1).Text = "Push Cart Challan"
...
Else
    If SSTab1.Tab = 0 Then
        MsgBox "Push Cart Challan Number Not Found...!", vbExclamation, "Effmcg"
        SSTab1.Tab = 0
...
If REC_SET.RecordCount > 0 Then
    ...
    Next
    SSTab1.Tab = 3
    Label49 = "Select Push Cart Return Challan"
    list5.Visible = True
    list5.SetFocus
Else
    If SSTab1.Tab = 0 Then
        MsgBox "Push Cart Return Challan Number Not Found...!", vbExclamation, "Effmcg"
        SSTab1.Tab = 0
        M_INV_IDY.Enabled = True
        SendKeys "{HOME}+{END}"
        M_INV_IDY.SetFocus
...
MS.TextMatrix(0, 7) = "Product Name"
MS.TextMatrix(0, 8) = "Short Name"
MS.Col = 0
MS.Col = 3
...
If KeyAscii = 13 Then
If list5.ListItems.Count > 0 Then
    If Label49 = "Select Push Cart Challan" Then
...
ElseIf Check1.Value = 0 Then
    Check2.Value = 1
End If
If Label49.Caption = "Select Push Cart Voucher" Then
    V_VAN_LST
...
If KeyCode = 13 Then
    OPS_STK = P_SUB_UNT(MS.TextMatrix(MS.Row, 1), MS.TextMatrix(MS.Row, 9))
    CUR_STK = P_SUB_UNT(QTY(Text1), MS.TextMatrix(MS.Row, 9))
    If Val(OPS_STK) < Val(CUR_STK) Then
        Text1 = QTY(Text1)
...
If check("prt", "prt_nme", "M_FRM_PCR") = False Then
CHECK3.Value = 0
Else
CHECK3.Value = 1
End If
...
If REC_SET.RecordCount > 0 Then
    ...
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from inv,PRD where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ = 'PCR' AND INV.PRD_IDY LIKE PRD.PRD_IDY", con, adOpenKeyset, adLockOptimistic
    MS.Rows = REC_SET.RecordCount + 1
    For a = 1 To MS.Rows - 1
        MS.TextMatrix(a, 0) = Trim(REC_SET("prd_idy"))
        MS.TextMatrix(a, 1) = QTY(REC_SET("RET_QTY") & "")
        ...
        MS.TextMatrix(a, 9) = Val(REC_SET("SUB_UNT"))
        REC_SET.MoveNext
    Next
    discalc
    SSTab1.Tab = 0
...
If k = 13 Or k = 40 Or k = 38 Then
    ...
    If REC_SET.RecordCount > 0 Then
        ...
        If MOD_REC = False Then Loadproducts
        SSTab1.Tab = 1
        MS.SetFocus
        If k = 38 Then
            M_INV_DAT.SetFocus
...
For a = 1 To MS.Rows - 1
    ...
    M_GRS_AMT = M_GRS_AMT + Val(MS.TextMatrix(a, 6))
    End If
Next
M_GRS_AMT = convert(amt(M_GRS_AMT))
Total = convert(amt(M_GRS_AMT))
    ...
    If .RecordCount > 0 Then
        ...
        For a = 1 To .RecordCount
            ...
            If REC_SET1.RecordCount > 0 Then
                ...
                MS.TextMatrix(a, 5) = convert(amt(REC_SET1("SAL_rat") & ""))
                End If
                MS.TextMatrix(a, 7) = Trim(REC_SET1("PRD_nme"))
                MS.TextMatrix(a, 8) = Trim(REC_SET1("PRD_prn"))
                MS.TextMatrix(a, 9) = REC_SET1("sub_unt")
                SSTab1.Tab = 1
                MS.Row = MS.Rows - 1
            End If
            .MoveNext
...
If MOD_REC = True Then
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "SELECT * FROM INL WHERE INV_IDY LIKE '" & Trim(M_INV_IDY) & "'", con, adOpenKeyset, adLockOptimistic
    If REC_SET.RecordCount > 0 Then ORD_IDY = Trim(REC_SET("ORD_IDY") & "")
    
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "SELECT * FROM INL WHERE ORD_IDY LIKE '" & Trim(ORD_IDY) & "' AND TXN_TYP LIKE 'LSL'", con, adOpenKeyset, adLockOptimistic
    If REC_SET.RecordCount > 0 Then ORD_IDY = Trim(REC_SET("INV_IDY") & "")
    
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from inl where inv_idy like '" & Trim(ORD_IDY) & "' and txn_typ like 'LSL'", con, adOpenKeyset, adLockOptimistic
    INC = Trim(ORD_IDY)
    con.Execute "DELETE FROM INV WHERE INV_IDY LIKE '" & Trim(ORD_IDY) & "' AND TXN_TYP LIKE 'LSL'"
Else
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from inl", con, adOpenKeyset, adLockOptimistic
    REC_SET.AddNew
...
RS.Open "SELECT * FROM INL WHERE INV_IDY LIKE '" & Trim(m_van_idy) & "'", con, adOpenKeyset, adLockOptimistic
If RS.RecordCount > 0 Then
REC_SET("cst_idy") = RS("CST_IDY") & ""
REC_SET("act_idy") = RS("ACT_IDY") & ""
REC_SET("smn_idy") = RS("SMN_IDY") & ""
End If
REC_SET("txn_typ") = "LSL"
REC_SET("grs_amt") = convert(amt(Val(M_GRS_AMT)))
REC_SET("net_amt") = Val(M_GRS_AMT)
REC_SET.Update
If REC_SET.State = 1 Then REC_SET.Close
REC_SET.Open "select * from inv", con, adOpenKeyset, adLockOptimistic
For a = 1 To MS.Rows - 1
    ...
    End If
Next
If MOD_REC = True Then MsgBox "New Invoice ID " & Trim(INC)
End Sub
