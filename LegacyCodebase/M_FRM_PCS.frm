...
Begin VB.Form M_FRM_PCS 
   ...
   Caption         =   "Push Cart Sales (Units)"
   ClientHeight    =   5625
   ClientLeft      =   1425
   ClientTop       =   1845
   ClientWidth     =   8820
   ForeColor       =   &H00FFFFFF&
   Icon            =   "M_FRM_PCS.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin MSComctlLib.Toolbar Toolbar1 
      ...
      Begin VB.ListBox text1 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRM_PCS.frx":0442
         Left            =   7080
         List            =   "M_FRM_PCS.frx":045B
         TabIndex        =   104
         TabStop         =   0   'False
         Top             =   50
         Visible         =   0   'False
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "M_FRM_PCS.frx":049F
      ...
      TabPicture(1)   =   "M_FRM_PCS.frx":04BB
      ...
      TabPicture(2)   =   "M_FRM_PCS.frx":04D7
      ...
      TabPicture(3)   =   "M_FRM_PCS.frx":04F3
      ...
      TabCaption(4)   =   "View"
      TabPicture(4)   =   "M_FRM_PCS.frx":050F
      ...
      Begin VB.ListBox List6 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRM_PCS.frx":052B
         Left            =   -72960
         List            =   "M_FRM_PCS.frx":0538
         TabIndex        =   65
         TabStop         =   0   'False
         Top             =   720
         Visible         =   0   'False
      ...
      Begin VB.ListBox M_ROU_IDY 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRM_PCS.frx":0545
         Left            =   -70080
         List            =   "M_FRM_PCS.frx":05B5
         TabIndex        =   61
         TabStop         =   0   'False
         Top             =   2640
         Width           =   495
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_PCS.frx":0625
               Key             =   "p"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_PCS.frx":0B69
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_PCS.frx":0F31
               Key             =   "c"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_PCS.frx":1285
               Key             =   "e"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_PCS.frx":18BD
               Key             =   "s"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_PCS.frx":1C11
               Key             =   "h"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_PCS.frx":2071
               Key             =   ""
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_PCS.frx":2365
               Key             =   "pr"
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_PCS.frx":2771
               Key             =   "d"
            EndProperty
            BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_PCS.frx":287D
               Key             =   "pre"
            EndProperty
            BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_PCS.frx":2BD1
               Key             =   "brw"
            EndProperty
            BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_PCS.frx":2FE5
               Key             =   "cpy"
            EndProperty
            BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_PCS.frx":3531
               Key             =   ""
            EndProperty
         EndProperty
      End
...
If check("PRT", "PRT_NME", "M_FRM_PCS") = True Then
    ...
    OpenDocument CURDIR & "\VOUCH.RP1", "Push Cart Challan", 2, Trim(INC), Trim(INC), 2, CURDIR & "\inv.cdx,c,inv_idy"
    Cancelrecord
End If
Cancelrecord
End Sub
...
If REC_SET.State = 1 Then REC_SET.Close
If Check1.Value = 1 Then
REC_SET.Open "select inl.inv_idy,inl.inv_dat,act.act_nme,act.act_ad4 from act,inl where act_nme like '" & Trim(M_INV_IDY) & "%' and inl.cst_idy=act.act_idy and inl.txn_typ ='SAL' AND LEN(TRIM(ORD_IDY))=10 AND SUBSTR(ORD_IDY,1,3) LIKE 'SAL' AND INL.INV_DAT = CTOD('" & INVOICE_DATE & "')", con, adOpenKeyset, adLockOptimistic
Else
REC_SET.Open "select inl.inv_idy,inl.inv_dat,act.act_nme,act.act_ad4 from act,inl where act_ad4 like '" & Trim(M_INV_IDY) & "%' and inl.cst_idy=act.act_idy and inl.txn_typ ='SAL' AND LEN(TRIM(ORD_IDY))=10 AND SUBSTR(ORD_IDY,1,3) LIKE 'SAL' AND INL.INV_DAT = CTOD('" & INVOICE_DATE & "')", con, adOpenKeyset, adLockOptimistic
End If
list5.ListItems.Clear
If REC_SET.RecordCount > 0 Then
    For A = 1 To REC_SET.RecordCount
...
ElseIf MS.Col = 5 Then
    ...
    If (Val(TOT_UNT) - Val(SAL_UNT)) < 0 Then
        MsgBox "Invalid Stock, Closing Cannot be Greater than Total Stock", vbInformation
        SendKeys "{home}+{end}"
        M_FLX_AMT.SetFocus
        Exit Sub
    End If
...
If ButtonMenu.KEY = "dt" Then
    If MOD_REC = True Then Openreport CURDIR & "\VOUCH.RP1", "Invoice", 2, "INV->INV_IDY='" & Trim(M_INV_IDY) & "'", 6
