...
Begin VB.Form M_FRM_LDS 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      ForeColor       =   8388608
      TabCaption(0)   =   "&Load Sheet"
      TabPicture(0)   =   "M_FRM_LDS.frx":0442
      ...
      TabPicture(1)   =   "M_FRM_LDS.frx":045E
      ...
      TabPicture(2)   =   "M_FRM_LDS.frx":047A
      ...
      TabCaption(3)   =   "View"
      TabPicture(3)   =   "M_FRM_LDS.frx":0496
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ListBox Route 
            ...
            Enabled         =   0   'False
            Height          =   480
            ItemData        =   "M_FRM_LDS.frx":04B2
            Left            =   7080
            List            =   "M_FRM_LDS.frx":04B4
            Style           =   1  'Checkbox
            TabIndex        =   22
            TabStop         =   0   'False
            Top             =   165
      ...
      Begin VB.ListBox List2 
         Height          =   2205
         ItemData        =   "M_FRM_LDS.frx":04B6
         Left            =   6960
         List            =   "M_FRM_LDS.frx":04B8
      ...
      Begin VB.Label Label8 
         AutoSize        =   -1  'True
         Caption         =   "Loading Invoice Net Amounts Please wait.."
         Height          =   195
         Left            =   -74880
         TabIndex        =   40
         Top             =   4800
      ...
      Begin VB.Label Label6 
         AutoSize        =   -1  'True
         Caption         =   "Processing Invoices Please wait.."
         Height          =   195
         Left            =   3000
         TabIndex        =   38
         Top             =   4800
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_LDS.frx":04BA
            Key             =   "p"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_LDS.frx":09FE
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_LDS.frx":0DC6
            Key             =   "c"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_LDS.frx":111A
            Key             =   "e"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_LDS.frx":1752
            Key             =   "s"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_LDS.frx":1AA6
            Key             =   "h"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_LDS.frx":1F06
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_LDS.frx":21FA
            Key             =   "pr"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_LDS.frx":2606
            Key             =   "d"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_LDS.frx":2712
            Key             =   "pre"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_LDS.frx":2A66
            Key             =   "brw"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_LDS.frx":2E7A
            Key             =   "cpy"
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.Toolbar Toolbar1 
      ...
      Begin VB.CommandButton M_VAN_CNV 
         Caption         =   "Load Sheet Xrf -> Van &Challan"
         Enabled         =   0   'False
         Height          =   330
         Left            =   6360
         TabIndex        =   41
...
rs.Open "SELECT * FROM INL,ACT WHERE ACT.ACT_IDY LIKE INL.CST_IDY AND INV_IDY in (SELECT CST_IDY FROM NPO) AND INL.TXN_TYP = 'SAL'", con, adOpenKeyset, adLockPessimistic
...
For A = 1 To List2.ListCount
    If List2.Selected(A - 1) = True Then
        ...
        rs.Open "SELECT * FROM INL,ACT WHERE ACT.ACT_IDY = INL.CST_IDY AND INL.TXN_TYP = 'SAL' AND INV_IDY LIKE '" & Trim(List2.List(A - 1)) & "'", con, adOpenKeyset, adLockPessimistic
...
If MOD_REC = True Then
    ...
    RSINL.Open "select * from inl where dch_idy like '" & Trim(LDS_IDY) & "' AND INL.TXN_TYP = 'SAL'", con, adOpenKeyset, adLockPessimistic
    List2.CLEAR
    MOD_REC = True
...
Tot_lbl = "0.00"
GETINVOICE
RSINL.Open "select * from inl,act,mar where inl.cst_idy = act.act_idy and act.mar_idy = mar.mar_idy AND TXN_TYP = 'SAL' and inv_idy in (SELECT CST_IDY FROM NPO)", con, adOpenKeyset, adLockPessimistic
...
RSINL.Open "SELECT SUM(TOT_PCS),BAT_IDY,INV.STK_TYP,INV.SUB_UNT,PRD_IDY,PRD_RAT FROM INL,INV WHERE INL.INV_IDY = INV.INV_IDY AND INL.TXN_TYP = 'SAL' AND INV.INV_IDY IN (SELECT CST_IDY FROM NPO) GROUP BY BAT_IDY,INV.STK_TYP", con, adOpenKeyset, adLockPessimistic
b = 1
chk = True
...
For A = 1 To RSINL.RecordCount
    If Trim(RSINL!stk_typ) = "Salable" Then
        ...
        If chk = True Then
            MS.AddItem ""
            MS.TextMatrix(b, 0) = ""
            If Int(Val(RSINL(0))) > 0 And Int(Val(RSINL(3))) > 0 Then
                MS.TextMatrix(b, 1) = Int(Val(RSINL(0)) / Val(RSINL(3)))
            Else
                MS.TextMatrix(b, 1) = 0#
            End If
            If Val(RSINL(3)) > 0 Then
...
For A = 1 To MS.Rows - 1
    ...
    If MS.TextMatrix(A, 0) <> "" Then
        ...
        If Val(MS.TextMatrix(A, 9)) > 0 Then
...
If K = 27 Then
    If list4.Visible = True And LST_CAP = "Select Load Sheet" Then
        list4.Visible = False
        SSTab1.Tab = 0
        LDS_IDY.SetFocus
    ...
    ElseIf list4.Visible = True And LST_CAP = "Select Market" Then
        ...
        MAR_IDY.SetFocus
    Else
        If M_FRM_LDS.ActiveControl.name = "LDS_IDY" Then
            Unload Me
        ElseIf List2.ListCount = 0 Then
            MsgBox "No Invoices Found!", vbInformation, "DAS Version 4.0"
            CANCELRECORD
        Else
            saverecord
        End If
...
'If List1.Visible = False And List2.Visible = False And list3.Visible = False And list4.Visible = False And list5.Visible = False Then
    ...
    If KeyCode = 69 And Shift = 2 Then
        If M_FRM_LDS.ActiveControl.name = "LDS_IDY" Then
            V_LDS_LST
        ElseIf M_FRM_LDS.ActiveControl.name = "M_INV_IDY" Then
            'V_INV_LST
        ElseIf M_FRM_LDS.ActiveControl.name = "M_CST_IDY" Then
            'V_DLR_LST
        ElseIf M_FRM_LDS.ActiveControl.name = "M_SMN_IDY" Then
            'V_SMN_LST
        ElseIf M_FRM_LDS.ActiveControl.name = "M_ACT_IDY" Then
            'V_ACT_LST
        ElseIf M_FRM_LDS.ActiveControl.name = "Text3" Then
            'V_PRD_LST
        End If
    End If
...
If KeyCode > 111 And KeyCode < 120 Then If TypeOf M_FRM_LDS.ActiveControl Is TextBox Then M_FRM_LDS.ActiveControl.Text = FUNKEY(KeyCode)
End Sub
...
If K = 13 Then
    ...
    Else
        ...
        If Len(Trim(LDS_IDY)) <> 10 Then
            RSlds.Open "SELECT * FROM LDS WHERE LDS_IDY LIKE 'LDS" & Tincrement(Trim(LDS_IDY)) & "' AND LDS_TYP = 'SAL'", con, adOpenKeyset, adLockPessimistic
        Else
            RSlds.Open "SELECT * FROM LDS WHERE LDS_IDY LIKE '" & Trim(LDS_IDY) & "' AND LDS_TYP = 'SAL'", con, adOpenKeyset, adLockPessimistic
        End If
        If RSlds.RecordCount > 0 Then
            ...
            displaydetails
        Else
            MsgBox "Invalid Delivery Sheet Number !", vbExclamation, "DAS Version 4.0"
            LDS_IDY.SetFocus
            SendKeys "{home}+{end}"
        End If
    End If
...
If Trim(LST_CAP) = "Select Market" Then
    ...
    Command5.SetFocus
ElseIf LST_CAP = "Select Load Sheet" Then
...
If MS.TextMatrix(MS.Row, 8) <> "" Then
    RSINV.Open "SELECT SUM(TOT_PCS),INL.INV_IDY,INL.CST_IDY FROM INL,INV WHERE INL.INV_IDY = INV.INV_IDY AND INV.TXN_TYP = 'SAL' AND INV.BAT_IDY = '" & Trim(MS.TextMatrix(MS.Row, 8)) & "' AND INV.STK_TYP IN('Free','Salable','Replc.') and INV.INV_IDY IN(SELECT CST_IDY FROM NPO) GROUP BY INV.INV_IDY", con, adOpenKeyset, adLockPessimistic
    MS1.Rows = 1
    MS1.ColWidth(3) = 0
    MS1.ColWidth(4) = 1200
...
RSINV.Open "SELECT ACT_IDY,ACT_NME,MAR_NME FROM ACT,MAR WHERE ACT.MAR_IDY = MAR.MAR_IDY", con, adOpenKeyset, adLockPessimistic
...
Dim REC_SET As New ADODB.Recordset
Dim lst As ListItem
LST_CAP = "Select Load Sheet"
If REC_SET.State = 1 Then REC_SET.Close
REC_SET.Open "select * from lds WHERE LDS_TYP = 'SAL'", con, adOpenKeyset, adLockPessimistic
list4.ListItems.CLEAR
If REC_SET.RecordCount > 0 Then
...
Dim lst As ListItem
Dim RSINL As New ADODB.Recordset
M_FRM_LDS.MousePointer = vbHourglass
    If VAN_CHK.Value = 1 Then
        RSINL.Open "SELECT INV_IDY,ACT_NME,NET_AMT FROM INL,ACT WHERE INL.ORD_IDY  =  '" & Trim(VAN_IDY) & "' AND INL.CST_IDY  =  ACT.ACT_IDY AND INL.TXN_TYP = 'SAL'", con, adOpenKeyset, adLockPessimistic
    Else
    If ALL_CHK.Value = 1 Then
        RSINL.Open "SELECT inv_idy,act_nme,net_amt FROM INL,ACT WHERE INL.CST_IDY  =  ACT.ACT_IDY AND INV_DAT >=CTOD('" & FRM_DAT & "') AND INV_DAT <=CTOD('" & TO_DAT & "') AND INL.TXN_TYP  =  'SAL' and DCH_IDY = ''" & CTR1, con, adOpenKeyset, adLockPessimistic
    Else
        If smn_chk.Value = True Then
            RSINL.Open "SELECT inv_idy,act_nme,net_amt FROM INL,ACT WHERE INL.CST_IDY  =  ACT.ACT_IDY AND INV_DAT >=CTOD('" & FRM_DAT & "') AND INV_DAT <=CTOD('" & TO_DAT & "') AND TXN_TYP  =  'SAL' AND INL.SMN_IDY  =  '" & Trim(SMN_IDY) & "%'" & CTR1 & " AND RTRIM(LTRIM(DCH_IDY))=''", con, adOpenKeyset, adLockPessimistic
        ElseIf mar_chk.Value = True Then
            RSINL.Open "SELECT inv_idy,act_nme,net_amt FROM INL,ACT WHERE INL.CST_IDY  =  ACT.ACT_IDY AND INV_DAT >=CTOD('" & FRM_DAT & "') AND INV_DAT <=CTOD('" & TO_DAT & "') AND TXN_TYP  =  'SAL' AND ACT.MAR_IDY  =  '" & Trim(MAR_IDY) & "%'" & CTR1 & " AND RTRIM(LTRIM(DCH_IDY))=''", con, adOpenKeyset, adLockPessimistic
        ElseIf Option3.Value = True Then
            QRY1 = GETROUTE
            If Trim(QRY1) = "" Then QRY1 = "''"
            RSINL.Open "SELECT inv_idy,act_nme,net_amt FROM INL,ACT WHERE INL.CST_IDY  =  ACT.ACT_IDY AND INV_DAT >=CTOD('" & FRM_DAT & "') AND INV_DAT <=CTOD('" & TO_DAT & "') AND TXN_TYP  =  'SAL' AND INL.ROU_IDY IN(" & QRY1 & ")" & CTR1 & "AND RTRIM(LTRIM(DCH_IDY))=''", con, adOpenKeyset, adLockPessimistic
        Else
            Exit Sub
        End If
     End If
    End If
M_FRM_LDS.MousePointer = vbNormal
If RSINL.EOF = True Then
   MsgBox "No Invoices Found For this Load Sheet Combination", vbExclamation
   If LDS_IDY.Enabled = False Then
'        FRM_DAT.SetFocus
        DTPicker1.SetFocus
    Else
...
If MOD_REC = False Then
    ...
    GETINVOICE
    If RSINL.State = 1 Then RSINL.Close
    RSINL.Open "SELECT * FROM INL WHERE INV_IDY IN(SELECT CST_IDY FROM NPO) AND INL.TXN_TYP = 'SAL'", con, adOpenKeyset, adLockPessimistic
    If RSINL.RecordCount > 0 Then
        For A = 1 To RSINL.RecordCount
...
'    End If
'    If ALL_CHK.Value = 1 Then
'        RSINL.Open "SELECT * FROM INL,ACT WHERE INL.CST_IDY LIKE ACT.ACT_IDY AND INV_DAT >=CTOD('" & FRM_DAT & "') AND INV_DAT <=CTOD('" & TO_DAT & "') AND TXN_TYP = 'SAL'" & CTR, CON, adOpenKeyset, adlockpessimistic
'    Else
'        If smn_chk.Value = True Then
'            RSINL.Open "SELECT * FROM INL,ACT WHERE INL.CST_IDY LIKE ACT.ACT_IDY AND INV_DAT >=CTOD('" & FRM_DAT & "') AND INV_DAT <=CTOD('" & TO_DAT & "') AND TXN_TYP = 'SAL' AND INL.SMN_IDY LIKE '" & Trim(SMN_IDY) & "'" & CTR, CON, adOpenKeyset, adlockpessimistic
'        ElseIf mar_chk.Value = True Then
'            RSINL.Open "SELECT * FROM INL,ACT WHERE INL.CST_IDY LIKE ACT.ACT_IDY AND INV_DAT >=CTOD('" & FRM_DAT & "') AND INV_DAT <=CTOD('" & TO_DAT & "') AND TXN_TYP = 'SAL' AND ACT.MAR_IDY LIKE '" & Trim(MAR_IDY) & "'" & CTR, CON, adOpenKeyset, adlockpessimistic
'        ElseIf Option3.Value = True Then
...
'                End If
'            Next
'            RSINL.Open "SELECT * FROM INL,ACT WHERE INL.CST_IDY LIKE ACT.ACT_IDY AND INV_DAT >=CTOD('" & FRM_DAT & "') AND INV_DAT <=CTOD('" & TO_DAT & "') AND TXN_TYP = 'SAL' AND INL.ROU_IDY IN(" & query & ") AND SUBSTR(INV_IDY,1,3)='SAL' " & CTR, CON, adOpenKeyset, adlockpessimistic
'        End If
'    End If
...
ElseIf Button.KEY = "ed" Then
    ...
    ElseIf M_FRM_LDS.ActiveControl.name = "M_ACT_IDY" Then
        ...
        'V_ACT_LST
    ElseIf M_FRM_LDS.ActiveControl.name = "Text3" Or (MS.Col = 0 And SSTab1.Tab = 1) Then
        'V_PRD_LST
    End If
...
If check("prt", "prt_nme", "M_FRM_LDS") = False Then
Check3.Value = 0
Else
Check3.Value = 1
End If
...
Dim RSINL As New ADODB.Recordset
If ALL_CHK.Value = 1 Then
    RSINL.Open "SELECT * FROM INL,ACT WHERE INL.CST_IDY LIKE ACT.ACT_IDY AND INV_DAT >=CTOD('" & FRM_DAT & "') AND INV_DAT <=CTOD('" & TO_DAT & "') AND TXN_TYP = 'SAL' AND DCH_IDY IN('','" & Trim(LDS_IDY) & "')", con, adOpenKeyset, adLockPessimistic
Else
    If smn_chk.Value = True Then
        RSINL.Open "SELECT * FROM INL,ACT WHERE INL.CST_IDY LIKE ACT.ACT_IDY AND INV_DAT >=CTOD('" & FRM_DAT & "') AND INV_DAT <=CTOD('" & TO_DAT & "') AND TXN_TYP = 'SAL' AND INL.SMN_IDY LIKE '" & Trim(SMN_IDY) & "%'" & CTR & " AND DCH_IDY IN('','" & Trim(LDS_IDY) & "')", con, adOpenKeyset, adLockPessimistic
    ElseIf mar_chk.Value = True Then
        RSINL.Open "SELECT * FROM INL,ACT WHERE INL.CST_IDY LIKE ACT.ACT_IDY AND INV_DAT >=CTOD('" & FRM_DAT & "') AND INV_DAT <=CTOD('" & TO_DAT & "') AND TXN_TYP = 'SAL' AND ACT.MAR_IDY LIKE '" & Trim(MAR_IDY) & "%'" & CTR & " AND DCH_IDY IN('','" & Trim(LDS_IDY) & "')", con, adOpenKeyset, adLockPessimistic
    ElseIf Option3.Value = True Then
        RSINL.Open "SELECT * FROM INL,ACT WHERE INL.CST_IDY LIKE ACT.ACT_IDY AND INV_DAT >=CTOD('" & FRM_DAT & "') AND INV_DAT <=CTOD('" & TO_DAT & "') AND TXN_TYP = 'SAL' AND INL.ROU_IDY IN(" & GETROUTE & ")" & CTR & " AND DCH_IDY IN('','" & Trim(LDS_IDY) & "')", con, adOpenKeyset, adLockPessimistic
    Else
        Exit Sub
    End If
End If
...
With MDIForm1
    If Len(Trim(LDS_IDY)) = 0 Then
        MsgBox "Select Load Sheet To Print", vbExclamation, "DAS Version 4.0"
        SSTab1.Tab = 0
        LDS_IDY.Enabled = True
        LDS_IDY.SetFocus
        Exit Sub
...
If ButtonMenu.KEY = "LDS_BAT" Then
    OpenReport CURDIR & "\REP_LIB.RP1", "Load Sheet", 2, SAL_QRY, 6
ElseIf ButtonMenu.KEY = "LDS_PRD" Then
    OpenReport CURDIR & "\REP_LIB.RP1", "Load Sheet Product", 2, SAL_QRY, 6
ElseIf ButtonMenu.KEY = "LDS_INV" Then
    OpenReport CURDIR & "\REP_LIB.RP1", "Load Sheet Invoice Track", 2, SAL_QRY, 6
ElseIf ButtonMenu.KEY = "LDS_PTR" Then
    SAL_QRY = "INL->DCH_IDY = '" & Trim(LDS_IDY) & "'"
    OpenReport CURDIR & "\REP_LIB.RP1", "Load Sheet Product Track", 2, SAL_QRY, 6
ElseIf ButtonMenu.KEY = "TRP_SHT" Then
    SAL_QRY = "INL->DCH_IDY = '" & Trim(LDS_IDY) & "' .and. INV->STK_TYP <> 'Shortage'"
    OpenReport CURDIR & "\REP_LIB.RP1", "Trip Sheet", 2, SAL_QRY, 6
End If
End With
End Sub
...
If Len(Trim(LDS_IDY)) > 0 Then
    If MsgBox("Convert this Load Sheet to Van Challan with Returns Posted Ticked ?", vbOKCancel) = vbOK Then
        Dim VAN_RS As New ADODB.Recordset, INL_RS As New ADODB.Recordset, INV_RS As New ADODB.Recordset, SNV_RS As New ADODB.Recordset, CUR_RS As New ADODB.Recordset, LDS_RS As New ADODB.Recordset
        ...
        INL_RS.Open "SELECT SUM(TOT_PCS),BAT_IDY,INV.STK_TYP,INV.SUB_UNT,PRD_IDY,PRD_RAT,INL.SMN_IDY,INL.ROU_IDY,INV.TRD_TAX FROM INL,INV WHERE INL.DCH_IDY LIKE '" & Trim(LDS_IDY) & "' AND INL.INV_IDY LIKE INV.INV_IDY AND INL.TXN_TYP = 'SAL' GROUP BY BAT_IDY,INV.STK_TYP", con, adOpenKeyset, adLockPessimistic
        'AND INV.INV_IDY IN (SELECT CST_IDY FROM NPO)
        ...
        While Not INL_RS.EOF
            If Trim(INL_RS("STK_TYP")) = "Free" Then
                If VAN_RS.State = 1 Then VAN_RS.Close
                VAN_RS.Open "SELECT * FROM VAN where VAN.BAT_IDY = '" & Trim(INL_RS("BAT_IDY")) & "' AND VAN.LDS_IDY LIKE '" & Trim(LDS_IDY) & "'", con, adOpenKeyset, adLockPessimistic
    ...
    End If
    If INL_RS.State = 1 Then INL_RS.Close
    INL_RS.Open "SELECT INV_IDY FROM INL WHERE DCH_IDY = '" & Trim(LDS_IDY) & "' AND TXN_TYP = 'SAL'", con, adOpenKeyset, adLockPessimistic
    If INL_RS.RecordCount > 0 Then
        While Not INL_RS.EOF
            If INV_RS.State = 1 Then INV_RS.Close
            INV_RS.Open "SELECT * FROM INV WHERE INV_IDY = '" & Trim(INL_RS("INV_IDY")) & "' AND TXN_TYP = 'SAL'", con, adOpenKeyset, adLockPessimistic
