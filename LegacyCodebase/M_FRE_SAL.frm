...
Begin VB.Form M_FRE_SAL 
   BackColor       =   &H8000000A&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Sales - System Bill Serial"
   ClientHeight    =   5625
   ClientLeft      =   1425
   ClientTop       =   1845
   ClientWidth     =   8820
   ForeColor       =   &H00FFFFFF&
   Icon            =   "M_FRE_SAL.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin MSComctlLib.Toolbar Toolbar1 
      ...
      Begin VB.ListBox text1 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRE_SAL.frx":0442
         Left            =   6960
         List            =   "M_FRE_SAL.frx":045B
         TabIndex        =   106
         TabStop         =   0   'False
         Top             =   50
         Visible         =   0   'False
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "M_FRE_SAL.frx":049F
      ...
      TabPicture(1)   =   "M_FRE_SAL.frx":04BB
      ...
      TabPicture(2)   =   "M_FRE_SAL.frx":04D7
      ...
      TabPicture(3)   =   "M_FRE_SAL.frx":04F3
      ...
      TabCaption(4)   =   "View"
      TabPicture(4)   =   "M_FRE_SAL.frx":050F
      ...
      Begin VB.ListBox List6 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRE_SAL.frx":052B
         Left            =   2040
         List            =   "M_FRE_SAL.frx":0538
         TabIndex        =   67
         TabStop         =   0   'False
         Top             =   720
         Visible         =   0   'False
      ...
      Begin VB.ListBox M_ROU_IDY 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRE_SAL.frx":0545
         Left            =   -70080
         List            =   "M_FRE_SAL.frx":05B5
         TabIndex        =   63
         TabStop         =   0   'False
         Top             =   2640
         Width           =   495
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_SAL.frx":0625
               Key             =   "p"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_SAL.frx":0B69
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_SAL.frx":0F31
               Key             =   "c"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_SAL.frx":1285
               Key             =   "e"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_SAL.frx":18BD
               Key             =   "s"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_SAL.frx":1C11
               Key             =   "h"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_SAL.frx":2071
               Key             =   ""
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_SAL.frx":2365
               Key             =   "pr"
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_SAL.frx":2771
               Key             =   "d"
            EndProperty
            BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_SAL.frx":287D
               Key             =   "pre"
            EndProperty
            BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_SAL.frx":2BD1
               Key             =   "brw"
            EndProperty
            BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_SAL.frx":2FE5
               Key             =   "cpy"
            EndProperty
            BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_SAL.frx":3531
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   End
End
Attribute VB_Name = "M_FRE_SAL"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim MOD_REC As Boolean, idnew As Boolean, ls As ListItem, M_DBT_RAP, MSROW, INVIDY, INC, dlr_idy, taxamt As Double, CHKNUM
...
If Val(M_NET_AMT) < 0 Then
    MsgBox "Invalid Invoice Net Amount!", vbExclamation, "Effmcg"
    SSTab1.Tab = 2
    M_EXD_AMT.SetFocus
    Exit Sub
End If
...
If MOD_REC = True Then
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from inv where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ IN('SAL','LSL')", CON, adOpenKeyset
    ...
    Next
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from inv where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ IN('FRS','FRC')", CON, adOpenKeyset
    For A = 1 To REC_SET.RecordCount
        CON.Execute "update prd where prd_idy like '" & REC_SET("prd_idy") & "' set cur_lev = " & ADDQTY(Val(REC_SET("prd_qty")), REC_SET("prd_idy"))
        REC_SET.MoveNext
    Next
    CON.Execute "delete from inv where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ IN('SAL','LSL')"
    CON.Execute "delete from inv where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ IN('FRS','FRC')"
    If REC_SET.State = 1 Then REC_SET.Close
...
For A = 1 To MS.Rows - 1
    If Trim(MS.TextMatrix(A, 0)) <> "" And (Val(Trim(MS.TextMatrix(A, 3))) <> "0.000" Or Val(Trim(MS.TextMatrix(A, 13))) > 0) Then
        ...
        Else
            REC_SET("rat_app") = "A"
        End If
        REC_SET("sch_amt") = Val(MS.TextMatrix(A, 7))
...
If check("PRT", "PRT_NME", "M_FRE_SAL") = True Then
...
If REC_SET.State = 1 Then REC_SET.Close
If Check1.Value = 1 Then
REC_SET.Open "select inl.inv_idy,inl.inv_dat,act.act_nme,act.act_ad4,ord_idy from act,inl where act_nme like '" & Trim(M_INV_IDY) & "%' and inl.cst_idy=act.act_idy and inl.txn_typ IN('LSL','SAL')", CON, adOpenKeyset, adLockOptimistic
Else
REC_SET.Open "select inl.inv_idy,inl.inv_dat,act.act_nme,act.act_ad4,ord_idy from act,inl where act_ad4 like '" & Trim(M_INV_IDY) & "%' and inl.cst_idy=act.act_idy and inl.txn_typ IN('LSL','SAL')", CON, adOpenKeyset, adLockOptimistic
End If
list5.ListItems.Clear
If REC_SET.RecordCount > 0 Then
    For A = 1 To REC_SET.RecordCount
        If Len(Trim(REC_SET!ORD_IDY)) <> 10 Then
...
If list1.Visible = False And list2.Visible = False And list3.Visible = False And list4.Visible = False And list5.Visible = False Then
    ...
    If KeyCode = 69 And Shift = 2 Then
        ...
        If M_FRE_SAL.ActiveControl.name = "M_INV_IDY" Then
            V_INV_LST
        ElseIf M_FRE_SAL.ActiveControl.name = "M_CST_IDY" Then
            V_DLR_LST
        ElseIf M_FRE_SAL.ActiveControl.name = "M_SMN_IDY" Then
            V_SMN_LST
        ElseIf M_FRE_SAL.ActiveControl.name = "M_ACT_IDY" Then
            V_ACT_LST
        ElseIf M_FRE_SAL.ActiveControl.name = "Text3" Then
            V_PRD_LST
        End If
    End If
End If
If KeyCode > 111 And KeyCode < 120 Then If TypeOf M_FRE_SAL.ActiveControl Is TextBox Then M_FRE_SAL.ActiveControl.Text = FUNKEY(KeyCode)
End Sub
...
ElseIf Button.KEY = "ed" Then
    ...
    ElseIf M_FRE_SAL.ActiveControl.name = "M_ACT_IDY" Then
        V_LST_CAP = "Select Account"
        V_ACT_LST
    ElseIf M_FRE_SAL.ActiveControl.name = "Text3" Or (MS.Col = 0 And SSTab1.Tab = 1) Then
        V_PRD_LST
    End If
...
If check("prt", "prt_nme", "m_fre_sal") = False Then
Check3.Value = 0
Else
Check3.Value = 1
End If
...
If REC_SET.State = 1 Then REC_SET.Close
If Len(Trim(M_INV_IDY)) <> 10 And CHKNUM = 1 Then
REC_SET.Open "select * from inl where inv_idy like '" & (Trim(M_INV_IDY)) & "' and txn_typ in('SAL','LSL') AND SUBSTR(ORD_IDY,1,3) NOT IN('SAL','RSI')", CON, adOpenKeyset
ElseIf Len(Trim(M_INV_IDY)) <> 10 Then
REC_SET.Open "select * from inl where inv_idy like 'SAL" & Tincrement(Trim(M_INV_IDY)) & "' and txn_typ in('SAL','LSL') AND SUBSTR(ORD_IDY,1,3) NOT IN('SAL','RSI')", CON, adOpenKeyset
Else
REC_SET.Open "select * from inl where inv_idy like '" & Tincrement(Trim(M_INV_IDY)) & "' and txn_typ in ('SAL','LSL') AND SUBSTR(ORD_IDY,1,3) NOT IN('SAL','RSI')", CON, adOpenKeyset
End If
If REC_SET.RecordCount > 0 Then
    If Len(Trim(M_INV_IDY)) <> 10 And CHKNUM = 1 Then
    ...
    End If
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from inv where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ in ('SAL','LSL')", CON, adOpenKeyset, adLockOptimistic
    ...
    For A = 1 To MS.Rows - 1
        ...
        End If
        If REC_SET2.State = 1 Then REC_SET2.Close
        REC_SET2.Open "SELECT * FROM INV WHERE INV_IDY LIKE '" & Trim(M_INV_IDY) & "' AND PRD_IDY LIKE '" & Trim(REC_SET("PRD_IDY")) & "' AND TXN_TYP IN ('FRS','FRC')", CON, adOpenKeyset, adLockOptimistic
        If REC_SET2.RecordCount > 0 Then
