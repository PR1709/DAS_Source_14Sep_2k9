...
Begin VB.Form M_FRE_SAL_CHG 
   BackColor       =   &H8000000A&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Rate Variance Sales "
   ClientHeight    =   5625
   ClientLeft      =   1425
   ClientTop       =   1845
   ClientWidth     =   8820
   ForeColor       =   &H00FFFFFF&
   Icon            =   "M_FRE_SAL_CHG.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin MSComctlLib.Toolbar Toolbar1 
      ...
      Begin VB.ListBox text1 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRE_SAL_CHG.frx":0442
         Left            =   6960
         List            =   "M_FRE_SAL_CHG.frx":045B
         TabIndex        =   106
         TabStop         =   0   'False
         Top             =   50
         Visible         =   0   'False
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "M_FRE_SAL_CHG.frx":049F
      ...
      TabPicture(1)   =   "M_FRE_SAL_CHG.frx":04BB
      ...
      TabPicture(2)   =   "M_FRE_SAL_CHG.frx":04D7
      ...
      TabPicture(3)   =   "M_FRE_SAL_CHG.frx":04F3
      ...
      TabCaption(4)   =   "View"
      TabPicture(4)   =   "M_FRE_SAL_CHG.frx":050F
      ...
      Begin VB.ListBox List6 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRE_SAL_CHG.frx":052B
         Left            =   2040
         List            =   "M_FRE_SAL_CHG.frx":0538
         TabIndex        =   67
         TabStop         =   0   'False
         Top             =   720
         Visible         =   0   'False
      ...
      Begin VB.ListBox M_ROU_IDY 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRE_SAL_CHG.frx":0545
         Left            =   -70080
         List            =   "M_FRE_SAL_CHG.frx":05B5
         TabIndex        =   63
         TabStop         =   0   'False
         Top             =   2640
         Width           =   495
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_SAL_CHG.frx":0625
               Key             =   "p"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_SAL_CHG.frx":0B69
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_SAL_CHG.frx":0F31
               Key             =   "c"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_SAL_CHG.frx":1285
               Key             =   "e"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_SAL_CHG.frx":18BD
               Key             =   "s"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_SAL_CHG.frx":1C11
               Key             =   "h"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_SAL_CHG.frx":2071
               Key             =   ""
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_SAL_CHG.frx":2365
               Key             =   "pr"
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_SAL_CHG.frx":2771
               Key             =   "d"
            EndProperty
            BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_SAL_CHG.frx":287D
               Key             =   "pre"
            EndProperty
            BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_SAL_CHG.frx":2BD1
               Key             =   "brw"
            EndProperty
            BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_SAL_CHG.frx":2FE5
               Key             =   "cpy"
            EndProperty
            BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_SAL_CHG.frx":3531
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   End
End
Attribute VB_Name = "M_FRE_SAL_CHG"
...
If check("PRT", "PRT_NME", "M_FRM_SAL_CHG") = True Then
...
If list1.Visible = False And List2.Visible = False And list3.Visible = False And list4.Visible = False And list5.Visible = False Then
    ...
    If KeyCode = 69 And Shift = 2 Then
        ...
        If M_FRE_SAL_CHG.ActiveControl.name = "M_INV_IDY" Then
            V_INV_LST
        ElseIf M_FRE_SAL_CHG.ActiveControl.name = "M_CST_IDY" Then
            V_DLR_LST
        ElseIf M_FRE_SAL_CHG.ActiveControl.name = "M_SMN_IDY" Then
            V_SMN_LST
        ElseIf M_FRE_SAL_CHG.ActiveControl.name = "M_ACT_IDY" Then
            V_ACT_LST
        ElseIf M_FRE_SAL_CHG.ActiveControl.name = "Text3" Then
            V_PRD_LST
        End If
    End If
End If
If KeyCode > 111 And KeyCode < 120 Then If TypeOf M_FRE_SAL_CHG.ActiveControl Is TextBox Then M_FRE_SAL_CHG.ActiveControl.Text = FUNKEY(KeyCode)
End Sub
...
ElseIf Button.KEY = "ed" Then
    ...
    ElseIf M_FRE_SAL_CHG.ActiveControl.name = "M_ACT_IDY" Then
        V_LST_CAP = "Select Account"
        V_ACT_LST
    ElseIf M_FRE_SAL_CHG.ActiveControl.name = "Text3" Or (MS.Col = 0 And SSTab1.Tab = 1) Then
        V_PRD_LST
    End If
...
If check("prt", "prt_nme", "M_FRE_SAL_CHG") = False Then
Check3.Value = 0
Else
Check3.Value = 1
End If
