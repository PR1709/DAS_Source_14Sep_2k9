...
Begin VB.Form M_VAN_SAL 
   ...
   Begin MSComctlLib.Toolbar Toolbar1 
      ...
      Begin VB.ListBox text1 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_VAN_SAL.frx":0442
         Left            =   6960
         List            =   "M_VAN_SAL.frx":045B
         TabIndex        =   105
         TabStop         =   0   'False
         Top             =   50
         Visible         =   0   'False
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "M_VAN_SAL.frx":049F
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "M_VAN_IDY"
      ...
      Tab(0).Control(10)=   "M_DBT_MCP"
      Tab(0).Control(11)=   "DBT_MCP"
      Tab(0).Control(12)=   "Shape2"
      Tab(0).Control(13)=   "Shape1"
      Tab(0).Control(14)=   "Line2(0)"
      Tab(0).Control(15)=   "Line1(0)"
      Tab(0).Control(16)=   "M_ACT_NME"
      Tab(0).Control(17)=   "M_SMN_NME"
      Tab(0).Control(18)=   "M_CST_AD4"
      Tab(0).Control(19)=   "M_CST_AD3"
      Tab(0).Control(20)=   "M_CST_AD2"
      Tab(0).Control(21)=   "M_CST_AD1"
      Tab(0).Control(22)=   "M_CST_NME"
      ...
      Tab(0).Control(29)=   "Label6"
      Tab(0).Control(30)=   "Label12"
      Tab(0).Control(31)=   "Label14"
      Tab(0).Control(32)=   "Label15"
      Tab(0).Control(33)=   "M_DBT_MCL"
      Tab(0).Control(34)=   "Label19"
      Tab(0).Control(35)=   "Label20"
      Tab(0).ControlCount=   36
      TabCaption(1)   =   "&Products"
      TabPicture(1)   =   "M_VAN_SAL.frx":04BB
      ...
      TabPicture(2)   =   "M_VAN_SAL.frx":04D7
      ...
      Tab(2).Control(16)=   "Label46"
      Tab(2).Control(17)=   "Label7"
      Tab(2).Control(18)=   "M_BEF_ROF"
      Tab(2).Control(19)=   "Label61"
      Tab(2).Control(20)=   "Label50"
      Tab(2).Control(21)=   "Label48"
      ...
      TabPicture(3)   =   "M_VAN_SAL.frx":04F3
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "M_LRN_AMT"
      Tab(3).Control(0).Enabled=   0   'False
      Tab(3).Control(1)=   "M_TXN_TPT"
      Tab(3).Control(1).Enabled=   0   'False
      Tab(3).Control(2)=   "M_WBL_IDY"
      Tab(3).Control(2).Enabled=   0   'False
      Tab(3).Control(3)=   "M_TXN_RMK"
      Tab(3).Control(3).Enabled=   0   'False
      Tab(3).Control(4)=   "M_TTL_CAS"
      Tab(3).Control(4).Enabled=   0   'False
      Tab(3).Control(5)=   "M_LRN_IDY"
      Tab(3).Control(5).Enabled=   0   'False
      Tab(3).Control(6)=   "M_WBL_DAT"
      Tab(3).Control(7)=   "M_LRN_DAT"
      Tab(3).Control(8)=   "Label59"
      Tab(3).Control(9)=   "Label58"
      Tab(3).Control(10)=   "Label57"
      Tab(3).Control(11)=   "Label56"
      Tab(3).Control(12)=   "Label55"
      Tab(3).Control(13)=   "Label54"
      Tab(3).Control(14)=   "Label53"
      Tab(3).Control(15)=   "Label51"
      Tab(3).ControlCount=   16
      TabCaption(4)   =   "View"
      TabPicture(4)   =   "M_VAN_SAL.frx":050F
      ...
      Begin VB.ListBox List6 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_VAN_SAL.frx":052B
         Left            =   2040
         List            =   "M_VAN_SAL.frx":0538
         TabIndex        =   66
         TabStop         =   0   'False
         Top             =   720
         Visible         =   0   'False
      ...
      Begin VB.ListBox M_ROU_IDY 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_VAN_SAL.frx":0545
         Left            =   -70080
         List            =   "M_VAN_SAL.frx":05B5
         TabIndex        =   62
         TabStop         =   0   'False
         Top             =   2640
         Width           =   495
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_VAN_SAL.frx":0625
               Key             =   "p"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_VAN_SAL.frx":0B69
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_VAN_SAL.frx":0F31
               Key             =   "c"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_VAN_SAL.frx":1285
               Key             =   "e"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_VAN_SAL.frx":18BD
               Key             =   "s"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_VAN_SAL.frx":1C11
               Key             =   "h"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_VAN_SAL.frx":2071
               Key             =   ""
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_VAN_SAL.frx":2365
               Key             =   "pr"
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_VAN_SAL.frx":2771
               Key             =   "d"
            EndProperty
            BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_VAN_SAL.frx":287D
               Key             =   "pre"
            EndProperty
            BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_VAN_SAL.frx":2BD1
               Key             =   "brw"
            EndProperty
            BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_VAN_SAL.frx":2FE5
               Key             =   "cpy"
            EndProperty
            BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_VAN_SAL.frx":3531
               Key             =   ""
            EndProperty
         EndProperty
      End
...
M_CSD_AMT = convert(amt(Round(Val(M_PRD_AMT) * Val(M_CSD_PCG) / 100, 2)))
M_CSD_DED = convert(amt(Round(Val((M_GRS_AMT) - Val(M_CSD_AMT)), 2)))
...
If Len(Trim(M_INV_IDY)) = 0 Then
    MsgBox "Invalid Invoice ID, Enter Invoice ID !", vbExclamation, "Effmcg"
    M_VAN_IDY.SetFocus
    SSTab1.Tab = 0
    Exit Sub
End If
If querycheck("INL", "INV_IDY", Trim(M_INV_IDY), " and len(trim(ord_idy))<>10") = True Then
    MsgBox "Invoice ID Already Exists", vbExclamation, "Effmcg"
    SSTab1.Tab = 0
    M_INV_IDY.SetFocus
    Exit Sub
End If

If check("inv", "inv_idy", Trim(M_VAN_IDY)) = False Then
    MsgBox "Challan Not Found, Enter Challan Number !", vbExclamation, "Effmcg"
    M_VAN_IDY.SetFocus
    SSTab1.Tab = 0
    Exit Sub
End If
...
End If
GRS_CAL
Dim rec_set4 As New ADODB.Recordset
If MOD_REC = True Then
    If REC_SET.State = 1 Then REC_SET.Close
    If rec_set4.State = 1 Then rec_set4.Close
    REC_SET.Open "select INT(SUM(((PRD_QTY-INT(PRD_QTY))*1000)+(INT(PRD_QTY)*SUB_UNT))/SUB_UNT)+(MOD(SUM(((PRD_QTY-INT(PRD_QTY))*1000)+(INT(PRD_QTY)*SUB_UNT)),SUB_UNT)/1000) PRD_QTY,INV.PRD_IDY from inv,PRD where INV.PRD_IDY LIKE PRD.PRD_IDY AND inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ IN ('SAL','FRS') GROUP BY INV.PRD_IDY", con, adOpenKeyset
    rec_set4.Open "SELECT * FROM INL WHERE ORD_IDY LIKE '" & Trim(M_VAN_IDY) & "' AND TXN_TYP LIKE 'RSR'", con, adOpenKeyset, adLockOptimistic
    If rec_set4.RecordCount = 0 Then
        For A = 1 To REC_SET.RecordCount
            If REC_SET2.State = 1 Then REC_SET2.Close
            REC_SET2.Open "SELECT * FROM INV WHERE inv.INV_IDY LIKE '" & Trim(M_VAN_IDY) & "' AND inv.PRD_IDY like '" & Trim(MS.TextMatrix(A, 0)) & "' AND TXN_TYP LIKE 'RSI'", con, adOpenKeyset, adLockOptimistic
                If REC_SET2.RecordCount > 0 Then
                    If REC_SET1.State = 1 Then REC_SET1.Close
                    REC_SET1.Open "select * from prd where prd_idy like '" & Trim(MS.TextMatrix(A, 0)) & "'", con, adOpenKeyset, adLockOptimistic
                    Ret_qty = P_SUB_UNT(QTY(Val(REC_SET2("ret_qty") & "")), REC_SET1("sub_unt"))
                    Ent_qty = P_SUB_UNT(QTY(REC_SET("PRD_QTY")), REC_SET1("sub_unt"))
                    REC_SET2("RET_QTY") = Val(P_QTY_UNT(Val(Ret_qty - Ent_qty), Val(REC_SET1("sub_unt"))))
                    REC_SET2.Update
                    REC_SET.MoveNext
                End If
        Next
    ...
    Next
    End If
    con.Execute "delete from inv where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ IN('SAL','FRS') AND LEN(TRIM(ORD_IDY))=10"
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from inl where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ like 'SAL'", con, adOpenKeyset, adLockOptimistic
    INC = M_INV_IDY
Else
...
For A = 1 To MS.Rows - 1
    If Trim(MS.TextMatrix(A, 0)) <> "" And (Val(Trim(MS.TextMatrix(A, 3))) <> "0.000" Or Val(Trim(MS.TextMatrix(A, 13))) > 0) Then
        REC_SET.AddNew
        ...
        Else
            REC_SET("rat_app") = "A"
        End If
        REC_SET("sch_amt") = MS.TextMatrix(A, 7) & ""
...
'        REC_SET("ADD_AMT") = (PRDNET * Val(MS.TextMatrix(A, 7)) / 100)
        ...
        If REC_SET1.State = 1 Then REC_SET1.Close
        If REC_SET2.State = 1 Then REC_SET2.Close
        REC_SET2.Open "SELECT * FROM INL WHERE ORD_IDY LIKE '" & Trim(M_VAN_IDY) & "' AND TXN_TYP LIKE 'RSR'", con, adOpenKeyset, adLockOptimistic
        If REC_SET2.RecordCount = 0 Then
            rec_set4.Open "SELECT * FROM INV WHERE inv.INV_IDY LIKE '" & Trim(M_VAN_IDY) & "' AND inv.PRD_IDY like '" & Trim(MS.TextMatrix(A, 0)) & "' AND TXN_TYP LIKE 'RSI'", con, adOpenKeyset, adLockOptimistic
            If rec_set4.RecordCount > 0 Then
            REC_SET1.Open "select * from prd where prd_idy like '" & Trim(MS.TextMatrix(A, 0)) & "'", con, adOpenKeyset, adLockOptimistic
                If REC_SET1.RecordCount > 0 Then
                    Ret_qty = P_SUB_UNT(QTY(rec_set4("ret_qty") & ""), REC_SET1("sub_unt"))
                    Ent_qty = P_SUB_UNT(QTY(MS.TextMatrix(A, 3)), REC_SET1("sub_unt"))
                    Fre_qty = P_SUB_UNT(QTY(MS.TextMatrix(A, 13)), REC_SET1("sub_unt"))
                    TOT_QTY = Val(Ret_qty) + Val(Ent_qty) + Val(Fre_qty)
                    rec_set4("ret_qty") = P_QTY_UNT(Str(TOT_QTY), Val(REC_SET1("sub_unt")))
                    rec_set4.Update
                End If
            End If
        Else
            con.Execute "update prd where prd_idy like '" & Trim(MS.TextMatrix(A, 0)) & "' set cur_lev = " & CONQTY(QTY(MS.TextMatrix(A, 3)), Trim(MS.TextMatrix(A, 0)))
            con.Execute "update prd where prd_idy like '" & Trim(MS.TextMatrix(A, 0)) & "' set cur_lev = " & CONQTY(QTY(MS.TextMatrix(A, 13)), Trim(MS.TextMatrix(A, 0)))
        End If
        If Val(MS.TextMatrix(A, 13)) <> 0 Then
            If RS.State = 1 Then RS.Close
            RS.Open "SELECT * FROM PRD WHERE PRD_IDY LIKE '" & Trim(MS.TextMatrix(A, 0)) & "'", con, adOpenKeyset, adLockOptimistic
            REC_SET.AddNew
            REC_SET("Inv_idy") = INC
            REC_SET("INV_DAT") = M_INV_DAT
            REC_SET("prd_idy") = Trim(MS.TextMatrix(A, 0))
            REC_SET("PRD_RAT") = Val(MS.TextMatrix(A, 4) & "")
            If RS.RecordCount > 0 Then REC_SET("COL_AMT") = RATCAL((QTY(MS.TextMatrix(A, 13) & "")), Val(MS.TextMatrix(A, 4)), RS("SUB_UNT"))
            REC_SET("prd_qty") = QTY(MS.TextMatrix(A, 13))
            REC_SET("ORD_IDY") = Trim(M_VAN_IDY)
            REC_SET("txn_typ") = "FRS"
            REC_SET.Update
        End If
...
If check("PRT", "PRT_NME", "M_VAN_SAL") = True Then
    ...
    OpenDocument CURDIR & "\VOUCH.RP1", "Invoice (Van)", 2, Trim(INC), Trim(INC), 2, CURDIR & "\inv.cdx,c,inv_idy"
    'Openreport CURDIR & "\VOUCH.RP1", "INVOICE (VAN)", 2, "INV->INV_IDY='" & Trim(INC) & "'", 0
    Cancelrecord
End If
Cancelrecord
End Sub
...
If Check1.Value = 1 Then
    If Toolbar1.Buttons(33).Value = tbrPressed Then
        REC_SET.Open "select ACT.*,MAR.MAR_NME,act.ROU_IDY,smn.smn_nme from act,MAR,smn where (act.ACT_TYP LIKE 'BOT' OR act.ACT_TYP LIKE 'SAL') and act_nme like '" & Trim(M_CST_IDY) & "%' AND ACT.MAR_IDY LIKE MAR.MAR_IDY AND ACT.SMN_IDY LIKE SMN.SMN_IDY AND MAR_VDA LIKE '" & Trim(Text1) & "' AND DBT_TYP='Y'", con, adOpenKeyset, adLockOptimistic
    Else
        REC_SET.Open "select ACT.*,MAR.MAR_NME,act.ROU_IDY,smn.smn_nme from act,MAR,smn where (act.ACT_TYP LIKE 'BOT' OR act.ACT_TYP LIKE 'SAL') and act_nme like '" & Trim(M_CST_IDY) & "%' AND ACT.MAR_IDY LIKE MAR.MAR_IDY AND ACT.SMN_IDY LIKE SMN.SMN_IDY AND DBT_TYP='Y'", con, adOpenKeyset, adLockOptimistic
    End If
ElseIf Check2.Value = 1 Then
    If Toolbar1.Buttons(33).Value = tbrPressed Then
        REC_SET.Open "select ACT.*,MAR.MAR_NME,act.ROU_IDY,smn.smn_nme from act,MAR,smn where (act.ACT_TYP LIKE 'BOT' OR act.ACT_TYP LIKE 'SAL') and act_ad4 like '" & Trim(M_CST_IDY) & "%' AND ACT.MAR_IDY LIKE MAR.MAR_IDY AND ACT.SMN_IDY LIKE SMN.SMN_IDY AND MAR_VDA LIKE '" & Trim(Text1) & "' AND DBT_TYP='Y'", con, adOpenKeyset, adLockOptimistic
    Else
...
SendKeys "{home}+{end}"
M_MDI.STS_BAR.Panels(1).Text = "Enter Surcharge on Tax"
End Sub
...
If K = 13 Or K = 40 Or K = 38 Then
    ...
    If REC_SET.RecordCount > 0 Then
        ...
        If REC_SET.State = 1 Then REC_SET.Close
        REC_SET.Open "select * from inl,SMN where INL.inv_idy like '" & Trim(M_VAN_IDY) & "' and txn_typ like 'RSI' AND SMN.SMN_IDY LIKE INL.SMN_IDY", con, adOpenKeyset, adLockOptimistic
        If REC_SET.RecordCount > 0 Then
...
If KeyAscii = 13 Then
    If list5.ListItems.Count > 0 Then
        If V_LST_CAP.Caption = "Select Invoice" Then
            M_INV_IDY = list5.SelectedItem
            list5.Visible = False
            M_INV_IDY_KeyDown 13, 0
        ElseIf V_LST_CAP.Caption = "Select Van Challan" Then
...
If REC_SET.State = 1 Then REC_SET.Close
If Check1.Value = 1 Then
    REC_SET.Open "select inl.inv_idy,inl.inv_dat,act.act_nme,act.act_ad4 from act,inl where act_nme like '" & Trim(M_INV_IDY) & "%' and inl.cst_idy=act.act_idy and inl.txn_typ ='SAL' and SUBSTR(TRIM(ord_idy),1,3) ='RSI'", con, adOpenKeyset, adLockOptimistic
Else
    REC_SET.Open "select inl.inv_idy,inl.inv_dat,act.act_nme,act.act_ad4 from act,inl where act_ad4 like '" & Trim(M_INV_IDY) & "%' and inl.cst_idy=act.act_idy and inl.txn_typ ='SAL' and SUBSTR(TRIM(ord_idy),1,3) ='RSI'", con, adOpenKeyset, adLockOptimistic
End If
...
If list1.Visible = False And List2.Visible = False And list3.Visible = False And list4.Visible = False And list5.Visible = False Then
    ...
    If KeyCode = 69 And Shift = 2 Then
        ...
        If M_VAN_SAL.ActiveControl.name = "M_INV_IDY" Then
            V_INV_LST
        ElseIf M_VAN_SAL.ActiveControl.name = "M_CST_IDY" Then
            V_DLR_LST
        ElseIf M_VAN_SAL.ActiveControl.name = "M_SMN_IDY" Then
            V_SMN_LST
        ElseIf M_VAN_SAL.ActiveControl.name = "M_ACT_IDY" Then
            V_ACT_LST
        ElseIf M_VAN_SAL.ActiveControl.name = "Text3" Then
            V_PRD_LST
        End If
    End If
End If
If KeyCode > 111 And KeyCode < 120 Then If TypeOf M_VAN_SAL.ActiveControl Is TextBox Then M_VAN_SAL.ActiveControl.Text = FUNKEY(KeyCode)
End Sub
...
M_MDI.STS_BAR.Panels(1).Text = "Enter Bill Book Serial Number, This is not Effmcg generated serial number"
End Sub
...
ElseIf V_LST_CAP.Caption = "Select Product" Then
    If Check2.Value = 1 Then
    con.Execute "insert into prt values('v_prdnum')"
    Else
    con.Execute "delete from prt where prt_nme like 'v_prdnum'"
    End If
    V_PRD_LST
End If
'End If
...
ElseIf MS.Col = 7 Then
    M_MDI.STS_BAR.Panels(1).Text = "Enter Product Discount Amount"
...
End If
End Sub
Public Sub vanchlist()
Dim REC_SET As New ADODB.Recordset
If REC_SET.State = 1 Then REC_SET.Close
If Check1.Value = 1 Then
   REC_SET.Open "select inl.inv_idy,inl.inv_dat,smn.smn_nme,smn.smn_ad4 from inl,smn where smn_nme like '" & Trim(M_VAN_IDY) & "%' and inl.smn_idy=smn.smn_idy and inl.txn_typ='RSI'", con, adOpenKeyset, adLockOptimistic
Else
   REC_SET.Open "select inl.inv_idy,inl.inv_dat,smn.smn_nme,smn.smn_ad4 from inl,smn where smn_AD4 like '" & Trim(M_VAN_IDY) & "%' and inl.smn_idy=smn.smn_idy and inl.txn_typ='RSI'", con, adOpenKeyset, adLockOptimistic
End If
list5.ListItems.Clear
If REC_SET.RecordCount > 0 Then
    For A = 1 To REC_SET.RecordCount
        If check("INL", "ORD_IDY", Trim(REC_SET(0)) & "' AND TXN_TYP LIKE 'RSR") = False Then
            Set ls = list5.ListItems.Add(, , Trim(REC_SET(0)))
            ls.ListSubItems.Add , , Format(REC_SET(1), "dd/MM/yyyy")
            ls.ListSubItems.Add , , Trim(REC_SET("smn_NME") & "")
            ls.ListSubItems.Add , , Trim(REC_SET("smn_AD4") & "")
...
Else
    If SSTab1.Tab = 0 Then
        MsgBox "Invalid Van Challan Number!", vbExclamation, "Effmcg"
        SSTab1.Tab = 0
        SendKeys "{HOME}+{END}"
        M_VAN_IDY.SetFocus
    End If
...
M_MDI.STS_BAR.Panels(1).Text = "Enter Van Challan Reference Number"
End Sub

Private Sub m_van_idy_keydown(K As Integer, Shift As Integer)
If K = 13 Or K = 40 Or K = 38 Then
    Dim REC_SET As New ADODB.Recordset
    Dim REC_SET_INE As New ADODB.Recordset
    If REC_SET.State = 1 Then REC_SET.Close
    If Len(Trim(M_VAN_IDY)) <> 10 Then
        REC_SET.Open "select INV.*,PRD.SUB_UNT from inv,PRD where inv_idy like 'RSI" & Tincrement(M_VAN_IDY) & "' and txn_typ like 'RSI' AND PRD.PRD_IDY LIKE INV.PRD_IDY", con, adOpenKeyset, adLockOptimistic
    Else
        REC_SET.Open "select INV.*,PRD.SUB_UNT from inv,PRD where inv_idy like '" & Trim(M_VAN_IDY) & "' and txn_typ like 'RSI' AND PRD.PRD_IDY LIKE INV.PRD_IDY", con, adOpenKeyset, adLockOptimistic
    End If
    If REC_SET.RecordCount > 0 Then
        If MOD_REC = False Then
            If check("INL", "ORD_IDY", Trim(REC_SET(0)) & "' AND TXN_TYP LIKE 'RSR") = True Then
                MsgBox "Invalid Van Challan Number!", vbExclamation
                SendKeys "{HOME}+{END}"
                M_VAN_IDY.SetFocus
                Exit Sub
            End If
        End If
        con.Execute "DELETE FROM INE"
        If REC_SET_INE.State = 1 Then REC_SET_INE.Close
        REC_SET_INE.Open "SELECT * FROM INE", con, adOpenKeyset, adLockOptimistic
        With REC_SET_INE
        For A = 1 To REC_SET.RecordCount
            .AddNew
            .Fields("INV_IDY") = Trim(REC_SET("INV_IDY"))
            .Fields("INV_DAT") = REC_SET("INV_DAT")
            .Fields("PRD_IDY") = Trim(REC_SET("PRD_IDY"))
            Dim RETQTY As Integer
            Dim PRDQTY As Integer
            RETQTY = P_SUB_UNT(QTY(REC_SET("RET_QTY")), REC_SET("SUB_UNT"))
            PRDQTY = P_SUB_UNT(QTY(REC_SET("PRD_QTY")), REC_SET("SUB_UNT"))
            .Fields("PRD_QTY") = P_QTY_UNT(PRDQTY - RETQTY, REC_SET("SUB_UNT"))
            .Fields("TXN_TYP") = Trim(REC_SET("TXN_TYP"))
            .Update
            REC_SET.MoveNext
        Next
        End With
        If Len(Trim(M_VAN_IDY)) <> 10 Then M_VAN_IDY = "RSI" & Tincrement(M_VAN_IDY)
        SSTab1.Tab = 0
        If K = 38 Then
            M_INV_DAT.SetFocus
        Else
...
M_FRM_PRE.Caption = "Prefix Credit Sales"
M_FRM_PRE.Show 1
...
ElseIf Button.KEY = "ed" Then
    ...
    ElseIf M_VAN_SAL.ActiveControl.name = "M_ACT_IDY" Then
        V_LST_CAP = "Select Account"
        V_ACT_LST
    ElseIf M_VAN_SAL.ActiveControl.name = "Text3" Or (MS.Col = 0 And SSTab1.Tab = 1) Then
        V_PRD_LST
    End If
...
If check("prt", "prt_nme", "M_VAN_SAL") = False Then
Check3.Value = 0
Else
Check3.Value = 1
End If
...
Else
    If querycheck("INL", "INV_IDY", Trim(M_INV_IDY), " and len(trim(ord_idy))<>10") = True Then
        MsgBox "Invoice ID Already Exists", vbExclamation
        M_INV_IDY.SetFocus
        Exit Sub
    End If
...
If REC_SET.State = 1 Then REC_SET.Close
REC_SET.Open "select * from inl where inv_idy like '" & (Trim(M_INV_IDY)) & "' and txn_typ like 'SAL' and LEN(TRIM(ord_idy)) = 10 ", con, adOpenKeyset
If REC_SET.RecordCount > 0 Then
    ...
    End If
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from inv where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ = 'SAL' AND LEN(TRIM(ORD_IDY))=10", con, adOpenKeyset, adLockOptimistic
    ...
    For A = 1 To MS.Rows - 1
        ...
        MS.TextMatrix(A, 7) = amt(REC_SET("sch_amt") & "")
        ...
        End If
        If REC_SET2.State = 1 Then REC_SET2.Close
        REC_SET2.Open "SELECT * FROM INV WHERE INV_IDY LIKE '" & M_INV_IDY & "' AND PRD_IDY LIKE '" & Trim(REC_SET("PRD_IDY")) & "' AND TXN_TYP LIKE 'FRS' AND LEN(TRIM(ORD_IDY)) = 10", con, adOpenKeyset, adLockOptimistic
        If REC_SET2.RecordCount > 0 Then
            MS.TextMatrix(A, 13) = QTY(REC_SET2("PRD_QTY"))
        End If
        REC_SET.MoveNext
    Next
    P_DIS_CAL
    ...
    M_INV_DAT.SetFocus
Else
    If MsgBox("Create New Invoice?", vbQuestion + vbYesNo) = vbYes Then
        M_INV_IDY.Enabled = False
        M_INV_DAT.SetFocus
    End If
End If
...
If check("INV", "INV_IDY", Trim(M_VAN_IDY)) = True Then
...
If K = 13 Then
    If MS.Col = 0 Then
        If REC_SET.State = 1 Then REC_SET.Close
        REC_SET.Open "SELECT * FROM inv WHERE prd_IDY LIKE '" & Sincrement(Text3) & "' and txn_typ like 'RSI'", con, adOpenKeyset
        If REC_SET.RecordCount > 0 Then
...
ElseIf K = 13 Then
    If MS.Col = 3 Then
            ...
            REC_SET1.Open "select PRD_QTY,RET_QTY from inv where PRD_IDY like '" & Trim(MS.TextMatrix(MS.Row, 0)) & "' AND txn_typ like 'RSI' AND INV_IDY LIKE '" & Trim(M_VAN_IDY) & "'", con, adOpenKeyset, adLockOptimistic
'            If Trim(M_INV_IDY) <> "" Then
'                REC_SET2.Open "select INT(SUM(((PRD_QTY-INT(PRD_QTY))*1000)+(INT(PRD_QTY)*SUB_UNT))/SUB_UNT)+(MOD(SUM(((PRD_QTY-INT(PRD_QTY))*1000)+(INT(PRD_QTY)*SUB_UNT)),SUB_UNT)/1000) from inv,PRD where PRD.PRD_IDY LIKE INV.PRD_IDY AND INV.prd_idy like '" & Trim(MS.TextMatrix(MS.Row, 0)) & "' and inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ IN('SAL','FRS')", con, adOpenKeyset, adLockOptimistic
...
'            End If
            ...
            If B > 0 And Val(REC_SET("sub_unt")) > 0 Then
                ...
                If M >= Val(REC_SET("sub_unt")) Then
                    ...
                    Exit Sub
                Else
                    F_S_UNT = MTS(Val(MS.TextMatrix(MS.Row, 13)), REC_SET("SUB_UNT"))
                    M_S_UNT = MTS(Val(M_FLX_AMT), REC_SET("SUB_UNT"))
                    QUANTITY = STM(Val(F_S_UNT) + Val(M_S_UNT), REC_SET("SUB_UNT"))
                End If
            Else
                F_S_UNT = MTS(Val(MS.TextMatrix(MS.Row, 13)), REC_SET("SUB_UNT"))
                M_S_UNT = MTS(Val(M_FLX_AMT), REC_SET("SUB_UNT"))
            ...
            If REC_SET.RecordCount > 0 Then
                ...
                REC_SET2.Open "SELECT * FROM INL WHERE ORD_IDY LIKE '" & Trim(M_VAN_IDY) & "' AND TXN_TYP LIKE 'RSR'", con, adOpenKeyset, adLockOptimistic
                If REC_SET2.RecordCount = 0 Then
                    Ent_qty = P_SUB_UNT(QTY(Trim(QUANTITY)), REC_SET("SUB_UNT"))
                    Ret_qty = P_SUB_UNT(QTY(REC_SET1("RET_QTY") & "") & "", REC_SET("SUB_UNT"))
                    PRD_QTY = P_SUB_UNT(QTY(REC_SET1("PRD_QTY") & ""), REC_SET("SUB_UNT"))
                    INV_TOT = P_SUB_UNT(QTY(Trim(INVTOT)), REC_SET("SUB_UNT"))
                    If (Val(Ent_qty) + Val(Ret_qty)) - (Val(PRD_QTY) + Val(INV_TOT)) > 0 Then
                ...
                Else
                    ...
                    If CONPRDQTY(REMIND, QUANTITY, MS.TextMatrix(MS.Row, 0)) < 0 Then
                        MsgBox "Stock Out Of Range, Check Stock !", vbExclamation, "Effmcg"
                        M_FLX_AMT.SetFocus
                        SendKeys "{home}+{end}"
                        Exit Sub
...
ElseIf MS.Col = 7 Then
    ...
    P_DIS_CAL
    MS.SetFocus
ElseIf MS.Col = 8 Or MS.Col = 9 Then
    M_FLX_AMT.Visible = False
...
If REC_SET.State = 1 Then REC_SET.Close
    ...
    If B > 0 And Val(REC_SET("sub_unt")) > 0 Then
        ...
        If M >= Val(REC_SET("sub_unt")) Then
            ...
            Exit Sub
        Else
            F_S_UNT = MTS(Val(M_FLX_AMT), REC_SET("SUB_UNT"))
            M_S_UNT = MTS(Val(MS.TextMatrix(MS.Row, 3)), REC_SET("SUB_UNT"))
            QUANTITY = STM(Val(F_S_UNT) + Val(M_S_UNT), REC_SET("SUB_UNT"))
        End If
    Else
        F_S_UNT = MTS(Val(M_FLX_AMT), REC_SET("SUB_UNT"))
...
For A = 1 To MS.Rows - 1
    ...
    MS.TextMatrix(A, 10) = amt(MS.TextMatrix(A, 10)) - amt(MS.TextMatrix(A, 7))
...
If check("INV", "INV_IDY", Trim(M_VAN_IDY)) = True Then
    If check("prt", "prt_nme", "v_prdnum") = True Then Check2.Value = 1
    Dim REC_SET As New ADODB.Recordset
    If REC_SET.State = 1 Then REC_SET.Close
    If Check1.Value = 1 Then
        REC_SET.Open "SELECT PRD.prd_nme,ine.prd_idy,prd_prn,ine.prd_qty,INE.RET_QTY,prd.sub_unt,prd.pur_rat,prd.sal_rat,prd.mrp_rat,PRD.STK_TYP FROM INE,PRD WHERE PRD.PRD_NME LIKE '" & Trim(Text3) & "%' AND INE.TXN_TYP LIKE 'RSI' AND INE.PRD_IDY LIKE PRD.PRD_IDY AND INE.INV_IDY LIKE '" & Trim(M_VAN_IDY) & "' AND STK_TYP IN('Free','Salable')", con, adOpenKeyset
    Else
        REC_SET.Open "SELECT PRD.prd_nme,ine.prd_idy,prd_prn,ine.prd_qty,INE.RET_QTY,prd.sub_unt,prd.pur_rat,prd.sal_rat,prd.mrp_rat,PRD.STK_TYP FROM INE,PRD WHERE PRD.PRD_PRN LIKE '" & Trim(Text3) & "%' AND INE.TXN_TYP LIKE 'RSI' AND INE.PRD_IDY LIKE PRD.PRD_IDY AND INE.INV_IDY LIKE '" & Trim(M_VAN_IDY) & "' AND STK_TYP IN('Free','Salable')", con, adOpenKeyset
    End If
...
'            If QTY(VANCONQTY(REC_SET("PRD_QTY"), REC_SET("prd_idy"), Trim(M_VAN_IDY))) <> 0 Then
...
'            End If
    ...
    Else
        If SSTab1.Tab = 1 Then
        MsgBox "This Product is not issued with this Van Challan !", vbExclamation, "Effmcg"
        SSTab1.Tab = 1
        If Text3.Visible = True Then
            Text3.SetFocus
        Else
