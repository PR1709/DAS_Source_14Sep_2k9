...
Begin VB.Form M_FRM_DBN 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabHeight       =   520
      ForeColor       =   8388608
      TabCaption(0)   =   "&Debit Note Voucher"
      TabPicture(0)   =   "M_FRM_DBN.frx":0442
      ...
      Tab(0).Control(12)=   "vch"
      Tab(0).Control(12).Enabled=   0   'False
      Tab(0).Control(13)=   "crd"
      Tab(0).Control(13).Enabled=   0   'False
      Tab(0).Control(14)=   "dbt"
      Tab(0).Control(14).Enabled=   0   'False
      Tab(0).Control(15)=   "rmk"
      Tab(0).Control(15).Enabled=   0   'False
      Tab(0).Control(16)=   "amount"
      Tab(0).Control(16).Enabled=   0   'False
      Tab(0).ControlCount=   17
      TabCaption(1)   =   "View"
      TabPicture(1)   =   "M_FRM_DBN.frx":045E
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_DBN.frx":047A
            Key             =   "p"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_DBN.frx":09BE
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_DBN.frx":0D86
            Key             =   "c"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_DBN.frx":10DA
            Key             =   "e"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_DBN.frx":1712
            Key             =   "s"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_DBN.frx":1A66
            Key             =   "h"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_DBN.frx":1EC6
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_DBN.frx":21BA
            Key             =   "pr"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_DBN.frx":25C6
            Key             =   "d"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_DBN.frx":26D2
            Key             =   "pre"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_DBN.frx":2A26
            Key             =   "brw"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_DBN.frx":2E3A
            Key             =   "cpy"
         EndProperty
      EndProperty
   End
...
If list1.Visible = False And list4.Visible = False Then
    ...
    If KeyCode = 69 And Shift = 2 Then
        If M_FRM_DBN.ActiveControl.name = "vch" Then
            vchlist
        ElseIf M_FRM_DBN.ActiveControl.name = "dbt" Then
            dbtlist
        ElseIf M_FRM_DBN.ActiveControl.name = "crd" Then
            crdlist
        End If
    End If
End If
If KeyCode > 111 And KeyCode < 120 Then If TypeOf M_FRM_DBN.ActiveControl Is TextBox Then M_FRM_DBN.ActiveControl.Text = FUNKEY(KeyCode)
End Sub
...
Prefix.Caption = "Prefix Debit Note (Accounts)"
Prefix.Show 1
...
If check("prt", "prt_nme", "M_FRM_DBN") = False Then
    Check3.Value = 0
Else
    Check3.Value = 1
End If
...
Dim rs As New ADODB.Recordset
If rs.State = 1 Then rs.Close
If Sincrement(crd) = Sincrement(dbt) Then
    MsgBox "Debit A/c Cannot be Equal to Credit A/c", vbExclamation, "DAS Version 4.0"
    crd = ""
    SSTab1.Tab = 0
    crd.SetFocus
    Exit Sub
...
If MOD1 = True Then
    rs.Open "Select * from vch where txn_idy like '" & Trim(vch) & "' and txn_typ like 'DBN' ", con, adOpenKeyset, adLockPessimistic
    INC = Trim(vch)
Else
    rs.Open "Select * from vch where txn_idy = ''", con, adOpenKeyset, adLockPessimistic
    rs.AddNew
    rs("txn_idy") = "DBN" & T7increment("idy_DBN")
    INC = rs("txn_idy")
End If
rs("txn_dat") = DATE1
...
'=====================================================================
rs.Update
If MOD1 = False Then MsgBox "Debit Note Number is " & INC, vbExclamation, "DAS Version 4.0"
If check("PRT", "PRT_NME", "M_FRM_DBN") = True Then
    con.Execute "update dir where dir_idy like 'INV' set dir_als = '" & INC & "'"
    OpenReport CURDIR & "\vouch.RP1", "New DBT NOTE", 2, "vch->txn_idy='" & Trim(INC) & "'.and.vch->txn_typ='DBN'", 6
End If
CANCELRECORD
End Sub
...
If Len(Trim(vch)) <> 10 Then
    rs.Open "Select * from vch where txn_idy like 'DBN" & Tincrement(vch) & "' and txn_typ like 'DBN'", con, adOpenKeyset, adLockPessimistic
Else
    rs.Open "Select * from vch where txn_idy like '" & Trim(vch) & "' and txn_typ like 'DBN'", con, adOpenKeyset, adLockPessimistic
End If
If rs.RecordCount > 0 Then
    ...
    End If
    If Len(Trim(vch)) <> 10 Then vch = "DBN" & Tincrement(vch)
    MOD1 = True
...
vch.Enabled = False
    DATE1.SetFocus
Else
    MsgBox "Debit Note Number Not Found !", vbExclamation, "DAS Version 4.0"
    SSTab1.Tab = 0
    vch.Enabled = True
    vch.SetFocus
End If
...
If rs.State = 1 Then rs.Close
rs.Open "select vch.txn_idy,vch.txn_dat,vch.txn_amt,a1.act_nme,a2.act_nme from vch,act a1,act a2 where vch.txn_typ like 'DBN' and a1.act_idy like vch.dbt_idy and a2.act_idy like vch.crt_idy", con, adOpenKeyset, adLockPessimistic
...
If rs.RecordCount > 0 Then
    ...
    Next
    SSTab1.Tab = 1
    Label49 = "Select Debit Note Voucher"
    list1.Visible = True
...
If CHECKTB("prt.dbf") = 1 Then
    ...
    Exit Sub
End If
If check("PRT", "PRT_NME", "M_FRM_DBN") = True Then M_FRM_PRV.Check3.Value = 1
M_FRM_PRV.Show 1
End Sub
