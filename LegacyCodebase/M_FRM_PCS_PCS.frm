...
Begin VB.Form M_FRM_PCS_PCS 
   BackColor       =   &H8000000A&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Push Cart Sales (Pieces)"
   ClientHeight    =   5625
   ClientLeft      =   1425
   ClientTop       =   1845
   ClientWidth     =   8820
   ForeColor       =   &H00FFFFFF&
   Icon            =   "M_FRM_PCS_PCS.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin MSComctlLib.Toolbar Toolbar1 
      ...
      Begin VB.ListBox text1 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRM_PCS_PCS.frx":0442
         Left            =   7080
         List            =   "M_FRM_PCS_PCS.frx":045B
         TabIndex        =   104
         TabStop         =   0   'False
         Top             =   50
         Visible         =   0   'False
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "M_FRM_PCS_PCS.frx":049F
      ...
      TabPicture(1)   =   "M_FRM_PCS_PCS.frx":04BB
      ...
      Tab(1).Control(5)=   "M_PRD_AMT"
      Tab(1).ControlCount=   6
      TabCaption(2)   =   "&Taxes and  Levies"
      TabPicture(2)   =   "M_FRM_PCS_PCS.frx":04D7
      ...
      Tab(2).Control(26)=   "Label5"
      Tab(2).Control(27)=   "M_CRT_DAY"
      Tab(2).Control(27).Enabled=   0   'False
      Tab(2).Control(28)=   "M_CSD_PCG"
      Tab(2).Control(28).Enabled=   0   'False
      Tab(2).Control(29)=   "M_SPD_PCG"
      Tab(2).Control(29).Enabled=   0   'False
      Tab(2).Control(30)=   "M_TAX_PCG"
      Tab(2).Control(30).Enabled=   0   'False
      Tab(2).Control(31)=   "M_EXD_AMT"
      Tab(2).Control(31).Enabled=   0   'False
      Tab(2).Control(32)=   "M_ROU_IDY"
      Tab(2).Control(32).Enabled=   0   'False
      Tab(2).Control(33)=   "M_TAX_AMT"
      Tab(2).Control(33).Enabled=   0   'False
      Tab(2).Control(34)=   "M_SPD_AMT"
      Tab(2).Control(34).Enabled=   0   'False
      Tab(2).Control(35)=   "M_CSD_AMT"
      Tab(2).Control(35).Enabled=   0   'False
      Tab(2).Control(36)=   "M_ROU_OFF"
      Tab(2).Control(36).Enabled=   0   'False
      Tab(2).Control(37)=   "M_CSD_DED"
      Tab(2).Control(37).Enabled=   0   'False
      Tab(2).Control(38)=   "M_SPD_DED"
      Tab(2).Control(38).Enabled=   0   'False
      Tab(2).Control(39)=   "M_TAX_DED"
      ...
      TabCaption(4)   =   "View"
      TabPicture(4)   =   "M_FRM_PCS_PCS.frx":050F
      ...
      Begin VB.ListBox List6 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRM_PCS_PCS.frx":052B
         Left            =   -72960
         List            =   "M_FRM_PCS_PCS.frx":0538
         TabIndex        =   65
         TabStop         =   0   'False
         Top             =   720
         Visible         =   0   'False
      ...
      Begin VB.ListBox M_ROU_IDY 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRM_PCS_PCS.frx":0545
         Left            =   -70080
         List            =   "M_FRM_PCS_PCS.frx":05B5
         TabIndex        =   61
         TabStop         =   0   'False
         Top             =   2640
         Width           =   495
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_PCS_PCS.frx":0625
               Key             =   "p"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_PCS_PCS.frx":0B69
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_PCS_PCS.frx":0F31
               Key             =   "c"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_PCS_PCS.frx":1285
               Key             =   "e"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_PCS_PCS.frx":18BD
               Key             =   "s"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_PCS_PCS.frx":1C11
               Key             =   "h"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_PCS_PCS.frx":2071
               Key             =   ""
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_PCS_PCS.frx":2365
               Key             =   "pr"
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_PCS_PCS.frx":2771
               Key             =   "d"
            EndProperty
            BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_PCS_PCS.frx":287D
               Key             =   "pre"
            EndProperty
            BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_PCS_PCS.frx":2BD1
               Key             =   "brw"
            EndProperty
            BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_PCS_PCS.frx":2FE5
               Key             =   "cpy"
            EndProperty
            BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_PCS_PCS.frx":3531
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   End
End
Attribute VB_Name = "M_FRM_PCS_PCS"
...
REC_SET("ord_idy") = Trim(REC_SET("inv_idy") & "")
...
For A = 1 To MS.Rows - 1
    If Trim(MS.TextMatrix(A, 0)) <> "" Then
        ...
        REC_SET("prd_qty") = P_QTY_UNT(MS.TextMatrix(A, 4), REC_SET1(0))
        ...
        Else
            REC_SET("rat_app") = "A"
        End If
        REC_SET("OPN_QTY") = P_QTY_UNT(MS.TextMatrix(A, 1), REC_SET1(0))
        REC_SET("ISS_QTY") = P_QTY_UNT(MS.TextMatrix(A, 2), REC_SET1(0))
        REC_SET("TOT_QTY") = P_QTY_UNT(MS.TextMatrix(A, 3), REC_SET1(0))
        REC_SET("RET_QTY") = P_QTY_UNT(MS.TextMatrix(A, 5), REC_SET1(0))
        REC_SET("txn_typ") = "SAL"
        REC_SET("COL_AMT") = convert(amt(MS.TextMatrix(A, 8)))
        REC_SET.Update
        con.Execute "update prd where prd_idy like '" & Trim(MS.TextMatrix(A, 0)) & "' set cur_lev = " & CONQTY(P_QTY_UNT(MS.TextMatrix(A, 2), REC_SET1("SUB_UNT")), Trim(MS.TextMatrix(A, 0)))
    End If
Next
If MOD_REC = False Then MsgBox "New Invoice ID " & INC, vbExclamation, "Effmcg"
M_PRV_NUM = labdisp("IDY_SAL")
If check("PRT", "PRT_NME", "M_FRM_PCS_PCS") = True Then
    ...
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "SELECT * FROM INE", con, adOpenKeyset, adLockOptimistic
    For A = 1 To MS.Rows - 1
    REC_SET.AddNew
        REC_SET("INV_IDY") = INC
        REC_SET("INV_DAT") = Trim(M_INV_DAT)
        REC_SET("PRD_IDY") = Trim(MS.TextMatrix(A, 0))
        REC_SET("OPN_QTY") = QTY(Trim(MS.TextMatrix(A, 1)))
        REC_SET("ISS_QTY") = QTY(Trim(MS.TextMatrix(A, 2)))
        REC_SET("TOT_QTY") = QTY(Trim(MS.TextMatrix(A, 3)))
        REC_SET("PRD_QTY") = QTY(Trim(MS.TextMatrix(A, 4)))
        REC_SET("RET_QTY") = QTY(Trim(MS.TextMatrix(A, 5)))
        REC_SET("PRD_RAT") = Val(Trim(MS.TextMatrix(A, 7)))
        REC_SET("COL_AMT") = Val(Trim(MS.TextMatrix(A, 8)))
        REC_SET("PRD_NME") = Trim(MS.TextMatrix(A, 9))
        REC_SET("ADD_DIS") = Val(M_CSD_PCG)
        REC_SET("ADD_AMT") = Val(M_CSD_AMT)
    REC_SET.Update
    Next
    OpenDocument CURDIR & "\VOUCH.RP1", "Push Cart Challan (Pieces)", 0, Trim(INC), Trim(INC), 2, ""  ' CURDIR & "\inv.cdx,c,inv_idy"
    Cancelrecord
End If
Cancelrecord
End Sub
...
M_Prd_Nme = MS.TextMatrix(MS.Row, 9)
End Sub
...
If REC_SET.State = 1 Then REC_SET.Close
If Check1.Value = 1 Then
REC_SET.Open "select inl.inv_idy,inl.inv_dat,act.act_nme,act.act_ad4 from act,inl where act_nme like '" & Trim(M_INV_IDY) & "%' and inl.cst_idy=act.act_idy and inl.txn_typ ='SAL' AND LEN(TRIM(ORD_IDY))=10 AND SUBSTR(ORD_IDY,1,3) LIKE 'SAL'", con, adOpenKeyset, adLockOptimistic
Else
REC_SET.Open "select inl.inv_idy,inl.inv_dat,act.act_nme,act.act_ad4 from act,inl where act_ad4 like '" & Trim(M_INV_IDY) & "%' and inl.cst_idy=act.act_idy and inl.txn_typ ='SAL' AND LEN(TRIM(ORD_IDY))=10 AND SUBSTR(ORD_IDY,1,3) LIKE 'SAL'", con, adOpenKeyset, adLockOptimistic
End If
...
If REC_SET.State = 1 Then REC_SET.Close
If Check1.Value = 1 Then
    REC_SET.Open "select inl.inv_idy,inl.inv_dat,act.act_nme,act.act_ad4 from act,inl where act_nme like '" & Trim(M_INV_IDY) & "%' and inl.cst_idy=act.act_idy and inl.txn_typ ='SAL'  AND LEN(TRIM(ORD_IDY))=10 AND SUBSTR(ORD_IDY,1,3) LIKE 'SAL' AND INV_DAT = CTOD('" & INVOICE_DATE & "')", con, adOpenKeyset, adLockOptimistic
Else
    REC_SET.Open "select inl.inv_idy,inl.inv_dat,act.act_nme,act.act_ad4 from act,inl where act_ad4 like '" & Trim(M_INV_IDY) & "%' and inl.cst_idy=act.act_idy and inl.txn_typ ='SAL'  AND LEN(TRIM(ORD_IDY))=10 AND SUBSTR(ORD_IDY,1,3) LIKE 'SAL' AND INV_DAT = CTOD('" & INVOICE_DATE & "')", con, adOpenKeyset, adLockOptimistic
End If
list5.ListItems.Clear
If REC_SET.RecordCount > 0 Then
    For A = 1 To REC_SET.RecordCount
...
If list1.Visible = False And List2.Visible = False And list3.Visible = False And list4.Visible = False And list5.Visible = False Then
    ...
    If KeyCode = 69 And Shift = 2 Then
        ...
        If M_FRM_PCS_PCS.ActiveControl.name = "M_INV_IDY" Then
            V_INV_LST
        ElseIf M_FRM_PCS_PCS.ActiveControl.name = "M_CST_IDY" Then
            V_DLR_LST
        ElseIf M_FRM_PCS_PCS.ActiveControl.name = "M_SMN_IDY" Then
            V_SMN_LST
        ElseIf M_FRM_PCS_PCS.ActiveControl.name = "M_ACT_IDY" Then
            V_ACT_LST
        ElseIf M_FRM_PCS_PCS.ActiveControl.name = "Text3" Then
            V_PRD_LST
        End If
    End If
End If
If KeyCode > 111 And KeyCode < 120 Then If TypeOf M_FRM_PCS_PCS.ActiveControl Is TextBox Then M_FRM_PCS_PCS.ActiveControl.Text = FUNKEY(KeyCode)
End Sub
...
If V_LST_CAP = "Select Push Cart Challan" Then
    ...
    RS.Open "select * from inv,PRD where inv_idy like '" & Trim(list5.SelectedItem) & "' and txn_typ like 'SAL' AND PRD.PRD_IDY LIKE INV.PRD_IDY", con, adOpenKeyset, adLockOptimistic
    If RS.RecordCount > 0 Then
        MS.Rows = 1
        For A = 1 To RS.RecordCount
            MS.AddItem ""
            MS.TextMatrix(A, 0) = Trim(RS("PRD_IDY") & "")
            MS.TextMatrix(A, 1) = P_SUB_UNT(Trim(QTY(RS("RET_QTY") & "")), RS("SUB_UNT"))
            MS.TextMatrix(A, 3) = P_SUB_UNT(Trim(QTY(RS("RET_QTY") & "")), RS("SUB_UNT"))
...
ElseIf Button.KEY = "ed" Then
    ...
    ElseIf M_FRM_PCS_PCS.ActiveControl.name = "M_ACT_IDY" Then
        V_LST_CAP = "Select Account"
        V_ACT_LST
    ElseIf M_FRM_PCS_PCS.ActiveControl.name = "Text3" Or (MS.Col = 0 And SSTab1.Tab = 1) Then
        V_PRD_LST
    End If
...
If check("prt", "prt_nme", "M_FRM_PCS_PCS") = False Then
    Check3.Value = 0
Else
    Check3.Value = 1
End If
...
REC_SET.Open "select * from inl where inv_idy like 'SAL" & Tincrement(Trim(M_INV_IDY)) & "' and txn_typ like 'SAL' AND LEN(TRIM(ORD_IDY))=10 AND SUBSTR(ORD_IDY,1,3) LIKE 'SAL'", con, adOpenKeyset
Else
REC_SET.Open "select * from inl where inv_idy like '" & Tincrement(Trim(M_INV_IDY)) & "' and txn_typ like 'SAL' AND LEN(TRIM(ORD_IDY))=10 AND SUBSTR(ORD_IDY,1,3) LIKE 'SAL'", con, adOpenKeyset
End If
If REC_SET.RecordCount > 0 Then
    If Len(Trim(M_INV_IDY)) <> 10 Then
    ...
    End If
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from inv,PRD where PRD.PRD_IDY LIKE INV.PRD_IDY AND inv_idy like '" & Sincrement(M_INV_IDY) & "' and txn_typ = 'SAL'", con, adOpenKeyset, adLockOptimistic
    MS.Rows = REC_SET.RecordCount + 1
    For A = 1 To MS.Rows - 1
        MS.TextMatrix(A, 0) = Trim(REC_SET("prd_idy"))
        MS.TextMatrix(A, 1) = P_SUB_UNT(QTY(REC_SET("OPN_QTY")), REC_SET("SUB_UNT"))
        MS.TextMatrix(A, 2) = P_SUB_UNT(QTY(REC_SET("ISS_QTY")), REC_SET("SUB_UNT"))
        MS.TextMatrix(A, 3) = P_SUB_UNT(QTY(REC_SET("TOT_QTY")), REC_SET("SUB_UNT"))
        MS.TextMatrix(A, 4) = P_SUB_UNT(QTY(REC_SET("PRD_QTY")), REC_SET("SUB_UNT"))
        MS.TextMatrix(A, 5) = P_SUB_UNT(QTY(REC_SET("RET_QTY")), REC_SET("SUB_UNT"))
...
If k > 47 And k < 58 Or k = 45 Or k = 8 Then
...
ElseIf k = 13 Then
    If MS.Col = 2 Or MS.Col = 1 Then
        ...
        If Trim(M_INV_IDY) <> "" Then
            REC_SET2.Open "select * from inv where prd_idy like '" & Trim(MS.TextMatrix(MS.Row, 0)) & "' and inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ like 'SAL'", con, adOpenKeyset, adLockOptimistic
            If REC_SET2.RecordCount > 0 Then
                INVTOT = QTY(REC_SET2("ISS_QTY"))
            End If
        End If
        INV_SUB = P_SUB_UNT(QTY(Trim(INVTOT)), REC_SET("SUB_UNT"))
        PRD_SUB = P_SUB_UNT(QTY(REC_SET("CUR_LEV")), REC_SET("SUB_UNT"))
        If (Val(INV_SUB) + Val(PRD_SUB)) < Val(M_FLX_AMT) Then
            MsgBox "Stock out of Range", vbInformation
            SendKeys "{HOME}+{END}"
            M_FLX_AMT.SetFocus
            Exit Sub
    ...
    MS.Text = M_FLX_AMT
    MS.TextMatrix(MS.Row, 3) = Val(MS.TextMatrix(MS.Row, 1)) + Val(MS.TextMatrix(MS.Row, 2))
    M_FLX_AMT.Visible = False
    MS.SetFocus
    P_DIS_CAL
ElseIf MS.Col = 5 Then
    If REC_SET.State = 1 Then REC_SET.Close
    If Val(MS.TextMatrix(MS.Row, 3)) < Val(M_FLX_AMT) Then
        MsgBox "Invalid Stock", vbInformation, "Effmcg"
        SendKeys "{home}+{end}"
        M_FLX_AMT.SetFocus
        Exit Sub
    End If
    MS.Text = M_FLX_AMT
    MS.TextMatrix(MS.Row, 4) = MS.TextMatrix(MS.Row, 3) - Val(MS.TextMatrix(MS.Row, 5))
    P_DIS_CAL
    M_FLX_AMT.Visible = False
    M_FLX_AMT = ""
    MS.SetFocus
...
If REC_SET.RecordCount > 0 Then
    ...
    MS.TextMatrix(MS.Row, 1) = "0"
    MS.TextMatrix(MS.Row, 2) = "0"
...
For A = 1 To MS.Rows - 1
    ...
    If (Val(MS.TextMatrix(MS.Row, 3)) - Val(MS.TextMatrix(MS.Row, 5))) < 0 Then
        If (Val(MS.TextMatrix(A, 3)) - Val(MS.TextMatrix(A, 4))) < 0 Then
            MS.TextMatrix(A, 4) = "0"
            MS.TextMatrix(A, 5) = "0"
        Else
            MS.TextMatrix(A, 5) = Val(TOT_UNT) - Val(SAL_UNT)
        End If
    End If
    
    If REC_SET.RecordCount > 0 Then
        If Val(REC_SET(0)) > 0 Then
            MS.TextMatrix(A, 8) = RATCAL(P_QTY_UNT(MS.TextMatrix(A, 4), REC_SET(0)), Val(MS.TextMatrix(A, 7) & ""), REC_SET(0))
        Else
...
If ButtonMenu.KEY = "dt" Then
    If MOD_REC = True Then
        Openreport CURDIR & "\VOUCH.RP1", "Invoice", 2, "INV->INV_IDY='" & Trim(M_INV_IDY) & "'", 6
        'OpenDocument CURDIR & "\vouch.rp1", "Invoice", 2, M_INV_IDY, M_INV_IDY, 6, CURDIR & "\inv.cdx,c,inv_idy"
    End If
End If
End Sub
