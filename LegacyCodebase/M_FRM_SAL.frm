...
Begin VB.Form M_FRM_SAL 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "M_FRM_SAL.frx":0442
      ...
      TabPicture(1)   =   "M_FRM_SAL.frx":045E
      ...
      TabPicture(2)   =   "M_FRM_SAL.frx":047A
      ...
      Tab(2).Control(9)=   "LabelAAS"
      Tab(2).Control(10)=   "Frame4"
      Tab(2).Control(11)=   "M_CRT_DAY"
      Tab(2).Control(11).Enabled=   0   'False
      Tab(2).Control(12)=   "M_DUE_DAT"
      Tab(2).Control(12).Enabled=   0   'False
      Tab(2).Control(13)=   "Command1"
      Tab(2).Control(13).Enabled=   0   'False
      Tab(2).Control(14)=   "Frame3"
      Tab(2).Control(15)=   "Command2"
      Tab(2).Control(15).Enabled=   0   'False
      Tab(2).Control(16)=   "M_ROU_IDY"
      Tab(2).ControlCount=   17
      TabCaption(3)   =   "&Shipment Details"
      TabPicture(3)   =   "M_FRM_SAL.frx":0496
      ...
      TabCaption(4)   =   "View"
      TabPicture(4)   =   "M_FRM_SAL.frx":04B2
      ...
      TabPicture(5)   =   "M_FRM_SAL.frx":04CE
      ...
      TabPicture(6)   =   "M_FRM_SAL.frx":04EA
      ...
      Begin VB.ListBox List7 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRM_SAL.frx":0506
         Left            =   -73920
         List            =   "M_FRM_SAL.frx":051F
         TabIndex        =   92
         TabStop         =   0   'False
         Top             =   1440
         Visible         =   0   'False
      ...
      Begin VB.ListBox List6 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRM_SAL.frx":0560
         Left            =   -72960
         List            =   "M_FRM_SAL.frx":0570
         TabIndex        =   22
         TabStop         =   0   'False
         Top             =   720
         Visible         =   0   'False
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SAL.frx":0580
            Key             =   "p"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SAL.frx":0AC4
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SAL.frx":0E8C
            Key             =   "c"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SAL.frx":11E0
            Key             =   "e"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SAL.frx":1818
            Key             =   "s"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SAL.frx":1B6C
            Key             =   "h"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SAL.frx":1FCC
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SAL.frx":22C0
            Key             =   "pr"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SAL.frx":26CC
            Key             =   "d"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SAL.frx":27D8
            Key             =   "pre"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SAL.frx":2B2C
            Key             =   "brw"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SAL.frx":2F40
            Key             =   "cpy"
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SAL.frx":348C
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.Toolbar Toolbar1 
      ...
      Begin VB.ListBox List10 
         ...
         Enabled         =   0   'False
         Height          =   225
         ItemData        =   "M_FRM_SAL.frx":38E0
         Left            =   6840
         List            =   "M_FRM_SAL.frx":38E7
         TabIndex        =   146
         Top             =   80
         Width           =   615
      End
      Begin VB.ListBox List9 
         Appearance      =   0  'Flat
         Height          =   225
         ItemData        =   "M_FRM_SAL.frx":38F3
         Left            =   7560
         List            =   "M_FRM_SAL.frx":38F5
         TabIndex        =   145
         TabStop         =   0   'False
      ...
      Begin VB.ListBox text1 
         Appearance      =   0  'Flat
         Height          =   225
         ItemData        =   "M_FRM_SAL.frx":38F7
         Left            =   5880
         List            =   "M_FRM_SAL.frx":3910
         TabIndex        =   85
         TabStop         =   0   'False
         Top             =   80
         Visible         =   0   'False
...
If Trim(CheckGCCStatus) = "T" Then
    If GCC_Validate = True Then
        MsgBox "GCC Enabled! GCC ID Required for this Retail Outlet! ", vbInformation, "DAS Version 4.0"
        CANCELRECORD
        M_INV_IDY.SetFocus
        Exit Sub
    End If
End If
'CHK_FTD = Val(Trim(GetValue("DIR_ALS", "DIR WHERE DIR_IDY = 'SYS' AND DIR_IDX = 'FTD'")))
...
If SYS_NUM = False Then
    If MOD_REC = False Then
        ...
        RSINL.Open "select * from inv where inv_idy = '" & Trim(M_INV_IDY) & "' and txn_typ = 'SAL'", con, adOpenKeyset, adLockPessimistic
        If Not RSINL.EOF Then
            MsgBox "Cannot Save, Invoice WITH THIS NUMBER Already Exists!", vbInformation + vbOKOnly, "DAS Version 4.0"
            SSTab1.Tab = 0
            CANCELRECORD
'            M_INV_IDY.SetFocus
            Exit Sub
...
If Toolbar1.Buttons(11).Value = tbrUnpressed Then
    If Len(Trim(M_INV_IDY)) = 0 Then
        MsgBox "Invoice Number or ID Required!, Cannot Save this Sale Entry!", vbExclamation, "DAS Version 4.0"
        CANCELRECORD
        Exit Sub
    End If
End If
...
If REC_SET1.RecordCount > 0 Then
    If Trim(REC_SET1("VAN_CLS")) = "C" Then
        MsgBox "Reference Van Challan Status is CLOSED for this Invoice, Cannot Save !", vbCritical, "DAS Version 4.0"
        DayCls_PrintBill (M_INV_IDY)
        CANCELRECORD
        Exit Sub
    End If
End If
If check("ACT", "(ACT_TYP = 'SAL' OR ACT_TYP = 'BOT') AND ACT_idy", Trim(M_CST_IDY)) = False Then
...
If b = 0 And C = 1 Then
    MsgBox "Sale Products Entries Are Not Made! Cannot Save Invoice Entry !", vbCritical, "DAS Version 4.0"
    SSTab1.Tab = 0
    M_INV_DAT.SetFocus
    Exit Sub
End If

If check("dir", "dir_idy = 'SYS' AND DIR_IDX = 'PSW' AND DIR_MSG", "Y") = True Then
    For A = 1 To MS.Rows - 1
        If Trim(MS.TextMatrix(A, 0)) <> "" Then
            If pcs_chk.Value = 1 Then
                If check("BRD", "prd_pdr > " & Val(MS.TextMatrix(A, 5)) & " and BAT_idy ", Trim(MS.TextMatrix(A, 15))) = True Then
                    MsgBox "Cannot Save Invoice! Billing - Invoice Rate is Less Than Purchase Rate", vbExclamation, "DAS Version 4.0"
                    MS.SetFocus
                    MS.Row = A
                    SSTab1.Tab = 1
                    Exit Sub
                End If
            Else
                PURRAT = Round(Val(GetValue("PRD_PDR", "BRD WHERE BAT_IDY = '" & Trim(MS.TextMatrix(A, 15)) & "'")) / Val(MS.TextMatrix(A, 13)), 2)
...
If MOD_REC = True Then
    ...
    REC_SET.Open "select * from inv where inv_idy = '" & Trim(M_INV_IDY) & "' and txn_typ = 'SAL'", con, adOpenKeyset, adLockPessimistic
    For A = 1 To REC_SET.RecordCount
        If (Trim(REC_SET!stk_typ) = "Free" Or Trim(REC_SET!stk_typ) = "Salable") And stk_upd = "Y" Then
            con.Execute "update prd where prd_idy = '" & Trim(REC_SET("prd_idy")) & "' set cur_lev = " & ADDQTY(Val(REC_SET("prd_qty")), Trim(REC_SET("prd_idy"))), d
            con.Execute "UPDATE PRD WHERE PRD_IDY = '" & Trim(REC_SET("prd_idy")) & "' set PRD_PCS = PRD_PCS + " & MTS(Val(REC_SET("prd_qty")), Val(REC_SET("SUB_UNT"))), d
            con.Execute "update Brd where BAT_idy = '" & Trim(REC_SET("BAT_idy")) & "' set PRD_QTY = " & ADDBRDQTY(Val(REC_SET("PRD_qty")), Trim(REC_SET("BAT_idy"))), d
        ElseIf (Trim(REC_SET!stk_typ) = "Damage" Or Trim(REC_SET!stk_typ) = "TakeBack" Or Trim(REC_SET!stk_typ) = "Breakage" Or Trim(REC_SET!stk_typ) = "Leakage") And stk_upd = "Y" Then
            con.Execute "update prd where prd_idy = '" & Trim(REC_SET("prd_idy")) & "' set cur_lev = " & CONQTY(Val(REC_SET("prd_qty")), Trim(REC_SET("prd_idy")))
            con.Execute "UPDATE PRD WHERE PRD_IDY = '" & Trim(REC_SET("prd_idy")) & "' set PRD_PCS = PRD_PCS - " & MTS(Val(REC_SET("prd_qty")), Val(REC_SET("SUB_UNT")))
            con.Execute "update Brd where BAT_idy = '" & Trim(REC_SET("BAT_idy")) & "' set PRD_QTY = " & CONBRDQTY(Val(REC_SET("PRD_qty")), Trim(REC_SET("BAT_idy")))
        End If
        REC_SET.MoveNext
    Next
    ...
    con.Execute "DELETE FROM INV WHERE INV_IDY = '" & Trim(M_INV_IDY) & "' AND TXN_TYP = 'SAL'"
    con.Execute "DELETE FROM LNV WHERE INV_IDY = '" & Trim(M_INV_IDY) & "'"
    
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from inl where inv_idy = '" & Trim(M_INV_IDY) & "' and txn_typ = 'SAL'", con, adOpenKeyset, adLockPessimistic
    INC = Trim(M_INV_IDY)
Else
...
'IRT UPDATION
If Val(T_NET_AMT) >= 0 Then
    REC_IRT.Open "select * from IRT WHERE INV_IDY = '" & Trim(INC) & "'", con, adOpenKeyset, adLockPessimistic
...
'        LST_TOT = Val(MS.TextMatrix(A, 2)) * Val(MS.TextMatrix(A, 22))
        ...
        REC_SET("txn_typ") = "SAL"
        If Len(Trim(GetValue("ACT_IDY", "CSR WHERE ACT_IDY = '" & Trim(M_CST_IDY) & "'"))) > 0 Then
            If APPLYCSR = True Then
                REC_SET("CPN_RAT") = GetValue("DIS_AMT", "CSR where ACT_IDY = '" & Trim(M_CST_IDY) & "' AND B_BAT_IDY = '" & Trim(MS.TextMatrix(A, 15)) & "'")
            Else
                REC_SET("CPN_RAT") = 0
            End If
        End If
        ...
        If Len(Trim(M_VAN_IDY)) = 0 Then
            If pcs_chk.Value = 1 Then
                con.Execute "update PRD where prd_idy = '" & Trim(MS.TextMatrix(A, 0)) & "' set CUR_LEV = " & CONQTY(Trim(MS.TextMatrix(A, 2)), Trim(MS.TextMatrix(A, 0))), d
                con.Execute "UPDATE PRD WHERE PRD_IDY = '" & Trim(MS.TextMatrix(A, 0)) & "' set PRD_PCS = PRD_PCS - " & MTS(Val(MS.TextMatrix(A, 2)), Val(MS.TextMatrix(A, 13))), d
                con.Execute "UPDATE BRD WHERE BAT_IDY = '" & Trim(MS.TextMatrix(A, 15)) & "' set prd_qty = " & CONBRDQTY(Trim(MS.TextMatrix(A, 2)), Trim(MS.TextMatrix(A, 15))), d
            Else
                con.Execute "update PRD where prd_idy = '" & Trim(MS.TextMatrix(A, 0)) & "' set CUR_LEV = " & CONQTY(QTY(STM(MS.TextMatrix(A, 2), Val(MS.TextMatrix(A, 13)))), Trim(MS.TextMatrix(A, 0)))
                con.Execute "UPDATE PRD WHERE PRD_IDY = '" & Trim(MS.TextMatrix(A, 0)) & "' set PRD_PCS = PRD_PCS - " & Val(MS.TextMatrix(A, 2))
                con.Execute "UPDATE BRD WHERE BAT_IDY = '" & Trim(MS.TextMatrix(A, 15)) & "' set prd_qty = " & CONBRDQTY(STM(MS.TextMatrix(A, 2), Val(MS.TextMatrix(A, 13))), Trim(MS.TextMatrix(A, 15)))
            End If
        End If
    End If
Next
    ...
    If Trim(MSF.TextMatrix(A, 0)) <> "" And Val(MSF.TextMatrix(A, 2)) > 0 And MSF.TextMatrix(A, 1) <> "" Then
        ...
        If Len(Trim(M_VAN_IDY)) = 0 Then
            If MSF.TextMatrix(A, 1) = "Free" Then
                If pcs_chk.Value = 1 Then
                    con.Execute "update PRD where prd_idy = '" & Trim(MSF.TextMatrix(A, 0)) & "' set CUR_LEV = " & CONQTY(Trim(MSF.TextMatrix(A, 2)), Trim(MSF.TextMatrix(A, 0))), d
                    con.Execute "UPDATE PRD WHERE PRD_IDY = '" & Trim(MSF.TextMatrix(A, 0)) & "' set PRD_PCS = PRD_PCS - " & MTS(Val(MSF.TextMatrix(A, 2)), Val(MSF.TextMatrix(A, 9))), d
                    con.Execute "UPDATE BRD WHERE BAT_IDY = '" & Trim(MSF.TextMatrix(A, 11)) & "' set prd_qty = " & CONBRDQTY(Trim(MSF.TextMatrix(A, 2)), Trim(MSF.TextMatrix(A, 11))), d
                Else
                    con.Execute "update PRD where prd_idy = '" & Trim(MSF.TextMatrix(A, 0)) & "' set CUR_LEV = " & CONQTY(QTY(STM(MSF.TextMatrix(A, 2), Val(MSF.TextMatrix(A, 9)))), Trim(MSF.TextMatrix(A, 0)))
                    con.Execute "UPDATE PRD WHERE PRD_IDY = '" & Trim(MSF.TextMatrix(A, 0)) & "' set PRD_PCS = PRD_PCS - " & Val(MSF.TextMatrix(A, 2))
                    con.Execute "UPDATE BRD WHERE BAT_IDY = '" & Trim(MSF.TextMatrix(A, 11)) & "' set prd_qty = " & CONBRDQTY(STM(MSF.TextMatrix(A, 2), Val(MSF.TextMatrix(A, 9))), Trim(MSF.TextMatrix(A, 11)))
                End If
            ElseIf MSF.TextMatrix(A, 1) = "Damage" Or MSF.TextMatrix(A, 1) = "TakeBack" Or MSF.TextMatrix(A, 1) = "Breakage" Or MSF.TextMatrix(A, 1) = "Leakage" Then
                If pcs_chk.Value = 1 Then
                    con.Execute "update PRD where prd_idy = '" & Trim(MSF.TextMatrix(A, 0)) & "' set CUR_LEV = " & ADDQTY(Trim(MSF.TextMatrix(A, 2)), Trim(MSF.TextMatrix(A, 0)))
                    con.Execute "UPDATE PRD WHERE PRD_IDY = '" & Trim(MSF.TextMatrix(A, 0)) & "' set PRD_PCS = PRD_PCS + " & MTS(Val(MSF.TextMatrix(A, 2)), Val(MSF.TextMatrix(A, 9)))
                    con.Execute "UPDATE BRD WHERE BAT_IDY = '" & Trim(MSF.TextMatrix(A, 11)) & "' set prd_qty = " & ADDBRDQTY(Trim(MSF.TextMatrix(A, 2)), Trim(MSF.TextMatrix(A, 11)))
                Else
                    con.Execute "update PRD where prd_idy = '" & Trim(MSF.TextMatrix(A, 0)) & "' set CUR_LEV = " & ADDQTY(QTY(STM(MSF.TextMatrix(A, 2), Val(MSF.TextMatrix(A, 9)))), Trim(MSF.TextMatrix(A, 0)))
                    con.Execute "UPDATE PRD WHERE PRD_IDY = '" & Trim(MSF.TextMatrix(A, 0)) & "' set PRD_PCS = PRD_PCS + " & Val(MSF.TextMatrix(A, 2))
                    con.Execute "UPDATE BRD WHERE BAT_IDY = '" & Trim(MSF.TextMatrix(A, 11)) & "' set prd_qty = " & ADDBRDQTY(STM(MSF.TextMatrix(A, 2), Val(MSF.TextMatrix(A, 9))), Trim(MSF.TextMatrix(A, 11)))
                End If
            End If
        End If
    End If
...
'           End If
        If Len(Trim(M_VAN_IDY)) = 0 Then
            ...
            REC_SET("RAT_APP") = "B"
            REC_SET("LST_RAT") = GetValue("LST_RAT", "PRD WHERE PRD_IDY = '" & MSS.TextMatrix(A, 5) & "'")
            REC_SET("LST_DIS") = GetValue("LST_DIS", "PRD WHERE PRD_IDY = '" & MSS.TextMatrix(A, 5) & "'")
            REC_SET("STK_TYP") = "Free"
            REC_SET("PRD_QTY") = STM(Val(.TextMatrix(A, 2)), Val(.TextMatrix(A, 12)))
            REC_SET("prd_rat") = Val(.TextMatrix(A, 3))
            If Len(Trim(GetValue("ACT_IDY", "CSR WHERE ACT_IDY = '" & Trim(M_CST_IDY) & "'"))) > 0 Then
                If APPLYCSR = True Then
                    REC_SET("CPN_RAT") = GetValue("DIS_AMT", "CSR where ACT_IDY = '" & Trim(M_CST_IDY) & "' AND B_BAT_IDY = '" & Trim(.TextMatrix(A, 7)) & "'")
                Else
                    REC_SET("CPN_RAT") = 0
                End If
            Else
            ...
            PFA = 0#
            SFA = 0#
            P_LPP = GetValue("U_PUR_LPP", "BRD WHERE BAT_IDY = '" & Trim(MSS.TextMatrix(A, 7)) & "'")
            S_LPP = GetValue("U_SAL_LPP", "BRD WHERE BAT_IDY = '" & Trim(MSS.TextMatrix(A, 7)) & "'")
            ...
            If Len(Trim(M_VAN_IDY)) = 0 Then
                con.Execute "update PRD where prd_idy = '" & Trim(.TextMatrix(A, 5)) & "' set CUR_LEV = " & CONQTY(QTY(STM(.TextMatrix(A, 2), Val(.TextMatrix(A, 12)))), Trim(.TextMatrix(A, 5))), d
                con.Execute "UPDATE PRD WHERE PRD_IDY = '" & Trim(.TextMatrix(A, 5)) & "' set PRD_PCS = PRD_PCS - " & Val(.TextMatrix(A, 2)), d
                con.Execute "UPDATE BRD WHERE BAT_IDY = '" & Trim(.TextMatrix(A, 7)) & "' set prd_qty = " & CONBRDQTY(STM(.TextMatrix(A, 2), Val(.TextMatrix(A, 12))), Trim(.TextMatrix(A, 7))), d
            End If
        Else
            If ISC_RS.State = 1 Then ISC_RS.Close
            ISC_RS.Open "SELECT * FROM INV WHERE ORD_IDY = '" & Trim(M_VAN_IDY) & "' AND BAT_IDY = '" & Trim(.TextMatrix(A, 7)) & "' AND SCH_IDY = '" & Trim(.TextMatrix(A, 8)) & "' AND STK_TYP LIKE 'Free' AND TXN_TYP = 'SAL'", con, adOpenKeyset, adLockPessimistic
            ...
            VSC_RS.Open "SELECT * FROM VAN WHERE INV_IDY = '" & Trim(M_VAN_IDY) & "' AND BAT_IDY = '" & Trim(.TextMatrix(A, 7)) & "'", con, adOpenKeyset, adLockPessimistic
            ...
            '    If (MTS(Val(VSC_RS("FRE_QTY")), Val(.TextMatrix(A, 12))) - Val(ESC_QTY)) >= Val(.TextMatrix(A, 2)) Then
                If (MTS(Val(VSC_RS("FRE_QTY")), Val(.TextMatrix(A, 12))) - Val(ESC_QTY)) > 0 And APP_SCH_QTY > 0 Then
                    ...
                    If Val(APP_SCH_QTY) > Val(AVB_SCH_QTY) Then
                        ...
                        M_SKP_PRD_NME = GetValue("PRD_NME", "PRD WHERE PRD_IDY = '" & Trim(MSS.TextMatrix(A, 5)) & "'")
                        M_SKP_SCH_NME = GetValue("SCH_NME", "SCH WHERE SCH_IDY = '" & Trim(.TextMatrix(A, 8)) & "'")
...
Fill_LNV_Batch (M_INV_IDY)
Scheme_Price_Update (M_INV_IDY)
LNV_Rpt_Update (M_INV_IDY)

If Len(M_VAN_IDY) = 0 Then
    AddShells Trim(INC), "SAL", M_CST_IDY, "Y", M_SMN_IDY, M_ROU_IDY
Else
    AddShells Trim(INC), "SAL", M_CST_IDY, "N", M_SMN_IDY, M_ROU_IDY
End If
'Schemes UPDATE END
If Toolbar1.Buttons(11).Value = tbrPressed Then
If MOD_REC = False Then
...
If check("PRT", "PRT_NME", "SAL_SHL") Then LOADSHELLS "SAL", Trim(INC)
If check("PRT", "PRT_NME", "M_FRM_SAL") = True Then
    con.Execute "update dir where dir_idy = 'INV' AND DIR_IDX = 'NUM' set dir_als = '" & INC & "'"
    con.Execute "update dir where dir_idy = 'DOC' AND DIR_IDX = 'TYP' set dir_als = 'SAL'"
    If querycheck("DIR", "DIR_MSG", "D", " AND DIR_IDY = 'SYS' AND DIR_IDX = 'DOS'") = True Then
        ...
        End If
    Else
        If Trim(GetValue("DIR_MSG", "DIR WHERE DIR_IDY = 'SYS' AND DIR_IDX = 'RRW'")) = "T" Then
            RRW_OpenDocument CURDIR & "", "Invoice", 2, Trim(INC), Trim(INC), 6, CURDIR & "\PNV.CDX"
        Else
            OpenDocument CURDIR & "\DOS_VCH.RP1", "Invoice", 2, Trim(INC), Trim(INC), 6, CURDIR & "\pnv.cdx,c,inv_idy"
        End If
    End If
    CANCELRECORD
End If
...
INL_JMD.Open "SELECT * FROM INL WHERE TXN_TYP = 'SAL'", con, adOpenKeyset, adLockPessimistic
...
If K = 13 Then
    ...
    ElseIf List7 = "TakeBack" Or List7 = "Damage" Or List7 = "Shortage" Or List7 = "Breakage" Or List7 = "Leakage" Then
        ...
        Prdtax.Open "select * from PRD where PRD_IDY = '" & MSF.TextMatrix(MSF.Row, 0) & "'", con, adOpenKeyset, adLockPessimistic
        Tkbtax = Val(Trim(Prdtax("SAL_TAX")))
        ' Changed by PKB/PNR for TakeBack Tax Calculation
        If pcs_chk.Value = 1 Then
            MSF.TextMatrix(MSF.Row, 2) = "0.000"
            MSF.TextMatrix(MSF.Row, 4) = convert(Val(GetValue("prd_sdr", "brd where bat_idy = '" & Trim(MSF.TextMatrix(MSF.Row, 11)) & "'")))
            If APPLYCSR = True Then MSF.TextMatrix(MSF.Row, 4) = convert(Val(GetValue("B_PRD_RAT", "CSR WHERE B_BAT_IDY = '" & Trim(MSF.TextMatrix(MSF.Row, 11)) & "' and act_idy = '" & Trim(M_CST_IDY) & "'")))
        Else
            MSF.TextMatrix(MSF.Row, 2) = "0"
            MSF.TextMatrix(MSF.Row, 4) = convert(Val(GetValue("prd_sdr", "brd where bat_idy = '" & Trim(MSF.TextMatrix(MSF.Row, 11)) & "'")) / Val(MSF.TextMatrix(MSF.Row, 9)))
            If APPLYCSR = True Then MSF.TextMatrix(MSF.Row, 4) = convert(Val(GetValue("B_PRD_RAT", "CSR WHERE B_BAT_IDY = '" & Trim(MSF.TextMatrix(MSF.Row, 11)) & "' and act_idy = '" & Trim(M_CST_IDY) & "'")) / Val(MSF.TextMatrix(MSF.Row, 9)))
        End If
        ...
        If querycheck("van", "inv_idy", M_VAN_IDY, "AND VAN_CLS='S' AND VAN_CHK='V'") = True Then
            If MOD_REC = False Then
                ...
                If rs.RecordCount > 0 Then
                    ...
                    If querycheck("DIR", "DIR_MSG", "T", " AND DIR_IDY = 'SYS' AND DIR_IDX = 'DBR'") = True Then
...
If KeyAscii = 13 Then
    ...
    End If
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from prd,BRD where PRD.PRD_IDY = BRD.PRD_IDY AND BRD.BAT_idy = '" & MS.TextMatrix(MS.Row, 15) & "'", con, adOpenKeyset, adLockPessimistic
    If REC_SET.RecordCount > 0 Then
        If APPLYCSR = False Then
            If Len(Trim(M_VAN_IDY)) <> 0 Then
                If querycheck("DIR", "DIR_MSG", "T", " AND DIR_IDY = 'SYS' AND DIR_IDX = 'DBV'") = True Then
                    If pcs_chk.Value = 1 Then
...
If KeyCode = 13 Or KeyCode = 40 Then
    If Val(M_CRT_DAY) > 365 Then
        ...
        M_CRT_DAY.SetFocus
    Else
        If querycheck("DIR", "DIR_MSG", "T", " AND DIR_IDY = 'SYS' AND DIR_IDX = 'AAS'") = True Then
            M_HVO_CHK = GetValue("CST_TYP", "ACT WHERE ACT_IDY = '" & Trim(M_CST_IDY) & "'")
            M_HVO_FLG = GetValue("DIR_MSG", "DIR WHERE DIR_IDY = 'SYS' AND DIR_IDX = 'AOM'")
            If Trim(M_HVO_CHK) = "HVO-P" Or Trim(M_HVO_CHK) = "HVO-NP" Or Trim(M_HVO_CHK) = "HVO-NP-WO" Or Trim(M_HVO_CHK) = "HVO-P-WO" Then
                ...
                Else
                    ...
                    Else
                        AutoApplyScheme
                        MsgBox "Schemes Auto-Apply Mode! Applied Successfully All Valid Schemes for this Invoice!", vbInformation, "DAS Version 4.0"
...
Chk_PCart.Open "select * from INV where INV_IDY like '" & Trim(M_INV_IDY) & "' AND TXN_TYP = 'SAL'", con, adOpenKeyset, adLockPessimistic
If Chk_PCart.RecordCount > 0 Then
    If Chk_PCart("ISS_QTY") > 0 Or Chk_PCart("OPN_QTY") > 0 Or Chk_PCart("TOT_QTY") > 0 Then
       MsgBox "This is a PushCart Invoice!", vbCritical, "DAS Version 4.0"
       CANCELRECORD
       Exit Sub
    End If
End If
...
If Toolbar1.Buttons(11).Value = tbrPressed Then
    If Check1.Value = 1 Then
        If DateDayCls = Date Then
            REC_SET.Open "select inl.inv_idy,inl.inv_dat,act.act_nme,act.act_ad4,ord_idy from act,inl where act_nme like '" & Trim(M_INV_IDY) & "%' and inl.cst_idy=act.act_idy and inl.txn_typ ='SAL'", con, adOpenKeyset, adLockPessimistic
        Else
            REC_SET.Open "select inl.inv_idy,inl.inv_dat,act.act_nme,act.act_ad4,ord_idy from act,inl where act_nme like '" & Trim(M_INV_IDY) & "%' and inl.cst_idy=act.act_idy and inl.txn_typ ='SAL' and INL.INV_DAT > CTOD('" & DateDayCls & "')", con, adOpenKeyset, adLockPessimistic
        End If
    Else
        If DateDayCls = Date Then
            REC_SET.Open "select inl.inv_idy,inl.inv_dat,act.act_nme,act.act_ad4,ord_idy from act,inl where act_ad4 like '" & Trim(M_INV_IDY) & "%' and inl.cst_idy=act.act_idy and inl.txn_typ ='SAL'", con, adOpenKeyset, adLockPessimistic
        Else
            REC_SET.Open "select inl.inv_idy,inl.inv_dat,act.act_nme,act.act_ad4,ord_idy from act,inl where act_ad4 like '" & Trim(M_INV_IDY) & "%' and inl.cst_idy=act.act_idy and inl.txn_typ ='SAL' and INL.INV_DAT > CTOD('" & DateDayCls & "')", con, adOpenKeyset, adLockPessimistic
        End If
    End If
Else
    If Len(Trim(M_INV_IDY)) <> 0 Then
...
If list1.Visible = False And list2.Visible = False And list3.Visible = False And list4.Visible = False And list5.Visible = False Then
    ...
    If KeyCode = 69 And Shift = 2 Then
        If M_FRM_SAL.ActiveControl.name = "M_INV_IDY" Then
            V_INV_LST
        ElseIf M_FRM_SAL.ActiveControl.name = "M_CST_IDY" Then
            V_DLR_LST
        ElseIf M_FRM_SAL.ActiveControl.name = "M_SMN_IDY" Then
            V_LST_CAP = "Select Salesman"
            V_SMN_LST
        ElseIf M_FRM_SAL.ActiveControl.name = "M_ACT_IDY" Then
            V_ACT_LST
        ElseIf M_FRM_SAL.ActiveControl.name = "Text3" Then
            list4.Tag = ""
            V_PRD_LST
        End If
    End If
End If
If KeyCode > 111 And KeyCode < 120 Then If TypeOf M_FRM_SAL.ActiveControl Is TextBox Then M_FRM_SAL.ActiveControl.Text = FUNKEY(KeyCode)
End Sub
...
'    On Error Resume Next
    ...
    If REC_SET.RecordCount > 0 Then
        If msg = False Then
            MsgBox "Scheme Invoice! Re-apply Schemes for any changes made to this Invoice!", vbInformation, "DAS Version 4.0"
        End If
        CHGQTY = "Yes Schemes"
    End If
    If REC_SET.State = 1 Then REC_SET.Close
    ...
    For A = 1 To MS.Rows - 1
        ...
        REC_SET2.Open "SELECT * FROM BRD WHERE BAT_IDY = '" & Trim(REC_SET!BAT_IDY) & "'", con, adOpenKeyset, adLockPessimistic
...
'            MS.TextMatrix(A, 24) = convert(REC_SET("CPN_AMT") & "")
        End If
        If REC_SET2.State = 1 Then REC_SET2.Close
        REC_SET2.Open "SELECT prd_nme,CON_FAC,SUB_UNT,pgr.GRP_IDY,GRP_CAT,GRP_CLS,PRD_PRN FROM PRD,pgr WHERE prd.grp_idy = pgr.grp_idy and PRD_IDY = '" & REC_SET("PRD_IDY") & "'", con, adOpenKeyset, adLockPessimistic
        If REC_SET2.RecordCount > 0 Then
    ...
    With MSF
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from inv where inv_idy = '" & Trim(M_INV_IDY) & "' and txn_typ = 'SAL' and sch_idy IS NULL and stk_typ in('Free','Damage','Replc.','TakeBack', 'Shortage','Breakage','Leakage')", con, adOpenKeyset, adLockPessimistic
    ...
    For A = 1 To .Rows - 1
        ...
        Else
            ...
            Else
                .TextMatrix(A, 4) = convert(Val(REC_SET("prd_rat") & "") + Val(REC_SET("TAX_AMT")))  '/ Val(REC_SET("SUB_UNT"))Changed by PNR
            End If
        End If
        ...
        End If
        If REC_SET2.State = 1 Then REC_SET2.Close
        REC_SET2.Open "SELECT prd_nme,CON_FAC,SUB_UNT,pgr.GRP_IDY,GRP_CAT,GRP_CLS,PRD_PRN FROM PRD,pgr WHERE prd.grp_idy = pgr.grp_idy and PRD_IDY = '" & REC_SET("PRD_IDY") & "'", con, adOpenStatic
        If REC_SET2.RecordCount > 0 Then
...
If err.Number = 35773 Then
    MsgBox "Invalid Invoice Selected for this Financial Year", vbInformation, "DAS Version 4.0"
    CANCELRECORD
Else
...
If K = 13 Then
    If MS.Col = 0 Then
        If REC_SET.State = 1 Then REC_SET.Close
        REC_SET.Open "SELECT * FROM prd,BRD WHERE PRD.prd_IDY LIKE '" & Sincrement(Text3) & "' AND BRD.PRD_IDY = PRD.PRD_IDY AND STK_TYP IN('Salable') and prd_qty >0", con, adOpenKeyset
...
ElseIf K = 13 Then
    If MS.Col = 2 Then
        ...
        If Trim(M_INV_IDY) <> "" Then
            REC_SET2.Open "select SUM(TOT_PCS),SUB_UNT from inv where BAT_IDY = '" & Trim(MS.TextMatrix(MS.Row, 15)) & "' and inv_idy = '" & Trim(M_INV_IDY) & "' and txn_typ = 'SAL' and stk_typ in('Salable','Free') GROUP BY BAT_IDY", con, adOpenKeyset, adLockPessimistic
        ...
        If pcs_chk.Value = 0 Then M_QTY = pcs
            ...
            If querycheck("DIR", "DIR_MSG", "U", " and dir_idy = 'SYS' AND DIR_IDX = 'STK'") = False Then
                ...
                Else
                    ...
                    REC_VAN.Open "SELECT * FROM VAN WHERE INV_IDY = '" & Trim(M_VAN_IDY) & "' AND BAT_IDY = '" & Trim(MS.TextMatrix(MS.Row, 15)) & "'", con, adOpenKeyset, adLockPessimistic
                    ...
                    REC_VAN_INV.Open "SELECT * FROM INV WHERE ORD_IDY = '" & Trim(M_VAN_IDY) & "' AND BAT_IDY = '" & Trim(MS.TextMatrix(MS.Row, 15)) & "' AND STK_TYP LIKE 'Salable' AND TXN_TYP = 'SAL'", con, adOpenKeyset, adLockPessimistic
                    ...
                    If M_FLX_AMT <> 0 Then
                        If (Val(V_NET_LOD) - (Val(B_NET_LOD) + Val(V_FRE_LOD))) - Val(CURQTY) < 0 Then
                            MsgBox "Net Load Stock Balance for this Invoice is : " & str(Val(C_NET_LOD)) & ", Check Net Load Stock !", vbExclamation, "DAS Version 4.0"
                            If M_FLX_AMT.Visible = True Then
                                M_FLX_AMT.SetFocus
                            Else
                                MS.SetFocus
...
For A = 1 To MS.Rows - 1
    ...
    If Trim(MS.TextMatrix(A, 0)) <> "" Then
        ...
        If MOD_REC = True And APPLYCSR = False Then
            DIS_TOT = DIS_TOT + Round(Val(MS.TextMatrix(A, 6)), 1)
        End If
        If pcs_chk.Value = 0 Then
            CHK_HVO_APP = Trim(GetValue("CST_TYP", "ACT WHERE ACT_IDY = '" & Trim(M_CST_IDY) & "'"))
            If Trim(CHK_HVO_APP) = "HVO-NP" Or Trim(CHK_HVO_APP) = "HVO-NP-WO" Then
...
Dim REC_SET As New ADODB.Recordset
If REC_SET.State = 1 Then REC_SET.Close
If querycheck("dir", "dir_msg", "U", " AND DIR_IDY = 'SYS' AND DIR_IDX = 'STK'") = True Then
    qry = ""
Else
    If Len(Trim(M_VAN_IDY)) = 10 Then
        qry = ""
    ...
    If Check1.Value = 1 Then
        ...
        If REC_SET.RecordCount > 0 Then
                ...
                With MS
                    ...
                    Else
                    If pcs_chk.Value = 1 Then
                        .TextMatrix(.Row, 5) = convert(GetValue("PRD_RAT", "CSR where B_BAT_IDY = '" & Trim(REC_SET("bat_idy")) & "' AND ACT_IDY = '" & Trim(M_CST_IDY) & "'"))
                    Else
                        .TextMatrix(.Row, 5) = convert(Val(GetValue("PRD_RAT", "CSR where B_BAT_IDY = '" & Trim(REC_SET("bat_idy")) & "' AND ACT_IDY = '" & Trim(M_CST_IDY) & "'")) / Val(REC_SET("sub_unt")))
                    End If
                    End If
                    .TextMatrix(.Row, 6) = "0.00"
                    .TextMatrix(.Row, 7) = discount(REC_SET("sal_dis") & "")
        ...
        Else    'Filtered Selection by pressing the SKU Alphabet lookup in  PRD_NME field
            If Len(Trim(M_VAN_IDY)) = 10 Then
                REC_SET.Open "SELECT * FROM PRD,BRD,VAN WHERE PRD.PRD_IDY = BRD.PRD_IDY AND VAN.BAT_IDY = BRD.BAT_IDY AND PRD_NME LIKE '" & Trim(Text3) & "%' AND VAN.INV_IDY = '" & Trim(M_VAN_IDY) & "' AND STK_TYP IN('Salable')" & qry & "order by brw_seq", con, adOpenKeyset
            Else
                REC_SET.Open "SELECT * FROM PRD,BRD WHERE PRD.PRD_IDY = BRD.PRD_IDY AND PRD_NME LIKE '" & Trim(Text3) & "%' AND STK_TYP IN('Salable')" & qry & "order by brw_seq", con, adOpenKeyset
            End If
        End If
    Else        'Filtered Selection by pressing the SKU Alphabet lookup in ShortName field
        If Len(Trim(M_VAN_IDY)) = 10 Then
            REC_SET.Open "SELECT * FROM PRD,BRD,VAN WHERE PRD.PRD_IDY = BRD.PRD_IDY AND VAN.BAT_IDY = BRD.BAT_IDY AND PRD_PRN LIKE '" & Trim(Text3) & "%' AND VAN.INV_IDY = '" & Trim(M_VAN_IDY) & "' AND STK_TYP IN('Salable')" & qry & "order by brw_seq", con, adOpenKeyset
        Else
            REC_SET.Open "SELECT * FROM prd,BRD WHERE PRD.PRD_IDY = BRD.PRD_IDY AND PRD_PRN LIKE '" & Trim(Text3) & "%' AND STK_TYP IN('Salable')" & qry & "order by brw_seq", con, adOpenKeyset
        End If
    End If
End If
...
If REC_SET.State = 1 Then REC_SET.Close
If list4.Tag = "MSF" Then
    REC_SET.Open "SELECT * FROM BRD,PRD WHERE BRD.PRD_IDY = PRD.PRD_IDY AND BRD.PRD_IDY LIKE '" & Sincrement(Text4) & "%' AND PRD.STK_TYP IN('Free','Salable','Promotional Item') and BRD.prd_qty >0 order by brw_seq", con, adOpenKeyset
Else
    REC_SET.Open "SELECT * FROM BRD,PRD WHERE BRD.PRD_IDY = PRD.PRD_IDY AND BRD.PRD_IDY LIKE '" & Sincrement(Text3) & "%' AND PRD.STK_TYP IN('Salable') and BRD.prd_qty >0 order by brw_seq", con, adOpenKeyset
End If
list4.ListItems.CLEAR
If REC_SET.RecordCount > 0 Then
    For A = 1 To REC_SET.RecordCount
...
If CHECKTB("dir.dbf,inl.dbf") = 1 Then
        ...
        Exit Sub
End If
If querycheck("DIR", "DIR_MSG", "R", " AND DIR_IDY = 'SYS' AND DIR_IDX = 'ROU'") = True Then
Else
    Exit Sub
End If
Dim REC_SET As New ADODB.Recordset
...
If MsgBox("Create New Price n Batch Record?", vbQuestion + vbYesNo, "DAS Version 4.0") = vbYes Then
    ...
    End If
    Me.Tag = "Batch"
    If querycheck("DIR", "DIR_MSG", "E", " AND DIR_IDY = 'SYS' AND DIR_IDX = 'EXP'") = True Then M_FRM_NBC.Width = 7530
    M_FRM_NBC.Tag = "SAL"
    M_FRM_NBC.Show 1
    MS.SetFocus
Else
...
If MSF.Col = 0 Then
    If KeyCode = 13 Then
        rsprd.Open "select * from prd,brd where prd.prd_idy = brd.prd_idy and prd.prd_idy = '" & Sincrement(Text4) & "'", con, adOpenKeyset, adLockPessimistic
...
With MSF
    If MSF.Col = 2 Then
        ...
        End If
        RSINV.Open "select sum(tot_pcs) from inv where bat_idy = '" & Trim(.TextMatrix(.Row, 11)) & "' and inv_idy = '" & Trim(M_INV_IDY) & "' and txn_typ = 'SAL' and stk_typ in('Free','Salable')", con, adOpenKeyset, adLockPessimistic
        ...
        If .Col = 2 Then
            ...
            Else
                CURQTY = (Val(salqty) + MTS(Val(STK), .TextMatrix(.Row, 9)))
            End If
            BRDQTY = Val(GetValue("prd_qty", "brd where bat_idy = '" & Trim(.TextMatrix(.Row, 11)) & "'"))
            BRDQTY = MTS(Val(BRDQTY), .TextMatrix(.Row, 9))
            If MSF.TextMatrix(MSF.Row, 1) = "Free" Or MSF.TextMatrix(MSF.Row, 1) = "Replc." Then
                If querycheck("DIR", "DIR_MSG", "U", " AND DIR_IDY = 'SYS' AND DIR_IDX LIKE 'STK'") = False Then
                    If Len(Trim(M_VAN_IDY)) = 10 Then
...
ElseIf Button.KEY = "ed" Then
    ...
    ElseIf M_FRM_SAL.ActiveControl.name = "M_ACT_IDY" Then
        V_LST_CAP = "Select Account"
        V_ACT_LST
    ElseIf M_FRM_SAL.ActiveControl.name = "Text3" Or (MS.Col = 0 And SSTab1.Tab = 1) Then
        list4.Tag = ""
        V_PRD_LST
    End If
...
With MSS
rs.Open "SELECT PRD.PRD_IDY,BAT_NME,PRD_NME,SCH.BAT_IDY AS BAT_IDY,PRD_MRP,B_PRD_QTY,GRP_IDY,PRD_SDR,TXN_TYP,F_PRD_IDY,SUB_UNT,PRO_RAT,PRD.CON_FAC AS CONFAC FROM SCH,BRD,PRD WHERE SCH_IDY LIKE '" & Trim(SCHIDY) & "' AND SCH.BAT_IDY LIKE BRD.BAT_IDY AND BRD.PRD_IDY = PRD.PRD_IDY", con, adOpenKeyset, adLockPessimistic
Set RSTMP = rs.Clone
For A = 1 To MS.Rows - 1
    If Trim(MS.TextMatrix(A, 0)) <> "" Then
...
Dim rs As New ADODB.Recordset
With MSS
rs.Open "SELECT PRD.PRD_IDY,BAT_NME,PRD_NME,SCH.BAT_IDY AS BAT_IDY,PRD_MRP,B_PRD_QTY,GRP_IDY,PRD_SDR,TXN_TYP,F_PRD_IDY,SUB_UNT,B_BIL_AMT,PRD.CON_FAC AS CONFAC FROM SCH,BRD,PRD WHERE SCH_IDY LIKE '" & Trim(SCHIDY) & "' AND SCH.BAT_IDY = BRD.BAT_IDY AND BRD.PRD_IDY = PRD.PRD_IDY", con, adOpenKeyset, adLockPessimistic
...
Else
    ...
    If rs.RecordCount > 0 And RSTMP.RecordCount > 0 Then
        MAXVALUE = GetValue("MAX(B_PRD_QTY)", "SCH WHERE SCH_IDY = '" & Trim(SCHIDY) & "' AND TXN_TYP = 'BAS'")
        For A = 1 To rs.RecordCount
    ...
    Else
        ...
        If rs.RecordCount > 0 And RSTMP.RecordCount > 0 Then
            ...
            RSTMP.MoveFirst
            MAXVALUE = GetValue("MAX(B_PRD_QTY)", "SCH WHERE SCH_IDY = '" & Trim(SCHIDY) & "' AND TXN_TYP = 'BAS'")
            FREMAXVALUE = GetValue("MAX(B_PRD_QTY)", "SCH WHERE SCH_IDY = '" & Trim(SCHIDY) & "' AND TXN_TYP = 'FRE'")
            With MSS
            For A = 1 To rs.RecordCount
    ...
    For A = 1 To rs.RecordCount
        ...
        Else
            If Val(b) = Val(MAXQTY) Then
                ...
                LSCH_AMT = convert(Val(LSCH_AMT) + Val(disamt))
            ElseIf Val(b) > Val(MAXQTY) Then
                PNR_SUT = GetValue("SKU_SBU", "BRD WHERE BAT_IDY = '" & Trim(rs!BAT_IDY) & "'")
                PNR_DRT = GetValue("PRD_SDR", "BRD WHERE BAT_IDY = '" & Trim(rs!BAT_IDY) & "'")
...
For A = 1 To .Rows - 1
    ...
    BRDQTY = GetValue("PRD_QTY", "BRD WHERE BAT_IDY = '" & Trim(.TextMatrix(A, 7)) & "'")
    BRDQTY = MTS(Val(BRDQTY), .TextMatrix(A, 12))
    If MOD_REC = True Then d = GetValue("sum(tot_pcs)", "inv where inv_idy = '" & Trim(M_INV_IDY) & "' and stk_typ in ('Salable','Free') and bat_idy like '" & Trim(.TextMatrix(A, 7)) & "'")
...
For A = 1 To rs.RecordCount
    ...
    Else
        smnid = GetValue("SMN_IDY", "SID WHERE SMN_IDY = '" & Trim(M_SMN_IDY) & "' AND SCH_IDY = '" & Trim(RSS!Sch_Idy) & "'")
        ROUID = GetValue("ROU_IDY", "SID WHERE ROU_IDY = '" & Trim(M_ROU_IDY) & "' AND SCH_IDY = '" & Trim(RSS!Sch_Idy) & "'")
        CSTID = GetValue("CST_IDY", "SID WHERE CST_IDY = '" & Trim(M_CST_IDY) & "' AND SCH_IDY = '" & Trim(RSS!Sch_Idy) & "'")
        If Len(Trim(smnid)) > 0 Or Len(Trim(ROUID)) > 0 Or Len(Trim(CSTID)) > 0 Then
            Set ls = SCHLST.ListItems.Add(, , Trim(RSS!Sch_Nme))
            ls.ListSubItems.Add , , Format(RSS!sch_bdt, "dd/mmm/yyyy")
            ls.ListSubItems.Add , , Format(RSS!sch_edt, "dd/mmm/yyyy")
...
For C = 1 To REC_SET.RecordCount
    ...
    If rs.RecordCount > 0 Then
        ...
        Else
            smnid = GetValue("SMN_IDY", "SID WHERE SMN_IDY = '" & Trim(M_SMN_IDY) & "' AND SCH_IDY = '" & Trim(REC_SET!Sch_Idy) & "'")
            ROUID = GetValue("ROU_IDY", "SID WHERE ROU_IDY = '" & Trim(M_ROU_IDY) & "' AND SCH_IDY = '" & Trim(REC_SET!Sch_Idy) & "'")
            CSTID = GetValue("CST_IDY", "SID WHERE CST_IDY = '" & Trim(M_CST_IDY) & "' AND SCH_IDY = '" & Trim(REC_SET!Sch_Idy) & "'")
            If Len(Trim(smnid)) > 0 Or Len(Trim(ROUID)) > 0 Or Len(Trim(CSTID)) > 0 Then
                Set ls = SCHLST.ListItems.Add(, , Trim(REC_SET!Sch_Nme))
                ls.ListSubItems.Add , , Format(REC_SET!sch_bdt, "dd/mmm/yyyy")
                ls.ListSubItems.Add , , Format(REC_SET!sch_edt, "dd/mmm/yyyy")
        ...
        End If
    ElseIf rs!B_CON_APP = "ORO" Then
            MAXVALUE = GetValue("MAX(B_PRD_QTY)", "SCH WHERE SCH_IDY = '" & Trim(rs!Sch_Idy) & "' AND TXN_TYP = 'BAS'")
            For A = 1 To rs.RecordCount
...
For A = 1 To MS.Rows - 1
    If TYP = "Brand" Then
        If Trim(NME) = Trim(GetValue("brd_nme", "prd where prd_idy = '" & Trim(MS.TextMatrix(A, 0)) & "'")) Then
            If pcs_chk.Value = 1 Then
    ...
    ElseIf TYP = "Pack Size" Then
        If Trim(NME) = Trim(GetValue("prd_pck", "prd where prd_idy = '" & Trim(MS.TextMatrix(A, 0)) & "'")) Then
            If pcs_chk.Value = 1 Then
                stkcount = Val(stkcount) + MTS(Val(MS.TextMatrix(A, 2)), Val(MS.TextMatrix(A, 13)))
            Else
                stkcount = Val(stkcount) + Val(MS.TextMatrix(A, 2))
    ...
    ElseIf TYP = "Pack Type" Then
        If Trim(NME) = Trim(GetValue("prd_pkt", "prd where prd_idy = '" & Trim(MS.TextMatrix(A, 0)) & "'")) Then
            If pcs_chk.Value = 1 Then
                stkcount = Val(stkcount) + MTS(Val(MS.TextMatrix(A, 2)), Val(MS.TextMatrix(A, 13)))
            Else
                stkcount = Val(stkcount) + Val(MS.TextMatrix(A, 2))
...
Dim RSTMP As New ADODB.Recordset
Dim rsprd As New ADODB.Recordset
rs.Open "SELECT * FROM SCH WHERE SCH_IDY = '" & Trim(SCHIDY) & "'", con, adOpenKeyset, adLockPessimistic
Set RSTMP = rs.Clone
...
If RSTMP.RecordCount > 0 Then
    ...
    rsprd.Open "SELECT * FROM PRD,BRD WHER BRD.PRD_IDY = PRD.PRD_IDY ", con, adOpenKeyset, adLockPessimistic
    For A = 1 To rs.RecordCount
        With MSS
        .AddItem ""
            If rsprd.RecordCount > 0 Then rsprd.MoveFirst
            rsprd.Find "BAT_IDY = '" & Trim(rs!BAT_IDY) & "'"
...
If RSTMP.RecordCount > 0 Then
    ...
    If rsprd.State = 1 Then rsprd.Close
    rsprd.Open "SELECT * FROM PRD,BRD WHERE BRD.PRD_IDY = PRD.PRD_IDY ", con, adOpenKeyset, adLockPessimistic
    For A = 1 To rs.RecordCount
        With MSS
        .AddItem ""
            If rsprd.RecordCount > 0 Then rsprd.MoveFirst
...
If RSTMP.RecordCount > 0 Then
    ...
    Next
    If rsprd.State = 1 Then rsprd.Close
    rsprd.Open "SELECT * FROM PRD,BRD,PGR WHER BRD.PRD_IDY = PRD.PRD_IDY AND PRD.GRP_IDY = PGR.GRP_IDY", con, adOpenKeyset, adLockPessimistic
    For A = 1 To rs.RecordCount
        With MSS
        .AddItem ""
            If rsprd.RecordCount > 0 Then rsprd.MoveFirst
...
For A = 1 To MS.Rows - 1
    If MType = "Brand" Then
        If Trim(mValue) = Trim(GetValue("brd_nme", "prd where prd_idy = '" & Trim(MS.TextMatrix(A, 0)) & "'")) Then prdvalue = prdvalue + Val(MS.TextMatrix(A, 9))
    ElseIf MType = "Pack Size" Then
        If Trim(mValue) = Trim(GetValue("prd_pck", "prd where prd_idy = '" & Trim(MS.TextMatrix(A, 0)) & "'")) Then prdvalue = prdvalue + Val(MS.TextMatrix(A, 9))
    ElseIf MType = "Pack Type" Then
        If Trim(mValue) = Trim(GetValue("prd_pkt", "prd where prd_idy = '" & Trim(MS.TextMatrix(A, 0)) & "'")) Then prdvalue = prdvalue + Val(MS.TextMatrix(A, 9))
...
Public Sub PNV_PNL_SaveProcedure()
Dim REC_PNL As New ADODB.Recordset
...
For A = 1 To MS.Rows - 1
    If Trim(MS.TextMatrix(A, 0)) <> "" And Val(MS.TextMatrix(A, 2)) > 0 And MS.TextMatrix(A, 1) <> "" Then
        ...
        If Len(Trim(GetValue("ACT_IDY", "CSR WHERE ACT_IDY = '" & Trim(M_CST_IDY) & "'"))) > 0 Then
            If APPLYCSR = True Then
                REC_PNL("CPN_RAT") = GetValue("DIS_AMT", "CSR where ACT_IDY = '" & Trim(M_CST_IDY) & "' AND B_BAT_IDY = '" & Trim(MS.TextMatrix(A, 15)) & "'")
            Else
                REC_PNL("CPN_RAT") = 0
            End If
        Else
...
'        REC_PNL("rat_app") = Trim(MSF.TextMatrix(A, 4)) 'ADDED BY PNR
        ...
        If Len(Trim(GetValue("ACT_IDY", "CSR WHERE ACT_IDY = '" & Trim(M_CST_IDY) & "'"))) > 0 Then
            If APPLYCSR = True Then
                REC_PNL("CPN_RAT") = GetValue("DIS_AMT", "CSR where ACT_IDY = '" & Trim(M_CST_IDY) & "' AND B_BAT_IDY = '" & Trim(MSF.TextMatrix(A, 11)) & "'")
            Else
                REC_PNL("CPN_RAT") = 0
            End If
        Else
...
For A = 1 To MSS.Rows - 1
    If Trim(MSS.TextMatrix(A, 0)) <> "" And (Val(MSS.TextMatrix(A, 2)) > 0 Or Val(MSS.TextMatrix(A, 4)) > 0) And APPSCH = True Then
        ...
        If Len(Trim(GetValue("ACT_IDY", "CSR WHERE ACT_IDY = '" & Trim(M_CST_IDY) & "'"))) > 0 Then
            If APPLYCSR = True Then
                REC_PNL("CPN_RAT") = GetValue("DIS_AMT", "CSR where ACT_IDY = '" & Trim(M_CST_IDY) & "' AND B_BAT_IDY = '" & Trim(MSS.TextMatrix(A, 7)) & "'")
            Else
                REC_PNL("CPN_RAT") = 0
            End If
        Else
        ...
        REC_PNL("lst_rat") = GetValue("LST_RAT", "PRD WHERE PRD_IDY = '" & MSS.TextMatrix(A, 5) & "'")
        REC_PNL("lst_dis") = GetValue("LST_DIS", "PRD WHERE PRD_IDY = '" & MSS.TextMatrix(A, 5) & "'")
        REC_PNL("ret_qty") = 0
        REC_PNL("iss_qty") = 0
        REC_PNL("tot_qty") = 0
        REC_PNL("rat_app") = "B" 'ADDED BY PNR
...
End Sub
Public Sub Fill_LNV_Batch(M_INV_IDY As String)
Dim LNV_BAT_UPD As New ADODB.Recordset
Dim INV_BAT_GET As New ADODB.Recordset
If LNV_BAT_UPD.State = 1 Then LNV_BAT_UPD.Close
LNV_BAT_UPD.Open "SELECT * FROM LNV WHERE INV_IDY = '" & Trim(M_INV_IDY) & "'", con, adOpenKeyset, adLockPessimistic
If LNV_BAT_UPD.RecordCount > 0 Then
    LNV_BAT_UPD.MoveFirst
    While Not LNV_BAT_UPD.EOF
        If Len(Trim(LNV_BAT_UPD!LEV_DES)) = 0 Then
              If INV_BAT_GET.State = 1 Then INV_BAT_GET.Close
              INV_BAT_GET.Open "SELECT * FROM INV WHERE INV_IDY = '" & Trim(M_INV_IDY) & "' AND TXN_TYP = 'SAL'", con, adOpenKeyset, adLockPessimistic
              If INV_BAT_GET.RecordCount > 0 Then INV_BAT_GET.MoveFirst
              LNV_BAT_UPD!LEV_DES = Trim(INV_BAT_GET!BAT_IDY)
              LNV_BAT_UPD.Update
        End If
        LNV_BAT_UPD.MoveNext
    Wend
End If
Set LNV_BAT_UPD = Nothing
Set INV_BAT_GET = Nothing
End Sub
Private Sub Scheme_Price_Update(M_INV_IDY As String)
On Error Resume Next
Dim LNV_RS As New ADODB.Recordset
Dim BRD_RS As New ADODB.Recordset
If LNV_RS.State = 1 Then LNV_RS.Close
LNV_RS.Open "SELECT * FROM LNV WHERE TXN_TYP = 'FRE' .AND. TRIM(LEV_DES) <> SPACE(10) .AND. INV_GRS <> 0 .AND. LNV.INV_IDY = '" & Trim(M_INV_IDY) & "'", con, adOpenKeyset, adLockOptimistic
If LNV_RS.RecordCount > 0 Then LNV_RS.MoveFirst
 While Not LNV_RS.EOF
    If BRD_RS.State = 1 Then BRD_RS.Close
    BRD_RS.Open "SELECT * FROM BRD WHERE BAT_IDY = '" & Trim(LNV_RS!LEV_DES) & "'", con, adOpenKeyset, adLockPessimistic
    If BRD_RS.RecordCount > 0 Then
            PFA = Val(LNV_RS("INV_GRS")) * Val(BRD_RS("U_PUR_LPP"))
            SFA = Val(LNV_RS("INV_GRS")) * Val(BRD_RS("U_SAL_LPP"))
            LNV_RS("P_FRE_AMT") = Val(PFA)
            LNV_RS("S_FRE_AMT") = Val(SFA)
            LNV_RS.Update
    End If
    LNV_RS.MoveNext
Wend
...
Set BRD_RS = Nothing
End Sub
Private Sub LNV_Rpt_Update(M_INV_IDY As String)
On Error Resume Next
Dim LNV_RS As New ADODB.Recordset
Dim BRD_RS As New ADODB.Recordset
...
If LNV_RS.State = 1 Then LNV_RS.Close
LNV_RS.Open "SELECT * FROM LNV WHERE INV_IDY = '" & Trim(M_INV_IDY) & "'", con, adOpenKeyset, adLockPessimistic
If LNV_RS.RecordCount > 0 Then LNV_RS.MoveFirst
While Not LNV_RS.EOF
    If SCH_RS.State = 1 Then SCH_RS.Close
    SCH_RS.Open "SELECT * FROM SCH WHERE SCH_IDY = '" & Trim(LNV_RS!LEV_IDY) & "'", con, adOpenKeyset, adLockPessimistic
    If SCH_RS.RecordCount > 0 Then
        LNV_RS!MER_NUM = Trim(SCH_RS!MER_NUM)
        LNV_RS.Update
    End If
    If BRD_RS.State = 1 Then BRD_RS.Close
    BRD_RS.Open "SELECT * FROM BRD WHERE BAT_IDY = '" & Trim(LNV_RS!LEV_DES) & "'", con, adOpenKeyset, adLockPessimistic
    If BRD_RS.RecordCount > 0 Then
        ...
        PRD_RS.Open "SELECT * FROM PRD WHERE PRD_IDY = '" & Trim(BRD_RS!PRD_IDY) & "'", con, adOpenKeyset, adLockPessimistic
        If PRD_RS.RecordCount > 0 Then
            LNV_RS!SUB_UNT = Val(PRD_RS!SUB_UNT)
            LNV_RS!PRD_PCK = Trim(PRD_RS!PRD_PCK)
            LNV_RS.Update
        End If
        If Pgr_RS.State = 1 Then Pgr_RS.Close
        Pgr_RS.Open "SELECT * FROM PGR WHERE GRP_IDY = '" & Trim(PRD_RS!GRP_IDY) & "'", con, adOpenKeyset, adLockPessimistic
        If Pgr_RS.RecordCount > 0 Then
            LNV_RS!GRP_CAT = Trim(Pgr_RS!GRP_CAT)
            LNV_RS.Update
        End If
    End If
    LNV_RS.MoveNext
