...
Begin VB.Form M_FRM_SRT 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Credit Note - Sales Return Entry"
   ClientHeight    =   5625
   ClientLeft      =   1455
   ClientTop       =   330
   ClientWidth     =   8820
   ForeColor       =   &H00FFFFFF&
   Icon            =   "M_FRM_SRT.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "M_FRM_SRT.frx":0442
      ...
      TabPicture(1)   =   "M_FRM_SRT.frx":045E
      ...
      TabPicture(2)   =   "M_FRM_SRT.frx":047A
      ...
      TabPicture(3)   =   "M_FRM_SRT.frx":0496
      ...
      TabCaption(4)   =   "View"
      TabPicture(4)   =   "M_FRM_SRT.frx":04B2
      ...
      Begin VB.ListBox List6 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRM_SRT.frx":04CE
         Left            =   -72960
         List            =   "M_FRM_SRT.frx":04D0
         TabIndex        =   27
         TabStop         =   0   'False
         Top             =   720
         Visible         =   0   'False
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SRT.frx":04D2
            Key             =   "p"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SRT.frx":0A16
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SRT.frx":0DDE
            Key             =   "c"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SRT.frx":1132
            Key             =   "e"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SRT.frx":176A
            Key             =   "s"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SRT.frx":1ABE
            Key             =   "h"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SRT.frx":1F1E
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SRT.frx":2212
            Key             =   "pr"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SRT.frx":261E
            Key             =   "d"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SRT.frx":272A
            Key             =   "pre"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SRT.frx":2A7E
            Key             =   "brw"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SRT.frx":2E92
            Key             =   "cpy"
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_SRT.frx":33DE
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Else
    ...
    End If
End If
If CHECKTB("act.dbf,smn.dbf,inl.dbf,inv.dbf,cat.dbf,loc.dbf,mar.dbf,pnl.dbf,pnv.dbf,dir.dbf,prd.dbf,brd.dbf,rri.dbf") = 1 Then
    MsgBox UCase(TNAME) & " Missing in " & Me.Caption
    CANCELRECORD
    Exit Sub
End If

If check("ACT", "(ACT_TYP LIKE 'SAL' OR ACT_TYP LIKE 'BOT') AND ACT_idy", Trim(M_SUP_IDY)) = False Then
...
If check("act", "(grp_clf like 'Sales Return ' and ACT_TYP LIKE '') AND act_idy", Trim(M_ACT_IDY)) = False Then
    MsgBox "Sale Return Account Not Found, Define Sale Return  Account...!", vbExclamation, "DAS Version 4.0"
    M_ACT_IDY.SetFocus
    SSTab1.Tab = 0
    Exit Sub
End If
...
If MOD_REC = True Then
    If Check3.Value = 1 Then
        ...
        Next
    End If
    TxnMoveBackup "INV", "BNV", Trim(M_INV_IDY), "SRN"
    TxnMoveBackup "INL", "BNL", Trim(M_INV_IDY), "SRN"
    
    con.Execute "delete from inv where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ like 'SRN'"
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from inl where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ like 'SRN'", con, adOpenKeyset, adLockPessimistic
    INC = Trim(M_INV_IDY)
Else
...
If MOD_REC = True Then
    TxnMoveBackup "PNV", "XNV", Trim(INC), "SRN"
    TxnMoveBackup "PNL", "XNL", Trim(INC), "SRN"
...
Next
'pnv update close
AddShells Trim(INC), "SRN", M_SUP_IDY, "Y", "", ""
If MOD_REC = False Then MsgBox "New Sale Return Voucher ID is " & INC, vbExclamation, "DAS Version 4.0"
If check("PRT", "PRT_NME", "SRN_SHL") Then LOADSHELLS "SRN", Trim(INC)
Label23 = labdisp("IDY_SRN")
If check("PRT", "PRT_NME", "M_FRM_SRT") = True Then
    con.Execute "update dir where dir_idy like 'INV' AND DIR_IDX LIKE 'NUM' set dir_als = '" & INC & "'"
    con.Execute "update dir where dir_idy like 'DOC' AND DIR_IDX LIKE 'TYP' set dir_als = 'SRN'"
        If querycheck("DIR", "DIR_MSG", "D", "AND DIR_IDY LIKE 'SYS' AND DIR_IDX LIKE 'DOS'") = True Then
    If REC_PNL.State = 1 Then REC_PNL.Close
        REC_PNL.Open "SELECT * FROM RRI WHERE RI_REPORT LIKE 'Sale Return Note'", PNL, adOpenKeyset, adLockPessimistic
        ...
        Else
        OpenDocument CURDIR & "\DOS_VCH.RP1", "Sale Return Note", 2, Trim(INC), Trim(INC), 6, CURDIR & "\pnv.cdx,c,inv_idy"
    End If
    CANCELRECORD
End If
CANCELRECORD
...
If Check1.Value = 1 Then
    REC_SET.Open "select * from act where (ACT_TYP LIKE 'BOT' OR ACT_TYP LIKE 'SAL') and act_nme like '" & Trim(M_SUP_IDY) & "%' AND DBT_TYP='Y'", con, adOpenKeyset, adLockPessimistic
ElseIf Check2.Value = 1 Then
    REC_SET.Open "select * from act where (ACT_TYP LIKE 'BOT' OR ACT_TYP LIKE 'SAL') and act_ad4 like '" & Trim(M_SUP_IDY) & "%' AND DBT_TYP='Y'", con, adOpenKeyset, adLockPessimistic
End If
...
If REC_SET.State = 1 Then REC_SET.Close
If Check1.Value = 1 Then
    REC_SET.Open "select * from act where grp_clf like 'Sales Return ' and ACT_NME LIKE '" & Trim(M_ACT_IDY) & "%' and ACT_TYP LIKE '' ", con, adOpenKeyset, adLockPessimistic
Else
    REC_SET.Open "select * from act where grp_clf like 'Sales Return ' and ACT_AD4 LIKE '" & Trim(M_ACT_IDY) & "%' and ACT_TYP LIKE '' ", con, adOpenKeyset, adLockPessimistic
End If
...
M_MDI.STS_BAR.Panels(1).Text = "Enter Sale Return  Account ID or Press <Enter> to View Existing Accounts"
End Sub
...
If K = 13 Or K = 40 Or K = 38 Then
    ...
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from act where act_idy like '" & Sincrement(Trim(M_SUP_IDY)) & "' AND (ACT_TYP LIKE 'BOT' OR ACT_TYP LIKE 'SAL') AND DBT_TYP='Y'", con, adOpenKeyset, adLockPessimistic
    If REC_SET.RecordCount > 0 Then
...
If REC_SET.State = 1 Then REC_SET.Close
If Check1.Value = 1 Then
REC_SET.Open "select inl.inv_idy,inl.inv_dat,act.act_nme,act.act_ad4 from act,inl where act_nme like '" & Trim(M_INV_IDY) & "%' and inl.cst_idy=act.act_idy and inl.txn_typ ='SRN'", con, adOpenKeyset, adLockPessimistic
Else
REC_SET.Open "select inl.inv_idy,inl.inv_dat,act.act_nme,act.act_ad4 from act,inl where act_ad4 like '" & Trim(M_INV_IDY) & "%' and inl.cst_idy=act.act_idy and inl.txn_typ ='SRN'", con, adOpenKeyset, adLockPessimistic
End If
...
If list1.Visible = False And list2.Visible = False And list3.Visible = False And List4.Visible = False And list5.Visible = False Then
    ...
    If KeyCode = 69 And Shift = 2 Then
        ...
        If M_FRM_SRT.ActiveControl.name = "M_INV_IDY" Then
            V_INV_LST
        ElseIf M_FRM_SRT.ActiveControl.name = "M_SUP_IDY" Then
            V_SUP_LST
        ElseIf M_FRM_SRT.ActiveControl.name = "M_SMN_IDY" Then
            V_SMN_LST
        ElseIf M_FRM_SRT.ActiveControl.name = "M_ACT_IDY" Then
            V_ACT_LST
        ElseIf M_FRM_SRT.ActiveControl.name = "Text3" Then
            V_PRD_LST
        End If
    End If
End If
If KeyCode > 111 And KeyCode < 120 Then If TypeOf M_FRM_SRT.ActiveControl Is TextBox Then M_FRM_SRT.ActiveControl.Text = FUNKEY(KeyCode)
End Sub
...
SCl MS, 4
MS.TextMatrix(0, 5) = "           SD %"
SCl MS, 5
MS.TextMatrix(0, 6) = "   Sale Tax %"
SCl MS, 6
...
M_MDI.STS_BAR.Panels(1).Text = "Press Ctrl+N to Generate New Sale Return Voucher ID by System, Press <Enter> to View Existing Vouchers"
End Sub
...
ElseIf MS.Col = 2 Then
    M_MDI.STS_BAR.Panels(1).Text = "Sale Return Voucher Rate"
...
ElseIf MS.Col = 5 Then
    M_MDI.STS_BAR.Panels(1).Text = "Sales Cash Discount %"
...
ElseIf Button.KEY = "ed" Then
    ...
    ElseIf M_FRM_SRT.ActiveControl.name = "M_ACT_IDY" Then
        label49 = "Select Account"
        V_ACT_LST
    ElseIf M_FRM_SRT.ActiveControl.name = "Text3" Or (MS.Col = 0 And SSTab1.Tab = 1) Then
        V_PRD_LST
    End If
...
If check("prt", "prt_nme", "M_FRM_SRT") = False Then
Check3.Value = 0
Else
Check3.Value = 1
End If
...
If REC_SET.RecordCount > 0 Then
    ...
    End If
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from inv where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ = 'SRN'", con, adOpenKeyset, adLockPessimistic
...
ElseIf K = 13 Then
    ...
    End If
        ...
        If Trim(M_INV_IDY) <> "" Then
            REC_SET2.Open "select PRD_QTY from inv where BAT_idy like '" & Trim(MS.TextMatrix(MS.Row, 13)) & "' and inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ like 'SRN'", con, adOpenKeyset, adLockPessimistic
            If REC_SET2.RecordCount > 0 Then
...
If REC_SET.RecordCount > 0 Then
    ...
    RATAPP = GetValue("dbt_rap", "act where act_idy like '" & Trim(M_SUP_IDY) & "'")
    If RATAPP = "B" Then
        MS.TextMatrix(MS.Row, 2) = convert(REC_SET("PRD_SDR"))
    ElseIf RATAPP = "C" Then
        MS.TextMatrix(MS.Row, 2) = convert(REC_SET("PRD_MRP"))
    ElseIf RATAPP = "A" Then
        MS.TextMatrix(MS.Row, 2) = convert(REC_SET("BAS_RAT"))
    Else
        MS.TextMatrix(MS.Row, 2) = convert(REC_SET("PRD_SDR"))
    End If
    MS.TextMatrix(MS.Row, 3) = "0.000"
    MS.TextMatrix(MS.Row, 4) = "0.00"
    MS.TextMatrix(MS.Row, 5) = discount(Val(REC_SET("sal_dis") & ""))
    MS.TextMatrix(MS.Row, 6) = discount(Val(REC_SET("sal_tax") & ""))
...
Dim REC_SET As New ADODB.Recordset
If REC_SET.State = 1 Then REC_SET.Close
REC_SET.Open "SELECT * FROM brd,prd WHERE BRD.PRD_IDY LIKE PRD.PRD_IDY AND PRD.PRD_IDY LIKE '" & Trim(Text3) & "%' and prd.stk_typ in('Salable','Free','Promotional Item') ORDER BY BRW_SEQ", con, adOpenKeyset
...
Dim REC_SET As New ADODB.Recordset
If REC_SET.State = 1 Then REC_SET.Close
REC_SET.Open "select rou_off from inl where inv_idy like '" & Trim(M_INV_IDY) & "' AND TXN_TYP LIKE 'SRN'", con, adOpenKeyset, adLockPessimistic
