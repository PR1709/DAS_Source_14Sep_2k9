...
Begin VB.Form M_FRM_PMT 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Payments (Bank and Cash)"
   ClientHeight    =   5625
   ClientLeft      =   180
   ClientTop       =   720
   ClientWidth     =   8820
   Icon            =   "M_FRM_PMT.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabCaption(0)   =   "&Payment Voucher"
      TabPicture(0)   =   "M_FRM_PMT.frx":0442
      ...
      TabPicture(1)   =   "M_FRM_PMT.frx":045E
      ...
      TabCaption(2)   =   "View"
      TabPicture(2)   =   "M_FRM_PMT.frx":047A
      ...
      Begin VB.ListBox List4 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRM_PMT.frx":0496
         Left            =   -73200
         List            =   "M_FRM_PMT.frx":04A3
         TabIndex        =   21
         Top             =   1920
         Visible         =   0   'False
         Width           =   615
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_PMT.frx":04B0
            Key             =   "p"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_PMT.frx":09F4
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_PMT.frx":0DBC
            Key             =   "c"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_PMT.frx":1110
            Key             =   "e"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_PMT.frx":1748
            Key             =   "s"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_PMT.frx":1A9C
            Key             =   "h"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_PMT.frx":1EFC
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_PMT.frx":21F0
            Key             =   "pr"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_PMT.frx":25FC
            Key             =   "d"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_PMT.frx":2708
            Key             =   "pre"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_PMT.frx":2A5C
            Key             =   "brw"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_PMT.frx":2E70
            Key             =   "cpy"
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "M_FRM_PMT"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim MOD1 As Boolean, idnew As Boolean, ls As ListItem
...
End If
If MOD1 = True Then
    con.Execute "delete from vch where txn_idy like '" & Trim(Text1) & "' and txn_typ='PMT'"
    INC = Trim(Text1)
Else
...
If Trim(MS.TextMatrix(1, 0)) <> "" And Val(MS.TextMatrix(1, 2)) >= "0" Then
...
'    rs.Update
End If
If MOD1 = False Then MsgBox "New Payment Number is " & INC, vbExclamation, "DAS Version 4.0"
CANCELRECORD
Else
MsgBox "Account Not Found, Define Account !", vbExclamation, "DAS Version 4.0"
SSTab1.Tab = 1
...
End If
'End If
If check("PRT", "PRT_NME", "M_FRM_PMT") = True Then
    con.Execute "update dir where dir_idy like 'INV' set dir_als = '" & INC & "'"
    con.Execute "update dir where dir_idy like 'REM' set dir_als = 'PMT'"
    OpenReport CURDIR & "\vouch.RP1", "New Pmt Voucher", 2, "vch->txn_idy='" & Trim(INC) & "'.and.vch->txn_typ='PMT'", 6
End If
...
If rs.State = 1 Then rs.Close
rs.Open "select distinct(txn_idy),act_nme,act_ad4,txn_dat from vch,ACT where txn_typ = 'PMT' AND vch.crt_idy = act.act_idy ", con, adOpenStatic
If rs.RecordCount > 0 Then
    ...
    rs.MoveNext
    Next
    Label49 = "Select Payment Voucher"
    SSTab1.Tab = 2
    list3.Visible = True
    Frame1.Visible = False
    list3.SetFocus
Else
    MsgBox "Payment Voucher Not Found!", vbExclamation, "DAS Version 4.0"
    Text1.Enabled = True
    SendKeys "{HOME}+{END}"
...
If KeyAscii = 27 Then
    If M_FRM_PMT.ActiveControl.name = "Text1" And Trim(Text1.Text) = "" Then
    Unload Me
    Set Form = Nothing
    Exit Sub
    End If
...
MS.ColWidth(3) = 600
MS.ColWidth(4) = 1200
MS.ColWidth(5) = 6000 'CHANGED BY PNR AS PER PRINCE CHOPRA REQUEST
...
If rs.State = 1 Then rs.Close
    If Len(Trim(Text1)) <> 0 Then
        ...
        rs.Open "select * from vch where txn_idy like '" & Trim(Text1) & "' and txn_typ='PMT'", con, adOpenStatic
        Else
        rs.Open "select * from vch where txn_idy like 'PMT" & Tincrement(Text1) & "' and txn_typ='PMT'", con, adOpenStatic
        End If
        If rs.RecordCount > 0 Then
            ...
            End If
            If Len(Trim(Text1)) <> 10 Then Text1 = "PMT" & Tincrement(Text1)
            Label7 = "0"
            Label9 = "0"
            MOD1 = True
            ...
            For A = 1 To rs.RecordCount
                 MS.TextMatrix(A, 0) = rs("dbt_idy") & ""
                 If RS1.State = 1 Then RS1.Close
                 RS1.Open "select * from act where act_idy like '" & Trim(rs("dbt_idy")) & "'", con, adOpenStatic
...
If list1.Visible = False And List2.Visible = False And list3.Visible = False Then
    ...
    If KeyCode = 69 And Shift = 2 Then
        If M_FRM_PMT.ActiveControl.name = "Text1" Then
            voucherlist
        ElseIf M_FRM_PMT.ActiveControl.name = "Text2" Then
            account
        ElseIf M_FRM_PMT.ActiveControl.name = "Text3" Then
            ACCOUNTLIST
        End If
    End If
End If
If KeyCode > 111 And KeyCode < 120 Then If TypeOf M_FRM_PMT.ActiveControl Is TextBox Then M_FRM_PMT.ActiveControl.Text = FUNKEY(KeyCode)
End Sub
...
Prefix.Caption = "Prefix Payments"
Prefix.Show 1
...
ElseIf Button.KEY = "ed" Then
    If M_FRM_PMT.ActiveControl.name = "Text1" Then
        ...
        voucherlist
    ElseIf M_FRM_PMT.ActiveControl.name = "MS" And MS.Col = 0 Then
         Check1.Value = 0
        Check2.Value = 0
        Label49 = "Select Account"
        ACCOUNTLIST
...
If CHECKTB("prt.dbf") = 1 Then
    ...
    Exit Sub
End If
If check("PRT", "PRT_NME", "M_FRM_PMT") = True Then M_FRM_PRV.Check3.Value = 1
M_FRM_PRV.Show 1
End Sub
