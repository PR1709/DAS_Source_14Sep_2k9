...
Begin VB.Form M_FRM_RSR 
   BackColor       =   &H8000000A&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Van Return Stock Voucher"
   ClientHeight    =   5625
   ClientLeft      =   1425
   ClientTop       =   1845
   ClientWidth     =   8820
   ForeColor       =   &H00404040&
   Icon            =   "M_FRM_RSR.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabCaption(2)   =   "a"
      TabPicture(2)   =   "M_FRM_RSR.frx":047A
      Tab(2).ControlEnabled=   0   'False
      Tab(2).ControlCount=   0
      TabCaption(3)   =   "View"
      TabPicture(3)   =   "M_FRM_RSR.frx":0496
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_RSR.frx":04B2
            Key             =   "p"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_RSR.frx":09F6
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_RSR.frx":0DBE
            Key             =   "c"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_RSR.frx":1112
            Key             =   "e"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_RSR.frx":174A
            Key             =   "s"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_RSR.frx":1A9E
            Key             =   "h"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_RSR.frx":1EFE
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_RSR.frx":21F2
            Key             =   "pr"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_RSR.frx":25FE
            Key             =   "d"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_RSR.frx":270A
            Key             =   "pre"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_RSR.frx":2A5E
            Key             =   "brw"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_RSR.frx":2E72
            Key             =   "cpy"
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_RSR.frx":33BE
            Key             =   ""
         EndProperty
      EndProperty
   End
...
If MOD_REC = True Then
    ...
    REC_SET.Open "select * from inv where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ like 'RSR'", con, adOpenKeyset, adLockOptimistic
    For A = 1 To REC_SET.RecordCount
        ...
        REC_SET.MoveNext
    Next
    con.Execute "delete from inv where inv_idy like '" & Sincrement(M_INV_IDY) & "' and txn_typ like 'RSR'"
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from inl where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ like 'RSR'", con, adOpenKeyset, adLockOptimistic
    INC = Trim(M_INV_IDY)
Else
    REC_SET.Open "select * from inl", con, adOpenKeyset, adLockOptimistic
    REC_SET.AddNew
    REC_SET("inv_idy") = "RSR" & T7increment("idy_RSR")
    INC = REC_SET("inv_idy")
    INVIDY = INC
End If
...
REC_SET1.Open "select smn_idy,act_idy,cst_idy,NET_AMT from inl where inv_idy like '" & Trim(M_VAN_IDY) & "' AND TXN_TYP LIKE 'RSI'", con, adOpenKeyset, adLockOptimistic
...
Label23 = labdisp("idy_RSR")
If check("PRT", "PRT_NME", "M_FRM_RSR") = True Then
    con.Execute "update dir where dir_idy like 'INV' set dir_als = '" & INC & "'"
    con.Execute "update dir where dir_idy like 'REM' set dir_als = 'RSR'"
    VAN_RET_DAT
    Openreport CURDIR & "\vouch.rp1", "Van Challan Return", 2, "VAN->inv_idy = '" & Trim(INC) & "'", 0
    Cancelrecord
End If
Cancelrecord
End Sub
...
If REC_SET.State = 1 Then REC_SET.Close
If Check1.Value = 1 Then
    REC_SET.Open "select inl.inv_idy,inl.inv_dat,smn.smn_nme,inl.ord_idy,smn.smn_nme from inl,smn where inl.txn_typ like 'RSR' AND INL.SMN_IDY LIKE SMN.SMN_IDY", con, adOpenKeyset, adLockOptimistic
Else
    REC_SET.Open "select inl.inv_idy,inl.inv_dat,SMN_NME,ord_idy,SMN_AD4 from SMN,inl where SMN_ad4 like '" & Trim(M_INV_IDY) & "%' and inl.smn_idy=smn.smn_idy and inl.txn_typ ='RSR'", con, adOpenKeyset, adLockOptimistic
End If
list5.ListItems.Clear
If REC_SET.RecordCount > 0 Then
    For A = 1 To REC_SET.RecordCount
...
If list1.Visible = False And list4.Visible = False And list5.Visible = False Then
    ...
    If KeyCode = 69 And Shift = 2 Then
        ...
        If M_FRM_RSR.ActiveControl.name = "M_INV_IDY" Then
            INVOICELIST
        ElseIf M_FRM_RSR.ActiveControl.name = "m_van_idy" Then
            V_VAN_LST
        End If
    End If
End If
If KeyCode > 111 And KeyCode < 120 Then If TypeOf M_FRM_RSR.ActiveControl Is TextBox Then M_FRM_RSR.ActiveControl.Text = FUNKEY(KeyCode)
End Sub
...
MS.TextMatrix(0, 7) = "  CD%"
MS.TextMatrix(0, 8) = "     Tax"
...
If check("prt", "prt_nme", "M_FRM_RSR") = False Then
Check3.Value = 0
Else
Check3.Value = 1
End If
...
REC_SET.Open "select * from inl where inv_idy like 'RSR" & Tincrement(Trim(M_INV_IDY)) & "' and txn_typ like 'RSR'", con, adOpenKeyset
    M_INV_IDY = "RSR" & Tincrement(Trim(M_INV_IDY))
Else
REC_SET.Open "select * from inl where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ like 'RSR'", con, adOpenKeyset
...
If REC_SET.RecordCount > 0 Then
    ...
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from inv where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ = 'RSR'", con, adOpenKeyset, adLockOptimistic
    MS.Rows = REC_SET.RecordCount + 1
    For A = 1 To MS.Rows - 1
        MS.TextMatrix(A, 0) = Trim(REC_SET("prd_idy"))
        MS.TextMatrix(A, 3) = QTY(REC_SET("prd_qty"))
...
If k = 13 Or k = 40 Then
    Dim REC_SET As New ADODB.Recordset
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select inv_idy from inl where inv_idy like '" & Trim(M_VAN_IDY) & "' and txn_typ like 'RSI'", con, adOpenKeyset, adLockOptimistic
    If REC_SET.RecordCount > 0 Then
...
If MOD_REC = True Then
    Dim REC_SET1 As New ADODB.Recordset
    If REC_SET1.State = 1 Then REC_SET1.Close
    REC_SET1.Open "select gRS_amt from inl where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ like 'RSR'", con, adOpenKeyset, adLockOptimistic
End If
For A = 1 To MS.Rows - 1
    ...
    If REC_SET.RecordCount > 0 Then
        If Val(REC_SET(0)) > 0 Then
            MS.TextMatrix(A, 9) = RATCAL(Val(MS.TextMatrix(A, 3) & ""), Val(MS.TextMatrix(A, 4) & ""), REC_SET(0))
        Else
            MS.TextMatrix(A, 9) = convert(amt(Round(Val(MS.TextMatrix(A, 3) & "") * Val(MS.TextMatrix(A, 4) & ""), 2)))
        End If
    End If
    MS.TextMatrix(A, 5) = QTY(WGTCAL(MS.TextMatrix(A, 3), MS.TextMatrix(A, 2), REC_SET(0)))
    Total = convert(amt(Val(Total) + MS.TextMatrix(A, 9)))
...
Dim REC_SET1 As New ADODB.Recordset
With REC_SET
    .Open "SELECT * FROM INL WHERE INV_IDY LIKE '" & Trim(M_VAN_IDY) & "' AND TXN_TYP LIKE 'RSI'", con, adOpenKeyset, adLockOptimistic
    If .RecordCount > 0 Then
        M_GRS_AMT = convert(amt(.Fields("NET_AMT") & ""))
        If .State = 1 Then .Close
        .Open "SELECT * FROM INV WHERE INV_IDY LIKE '" & Trim(M_VAN_IDY) & "' AND TXN_TYP LIKE 'RSI'", con, adOpenKeyset, adLockOptimistic
        If .RecordCount > 0 Then
        ...
        For A = 1 To .RecordCount
            ...
            If REC_SET1.RecordCount > 0 Then
                ...
                MS.TextMatrix(A, 2) = FAC(Val(REC_SET1("CON_FAC") & ""))
                QTY_UNT = P_SUB_UNT(QTY(REC_SET("PRD_QTY")), Val(REC_SET1("SUB_UNT"))) - P_SUB_UNT(QTY(REC_SET("RET_QTY") & ""), Val(REC_SET1("SUB_UNT")))
                MS.TextMatrix(A, 3) = P_QTY_UNT(Str(QTY_UNT), Val(REC_SET1("SUB_UNT") & ""))
                If bslab = "A" Then
                MS.TextMatrix(A, 4) = convert(amt(REC_SET1("SAL_rat") & ""))
                ElseIf bslab = "B" Then
                MS.TextMatrix(A, 4) = convert(amt(REC_SET1("PUR_rat") & ""))
                ElseIf bslab = "C" Then
                MS.TextMatrix(A, 4) = convert(amt(REC_SET1("mrp_rat") & ""))
                Else
                MS.TextMatrix(A, 4) = convert(amt(REC_SET1("SAL_rat") & ""))
                End If
                MS.TextMatrix(A, 10) = Trim(REC_SET1("prd_prn"))
                MS.TextMatrix(A, 11) = Trim(REC_SET1("prd_nme"))
                SSTab1.Tab = 1
                MS.Row = MS.Rows - 1
            End If
            .MoveNext
...
If VAN_DAT.State = 1 Then VAN_DAT.Close
VAN_DAT.Open "SELECT * FROM VAN", con, adOpenKeyset, adLockOptimistic
        If INV_DAT.State = 1 Then INV_DAT.Close
        INV_DAT.Open "SELECT * FROM INV WHERE INV_IDY LIKE '" & Trim(M_VAN_IDY) & "'", con, adOpenKeyset, adLockOptimistic
        If RSR_DAT.State = 1 Then RSR_DAT.Close
        RSR_DAT.Open "SELECT * FROM INL WHERE INV_IDY LIKE '" & Trim(INC) & "' AND TXN_TYP LIKE 'RSR'", con, adOpenDynamic, adLockOptimistic
        For A = 1 To INV_DAT.RecordCount
        If RSR_DAT.EOF = False Then
            VAN_DAT.AddNew
            VAN_DAT("INV_IDY") = Trim(INC)
