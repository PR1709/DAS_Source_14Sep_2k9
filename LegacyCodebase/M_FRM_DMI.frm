...
Begin VB.Form M_FRM_DMI 
   BackColor       =   &H8000000A&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Non Salable Stock Issues"
   ClientHeight    =   5625
   ClientLeft      =   1425
   ClientTop       =   1845
   ClientWidth     =   8820
   ForeColor       =   &H00FFFFFF&
   Icon            =   "M_FRM_DMI.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "M_FRM_DMI.frx":0442
      ...
      TabPicture(1)   =   "M_FRM_DMI.frx":045E
      ...
      TabPicture(2)   =   "M_FRM_DMI.frx":047A
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "M_PKG_CST"
      Tab(2).Control(0).Enabled=   0   'False
      Tab(2).Control(1)=   "M_FRT_AMT"
      Tab(2).Control(1).Enabled=   0   'False
      Tab(2).Control(2)=   "M_FRT_TYP"
      ...
      Tab(2).Control(16)=   "M_BEF_ROF"
      Tab(2).Control(17)=   "Label61"
      Tab(2).Control(18)=   "Label50"
      Tab(2).Control(19)=   "Label48"
      Tab(2).Control(20)=   "Label47"
      Tab(2).Control(21)=   "Label46"
      Tab(2).Control(22)=   "Label35"
      Tab(2).Control(23)=   "Label31"
      Tab(2).Control(24)=   "Label38"
      Tab(2).Control(25)=   "Label37"
      Tab(2).Control(26)=   "Label36"
      Tab(2).Control(27)=   "Label34"
      Tab(2).Control(28)=   "Label33"
      Tab(2).Control(29)=   "Label32"
      Tab(2).Control(30)=   "Label30"
      Tab(2).Control(31)=   "Label29"
      Tab(2).Control(32)=   "Label28"
      Tab(2).Control(33)=   "Label27"
      Tab(2).Control(34)=   "Label42"
      Tab(2).Control(35)=   "M_NET_AMT"
      Tab(2).Control(36)=   "Label44"
      Tab(2).Control(37)=   "Label24"
      Tab(2).Control(38)=   "M_GRS_AMT"
      Tab(2).Control(39)=   "Label22"
      Tab(2).Control(40)=   "Label26"
      Tab(2).Control(41)=   "Label25"
      Tab(2).ControlCount=   42
      TabCaption(3)   =   "&Shipment Details"
      TabPicture(3)   =   "M_FRM_DMI.frx":0496
      ...
      TabCaption(4)   =   "View"
      TabPicture(4)   =   "M_FRM_DMI.frx":04B2
      ...
      Begin VB.ListBox M_FRT_TYP 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRM_DMI.frx":04CE
         Left            =   -71760
         List            =   "M_FRM_DMI.frx":04D8
         TabIndex        =   81
         Top             =   3000
         Width           =   495
      End
      ...
      Begin VB.ListBox List6 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRM_DMI.frx":04E2
         Left            =   -72960
         List            =   "M_FRM_DMI.frx":04EF
         TabIndex        =   67
         TabStop         =   0   'False
         Top             =   720
         Visible         =   0   'False
      ...
      Begin VB.ListBox M_ROU_IDY 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRM_DMI.frx":04FC
         Left            =   -70080
         List            =   "M_FRM_DMI.frx":056C
         TabIndex        =   63
         TabStop         =   0   'False
         Top             =   2640
         Width           =   495
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_DMI.frx":05DC
               Key             =   "p"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_DMI.frx":0B20
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_DMI.frx":0EE8
               Key             =   "c"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_DMI.frx":123C
               Key             =   "e"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_DMI.frx":1874
               Key             =   "s"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_DMI.frx":1BC8
               Key             =   "h"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_DMI.frx":2028
               Key             =   ""
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_DMI.frx":231C
               Key             =   "pr"
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_DMI.frx":2728
               Key             =   "d"
            EndProperty
            BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_DMI.frx":2834
               Key             =   "pre"
            EndProperty
            BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_DMI.frx":2B88
               Key             =   "brw"
            EndProperty
            BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_DMI.frx":2F9C
               Key             =   "cpy"
            EndProperty
            BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRM_DMI.frx":34E8
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   End
End
Attribute VB_Name = "M_FRM_DMI"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim MOD_REC As Boolean, idnew As Boolean, ls As ListItem, M_DBT_RAP, MSROW, INVIDY, INC, dlr_idy
...
If check("ACT", "ACT_idy", Trim(M_CST_IDY)) = False Then
    MsgBox "Party Not Found ,Define Partys !", vbExclamation, "Effmcg"
    SSTab1.Tab = 0
    M_CST_IDY.SetFocus
    Exit Sub
End If
...
If check("act", "(grp_clf like 'Stock Issues' and ACT_TYP LIKE '') AND act_idy", Trim(M_ACT_IDY)) = False Then
    MsgBox "Stock Issues Account Not Found, Define Stock Issues Acount...!", vbExclamation, "Effmcg"
    M_ACT_IDY.SetFocus
    SSTab1.Tab = 0
    Exit Sub
End If
...
If MOD_REC = True Then
    ...
    REC_SET.Open "select * from inv where inv_idy like '" & Sincrement(M_INV_IDY) & "' and txn_typ like 'DMI'", con, adOpenKeyset
    For A = 1 To REC_SET.RecordCount
        ...
        REC_SET.MoveNext
    Next
    con.Execute "delete from inv where inv_idy like '" & Sincrement(M_INV_IDY) & "' and txn_typ like 'DMI'"
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from inl where inv_idy like '" & Sincrement(M_INV_IDY) & "' and txn_typ like 'DMI'", con, adOpenKeyset, adLockOptimistic
    INC = Sincrement(M_INV_IDY)
Else
    REC_SET.Open "select * from inl", con, adOpenKeyset, adLockOptimistic
    REC_SET.AddNew
    REC_SET("inv_idy") = "DMI" & T7increment("IDY_CHN")
    INC = REC_SET("inv_idy")
    INVIDY = INC
End If
REC_SET("inv_dat") = M_INV_DAT
REC_SET("ord_idy") = Trim(Order & "")
...
For A = 1 To MS.Rows - 1
    ...
    End If
Next
If MOD_REC = False Then MsgBox "New Tranfer Outward ID is " & INC, vbExclamation, "Effmcg"
M_PRV_NUM = labdisp("IDY_CHN")
If check("PRT", "PRT_NME", "M_FRM_DMI") = True Then
    ...
    OpenDocument CURDIR & "\VOUCH.RP1", "DMI Note", 2, Trim(INC), Trim(INC), 2, CURDIR & "\inv.cdx,c,inv_idy"
    Cancelrecord
End If
Cancelrecord
End Sub
...
If Check1.Value = 1 Then
    REC_SET.Open "select * from act where act_nme like '" & Trim(M_CST_IDY) & "%'", con, adOpenKeyset, adLockOptimistic
ElseIf Check2.Value = 1 Then
    REC_SET.Open "select * from act where act_ad4 like '" & Trim(M_CST_IDY) & "%'", con, adOpenKeyset, adLockOptimistic
End If
...
If REC_SET.RecordCount > 0 Then
    ...
    Next
    SSTab1.Tab = 4
    V_LST_CAP = "Select Party"
    list3.Visible = True
    list3.SetFocus
Else
    If SSTab1.Tab = 0 Then
        MsgBox "Party Not Found, Define Party !", vbExclamation, "Effmcg"
        SSTab1.Tab = 0
        M_CST_IDY.SetFocus
    End If
End If
...
If REC_SET.State = 1 Then REC_SET.Close
If Check1.Value = 1 Then
    REC_SET.Open "select * from act where grp_clf like 'Stock Issues' and ACT_NME LIKE '" & Trim(M_ACT_IDY) & "%' and ACT_TYP LIKE '' ", con, adOpenKeyset, adLockOptimistic
Else
    REC_SET.Open "select * from act where grp_clf like 'Stock Issues' and ACT_AD4 LIKE '" & Trim(M_ACT_IDY) & "%' and ACT_TYP LIKE '' ", con, adOpenKeyset, adLockOptimistic
End If
...
If k = 13 Or k = 40 Or k = 38 Then
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from act where act_idy like '" & Sincrement(Trim(M_CST_IDY)) & "'", con, adOpenKeyset, adLockOptimistic
    If REC_SET.RecordCount > 0 Then
...
If REC_SET.State = 1 Then REC_SET.Close
If Check1.Value = 1 Then
REC_SET.Open "select inl.inv_idy,inl.inv_dat,act.act_nme,act.act_ad4 from act,inl where act_nme like '" & Trim(M_INV_IDY) & "%' and inl.cst_idy=act.act_idy and inl.txn_typ ='DMI'", con, adOpenKeyset, adLockOptimistic
Else
REC_SET.Open "select inl.inv_idy,inl.inv_dat,act.act_nme,act.act_ad4 from act,inl where act_ad4 like '" & Trim(M_INV_IDY) & "%' and inl.cst_idy=act.act_idy and inl.txn_typ ='DMI'", con, adOpenKeyset, adLockOptimistic
End If
...
If REC_SET.RecordCount > 0 Then
    ...
    Next
    SSTab1.Tab = 4
    V_LST_CAP = "Select Transfer Out Document"
    list5.Visible = True
    list5.SetFocus
Else
    If SSTab1.Tab = 0 Then
        MsgBox "Transfer Out Number Not Found...!", vbExclamation, "Effmcg"
        SSTab1.Tab = 0
        M_INV_IDY.Enabled = True
        SendKeys "{HOME}+{END}"
        M_INV_IDY.SetFocus
...
If list1.Visible = False And List2.Visible = False And list3.Visible = False And list4.Visible = False And list5.Visible = False Then
    ...
    If KeyCode = 69 And Shift = 2 Then
        ...
        If M_FRM_DMI.ActiveControl.name = "M_INV_IDY" Then
            V_INV_LST
        ElseIf M_FRM_DMI.ActiveControl.name = "M_CST_IDY" Then
            V_DLR_LST
        ElseIf M_FRM_DMI.ActiveControl.name = "M_SMN_IDY" Then
            V_SMN_LST
        ElseIf M_FRM_DMI.ActiveControl.name = "M_ACT_IDY" Then
            V_ACT_LST
        ElseIf M_FRM_DMI.ActiveControl.name = "Text3" Then
            V_PRD_LST
        End If
    End If
End If
If KeyCode > 111 And KeyCode < 120 Then If TypeOf M_FRM_DMI.ActiveControl Is TextBox Then M_FRM_DMI.ActiveControl.Text = FUNKEY(KeyCode)
End Sub
...
ElseIf Button.KEY = "ed" Then
    ...
    ElseIf M_FRM_DMI.ActiveControl.name = "M_ACT_IDY" Then
        V_LST_CAP = "Select Account"
        V_ACT_LST
    ElseIf M_FRM_DMI.ActiveControl.name = "Text3" Or (MS.Col = 0 And SSTab1.Tab = 1) Then
        V_PRD_LST
    End If
...
If check("prt", "prt_nme", "M_FRM_DMI") = False Then
Check3.Value = 0
Else
Check3.Value = 1
End If
...
REC_SET.Open "select * from inl where inv_idy like 'DMI" & Tincrement(Trim(M_INV_IDY)) & "' and txn_typ like 'DMI'", con, adOpenKeyset
Else
REC_SET.Open "select * from inl where inv_idy like '" & Tincrement(Trim(M_INV_IDY)) & "' and txn_typ like 'DMI'", con, adOpenKeyset
End If
If REC_SET.RecordCount > 0 Then
    If Len(Trim(M_INV_IDY)) <> 10 Then
    M_INV_IDY = "DMI" & Tincrement(Trim(M_INV_IDY))
    End If
    M_INV_IDY.Enabled = False
    MOD_REC = True
    ...
    End If
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from inv where inv_idy like '" & Sincrement(M_INV_IDY) & "' and txn_typ = 'DMI'", con, adOpenKeyset, adLockOptimistic
...
If MS.Row <> 0 Then
    If MS.Col = 0 Then
        If k = 13 Then
            ...
            Else
                If REC_SET.State = 1 Then REC_SET.Close
                REC_SET.Open "SELECT * FROM prd WHERE STK_TYP NOT IN('Free','Salable')", con, adOpenKeyset
                If REC_SET.RecordCount > 0 Then
...
ElseIf k = 13 Then
    If MS.Col = 3 Then
        ...
        If Trim(M_INV_IDY) <> "" Then
            REC_SET2.Open "select prd_qty from inv where prd_idy like '" & Trim(MS.TextMatrix(MS.Row, 0)) & "' and inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ like 'DMI'", con, adOpenKeyset, adLockOptimistic
...
For A = 1 To MS.Rows - 1
    ...
    End If
Next
REC_SET.Open "select * from PRD where prd_idy like '" & Trim(prdid) & "' AND STK_TYP NOT IN('Free','Salable')", con, adOpenKeyset
If REC_SET.RecordCount > 0 Then
    list4.Visible = False
...
If REC_SET.State = 1 Then REC_SET.Close
If Check1.Value = 1 Then
REC_SET.Open "SELECT * FROM prd WHERE PRD_NME LIKE '" & Trim(Text3) & "%' AND STK_TYP NOT IN('Free','Salable')", con, adOpenKeyset
Else
REC_SET.Open "SELECT * FROM prd WHERE PRD_PRN LIKE '" & Trim(Text3) & "%' AND STK_TYP NOT IN('Free','Salable')", con, adOpenKeyset
End If
list4.ListItems.Clear
If REC_SET.RecordCount > 0 Then
    For A = 1 To REC_SET.RecordCount
...
Dim REC_SET As New ADODB.Recordset
If REC_SET.State = 1 Then REC_SET.Close
REC_SET.Open "select rou_off from inl where inv_idy like '" & Trim(M_INV_IDY) & "' AND TXN_TYP LIKE 'DMI'", con, adOpenKeyset, adLockOptimistic
