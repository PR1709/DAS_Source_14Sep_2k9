...
Begin VB.Form M_FRE_VAN 
   BackColor       =   &H8000000A&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Ready Stock Sales (Free)"
   ClientHeight    =   5625
   ClientLeft      =   1425
   ClientTop       =   1845
   ClientWidth     =   8820
   ForeColor       =   &H00FFFFFF&
   Icon            =   "M_FRE_VAN.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin MSComctlLib.Toolbar Toolbar1 
      ...
      Begin VB.ListBox text1 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRE_VAN.frx":0442
         Left            =   6960
         List            =   "M_FRE_VAN.frx":045B
         TabIndex        =   105
         TabStop         =   0   'False
         Top             =   50
         Visible         =   0   'False
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "M_FRE_VAN.frx":049F
      ...
      TabPicture(1)   =   "M_FRE_VAN.frx":04BB
      ...
      TabPicture(2)   =   "M_FRE_VAN.frx":04D7
      ...
      TabPicture(3)   =   "M_FRE_VAN.frx":04F3
      ...
      TabCaption(4)   =   "View"
      TabPicture(4)   =   "M_FRE_VAN.frx":050F
      ...
      Begin VB.ListBox List6 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRE_VAN.frx":052B
         Left            =   2040
         List            =   "M_FRE_VAN.frx":0538
         TabIndex        =   66
         TabStop         =   0   'False
         Top             =   720
         Visible         =   0   'False
      ...
      Begin VB.ListBox M_ROU_IDY 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRE_VAN.frx":0545
         Left            =   -70080
         List            =   "M_FRE_VAN.frx":05B5
         TabIndex        =   62
         TabStop         =   0   'False
         Top             =   2640
         Width           =   495
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_VAN.frx":0625
               Key             =   "p"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_VAN.frx":0B69
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_VAN.frx":0F31
               Key             =   "c"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_VAN.frx":1285
               Key             =   "e"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_VAN.frx":18BD
               Key             =   "s"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_VAN.frx":1C11
               Key             =   "h"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_VAN.frx":2071
               Key             =   ""
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_VAN.frx":2365
               Key             =   "pr"
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_VAN.frx":2771
               Key             =   "d"
            EndProperty
            BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_VAN.frx":287D
               Key             =   "pre"
            EndProperty
            BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_VAN.frx":2BD1
               Key             =   "brw"
            EndProperty
            BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_VAN.frx":2FE5
               Key             =   "cpy"
            EndProperty
            BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_VAN.frx":3531
               Key             =   ""
            EndProperty
         EndProperty
      End
...
If Len(Trim(M_INV_IDY)) = 0 Then
    MsgBox "Invalid Bill Number, Enter Bill Number !", vbExclamation, "Effmcg"
    m_van_idy.SetFocus
    SSTab1.Tab = 0
    Exit Sub
End If
        ...
        If REC_SET2.RecordCount = 0 Then
            ...
            REC_SET1.Open "select * from prd where prd_idy like '" & Trim(MS.TextMatrix(A, 0)) & "'", con, adOpenKeyset, adLockOptimistic
                If REC_SET1.RecordCount > 0 Then
                    ...
                    TOT_QTY = Val(Ret_qty) + Val(Ent_qty)
            ...
            If Val(MS.TextMatrix(A, 13)) <> 0 Then
                ...
                REC_SET("PRD_RAT") = Val(REC_SET1(1))
                REC_SET("COL_AMT") = RATCAL((QTY(MS.TextMatrix(A, 13) & "")), Val(REC_SET1(1) & ""), REC_SET1(0))
...
If check("PRT", "PRT_NME", "M_FRE_VAN") = True Then
...
If Check1.Value = 1 Then
    If Toolbar1.Buttons(33).Value = tbrPressed Then
        REC_SET.Open "select ACT.*,MAR.MAR_NME,act.ROU_IDY,smn.smn_nme from act,MAR,smn where (act.ACT_TYP LIKE 'BOT' OR act.ACT_TYP LIKE 'SAL') and act_nme like '" & Trim(M_CST_IDY) & "%' AND ACT.MAR_IDY LIKE MAR.MAR_IDY AND ACT.SMN_IDY LIKE SMN.SMN_IDY AND MAR_VDA LIKE '" & Trim(text1) & "'", con, adOpenKeyset, adLockOptimistic
    Else
        REC_SET.Open "select ACT.*,MAR.MAR_NME,act.ROU_IDY,smn.smn_nme from act,MAR,smn where (act.ACT_TYP LIKE 'BOT' OR act.ACT_TYP LIKE 'SAL') and act_nme like '" & Trim(M_CST_IDY) & "%' AND ACT.MAR_IDY LIKE MAR.MAR_IDY AND ACT.SMN_IDY LIKE SMN.SMN_IDY", con, adOpenKeyset, adLockOptimistic
    End If
ElseIf Check2.Value = 1 Then
    If Toolbar1.Buttons(33).Value = tbrPressed Then
        REC_SET.Open "select ACT.*,MAR.MAR_NME,act.ROU_IDY,smn.smn_nme from act,MAR,smn where (act.ACT_TYP LIKE 'BOT' OR act.ACT_TYP LIKE 'SAL') and act_ad4 like '" & Trim(M_CST_IDY) & "%' AND ACT.MAR_IDY LIKE MAR.MAR_IDY AND ACT.SMN_IDY LIKE SMN.SMN_IDY AND MAR_VDA LIKE '" & Trim(text1) & "'", con, adOpenKeyset, adLockOptimistic
    Else
...
If REC_SET.State = 1 Then REC_SET.Close
If Check1.Value = 1 Then
REC_SET.Open "select inl.inv_idy,inl.inv_dat,act.act_nme,act.act_ad4 from act,inl where act_nme like '" & Trim(M_INV_IDY) & "%' and inl.cst_idy=act.act_idy and inl.txn_typ ='SAL' and ord_idy not like '0'", con, adOpenKeyset, adLockOptimistic
Else
REC_SET.Open "select inl.inv_idy,inl.inv_dat,act.act_nme,act.act_ad4 from act,inl where act_ad4 like '" & Trim(M_INV_IDY) & "%' and inl.cst_idy=act.act_idy and inl.txn_typ ='SAL' and ord_idy not like '0'", con, adOpenKeyset, adLockOptimistic
End If
...
If list1.Visible = False And list2.Visible = False And list3.Visible = False And list4.Visible = False And list5.Visible = False Then
    ...
    If KeyCode = 69 And Shift = 2 Then
        ...
        If M_FRE_VAN.ActiveControl.name = "M_INV_IDY" Then
            V_INV_LST
        ElseIf M_FRE_VAN.ActiveControl.name = "M_CST_IDY" Then
            V_DLR_LST
        ElseIf M_FRE_VAN.ActiveControl.name = "M_SMN_IDY" Then
            V_SMN_LST
        ElseIf M_FRE_VAN.ActiveControl.name = "M_ACT_IDY" Then
            V_ACT_LST
        ElseIf M_FRE_VAN.ActiveControl.name = "Text3" Then
            V_PRD_LST
        End If
    End If
End If
If KeyCode > 111 And KeyCode < 120 Then If TypeOf M_FRE_VAN.ActiveControl Is TextBox Then M_FRE_VAN.ActiveControl.Text = FUNKEY(KeyCode)
End Sub
...
If K = 13 Or K = 40 Or K = 38 Then
    ...
    REC_SET.Open "select inv_idy from inv where inv_idy like 'RSI" & Tincrement(m_van_idy) & "' and txn_typ like 'RSI'", con, adOpenKeyset, adLockOptimistic
    Else
    REC_SET.Open "select inv_idy from inv where inv_idy like '" & Trim(m_van_idy) & "' and txn_typ like 'RSI'", con, adOpenKeyset, adLockOptimistic
    End If
    If REC_SET.RecordCount > 0 Then
...
ElseIf Button.KEY = "ed" Then
    ...
    ElseIf M_FRE_VAN.ActiveControl.name = "M_ACT_IDY" Then
        V_LST_CAP = "Select Account"
        V_ACT_LST
    ElseIf M_FRE_VAN.ActiveControl.name = "Text3" Or (MS.Col = 0 And SSTab1.Tab = 1) Then
        V_PRD_LST
    End If
...
If check("prt", "prt_nme", "M_FRE_VAN") = False Then
Check3.Value = 0
Else
Check3.Value = 1
End If
...
If REC_SET.State = 1 Then REC_SET.Close
REC_SET.Open "select * from inl where inv_idy like '" & (Trim(M_INV_IDY)) & "' and txn_typ like 'SAL' and ord_idy not like '0'", con, adOpenKeyset
If REC_SET.RecordCount > 0 Then
    ...
    End If
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from inv where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ = 'SAL'", con, adOpenKeyset, adLockOptimistic
    ...
    M_INV_DAT.SetFocus
Else
    If MsgBox("Invoice Number Not found, Creating New Invoice", vbExclamation + vbYesNo) = vbYes Then
        M_INV_IDY.Enabled = False
        M_INV_DAT.SetFocus
    End If
End If
...
If check("INV", "INV_IDY", Trim(m_van_idy)) = True Then
    ...
    If REC_SET.State = 1 Then REC_SET.Close
    If Check1.Value = 1 Then
    REC_SET.Open "SELECT prd_nme,inv.prd_idy,prd_prn,inv.prd_qty, INV.RET_QTY,prd.sub_unt,prd.pur_rat,prd.sal_rat,prd.mrp_rat,PRD.STK_TYP FROM INV,PRD WHERE PRD.PRD_NME LIKE '" & Trim(Text3) & "%' AND INV.TXN_TYP LIKE 'RSI' AND INV.PRD_IDY LIKE PRD.PRD_IDY AND INV_IDY LIKE '" & Trim(m_van_idy) & "' AND STK_TYP IN('Free','Salable')", con, adOpenKeyset
    Else
    REC_SET.Open "SELECT prd_nme,inv.prd_idy,prd_prn,inv.prd_qty,INV.RET_QTY,prd.sub_unt,prd.pur_rat,prd.sal_rat,prd.mrp_rat,PRD.STK)TYP FROM INV,PRD WHERE PRD.PRD_PRN LIKE '" & Trim(Text3) & "%' AND INV.TXN_TYP LIKE 'RSI' AND INV.PRD_IDY LIKE PRD.PRD_IDY AND INV_IDY LIKE '" & Trim(m_van_idy) & "' AND STK_TYP IN('Free','Salable')", con, adOpenKeyset
    End If
    ...
    If REC_SET.RecordCount > 0 Then
        For A = 1 To REC_SET.RecordCount
            ...
            If QTY(VANCONQTY(REC_SET("PRD_QTY"), REC_SET("prd_idy"), Trim(m_van_idy))) <> 0 Then
                ls.ListSubItems.Add , , QTY(VANCONQTY(REC_SET("PRD_QTY"), REC_SET("prd_idy"), Trim(m_van_idy)))
            Else
