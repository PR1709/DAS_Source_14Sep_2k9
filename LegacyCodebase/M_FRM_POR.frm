...
Begin VB.Form M_FRM_POR 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      ForeColor       =   8388608
      TabCaption(0)   =   "Purchase &Order Details"
      TabPicture(0)   =   "M_FRM_POR.frx":0442
      ...
      TabPicture(1)   =   "M_FRM_POR.frx":045E
      ...
      TabPicture(2)   =   "M_FRM_POR.frx":047A
      ...
      TabPicture(3)   =   "M_FRM_POR.frx":0496
      ...
      TabCaption(4)   =   "View"
      TabPicture(4)   =   "M_FRM_POR.frx":04B2
      ...
      Begin VB.ListBox List6 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRM_POR.frx":04CE
         Left            =   -72960
         List            =   "M_FRM_POR.frx":04E4
         TabIndex        =   27
         TabStop         =   0   'False
         Top             =   720
         Visible         =   0   'False
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_POR.frx":051C
            Key             =   "p"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_POR.frx":0A60
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_POR.frx":0E28
            Key             =   "c"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_POR.frx":117C
            Key             =   "e"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_POR.frx":17B4
            Key             =   "s"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_POR.frx":1B08
            Key             =   "h"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_POR.frx":1F68
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_POR.frx":225C
            Key             =   "pr"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_POR.frx":2668
            Key             =   "d"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_POR.frx":2774
            Key             =   "pre"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_POR.frx":2AC8
            Key             =   "brw"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_POR.frx":2EDC
            Key             =   "cpy"
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_FRM_POR.frx":3428
            Key             =   ""
         EndProperty
      EndProperty
   End
...
'    MsgBox "Purchase Account Not Found, Define Purchase Account!", vbCritical, "DAS Version 4.0"
'    M_ACT_IDY.SetFocus
'    SSTab1.Tab = 0
'    Exit Sub
'End If
...
'    MsgBox "Reference Supplier Document Number Required!", vbInformation, "DAS Version 4.0"
'    M_PUR_IDY.SetFocus
'    SSTab1.Tab = 0
'    Exit Sub
'End If
...
If Val(T_NET_AMT) < 0 Then
    MsgBox "Can't Save this Purchase Order, NetAmount is Invalid!", vbCritical, "DAS Version 4.0"
    SSTab1.Tab = 2
    M_EXD_AMT.SetFocus
    Exit Sub
End If
...
If MOD_REC = True Then
    If Check3.Value = 1 Then
        ...
        REC_SET.Open "select * from inv where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ like 'PPO'", con, adOpenKeyset
        ...
        Next
    End If
    TxnMoveBackup "INV", "BNV", Trim(M_INV_IDY), "PPO"
    TxnMoveBackup "INL", "BNL", Trim(M_INV_IDY), "PPO"
    
    con.Execute "delete from inv where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ like 'PPO'"
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from inl where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ like 'PPO'", con, adOpenKeyset, adLockPessimistic
    INC = Trim(M_INV_IDY)
Else
    REC_SET.Open "select * from inl where inv_idy = ''", con, adOpenKeyset, adLockPessimistic
    REC_SET.AddNew
    REC_SET("inv_idy") = "PPO" & T7increment("IDY_PPO")
    INC = REC_SET("inv_idy")
    INVIDY = INC
End If
...
If MOD_REC = True Then
    TxnMoveBackup "PNV", "XNV", Trim(INC), "PPO"
    TxnMoveBackup "PNL", "XNL", Trim(INC), "PPO"
...
Next
'pnv update close
'AddShells Trim(INC), "PPO", M_SUP_IDY, "Y", "", ""
If MOD_REC = False Then MsgBox "New Purchase Order ID is " & INC, vbExclamation, "DAS Version 4.0"
If check("PRT", "PRT_NME", "PPO_SHL") Then LOADSHELLS "PPO", Trim(INC)
Label23 = labdisp("IDY_PPO")
If check("PRT", "PRT_NME", "M_FRM_POR") = True Then
    con.Execute "update dir where dir_idy like 'INV' AND DIR_IDX LIKE 'NUM' set dir_als = '" & INC & "'"
    con.Execute "update dir where dir_idy like 'DOC' AND DIR_IDX LIKE 'TYP' set dir_als = 'PPO'"
    If querycheck("DIR", "DIR_MSG", "D", "AND DIR_IDY LIKE 'SYS' AND DIR_IDX LIKE 'DOS'") = True Then
        If REC_PNL.State = 1 Then REC_PNL.Close
        REC_PNL.Open "SELECT * FROM RRI WHERE RI_REPORT LIKE 'Purchase Order Note'", PNL, adOpenKeyset, adLockPessimistic
        ...
        Else
        OpenDocument CURDIR & "\DOS_VCH.RP1", "Purchase Order Note", 2, Trim(INC), Trim(INC), 6, CURDIR & "\pnv.cdx,c,inv_idy"
    End If
    CANCELRECORD
End If
REC_SET.Close
...
M_MDI.STS_BAR.Panels(1).Text = "Enter Supplier Document Reference Number"
End Sub
...
If KeyAscii = 13 Then
    For A = 1 To MS.Rows - 1
        If MS.TextMatrix(MS.Row, 13) = MS.TextMatrix(A, 13) And Trim(List6) = MS.TextMatrix(A, 21) Then
            SSTab1.Tab = 1
            list4.Visible = False
            MsgBox "Product Already Exists In Purchase Order By this Type !", vbExclamation, "DAS Version 4.0"
            Text3.Visible = False
            MS.SetFocus
            MS.Col = 0
            MS.Row = A
...
If Check1.Value = 1 Then
    If DateDayCls = Date Then
       REC_SET.Open "select inl.inv_idy,inl.inv_dat,inl.ord_idy,act.act_nme,act.act_ad4 from act,inl where act_nme like '" & Trim(M_INV_IDY) & "%' and inl.cst_idy=act.act_idy and inl.txn_typ ='PPO'", con, adOpenKeyset, adLockPessimistic
    Else
       REC_SET.Open "select inl.inv_idy,inl.inv_dat,inl.ord_idy,act.act_nme,act.act_ad4 from act,inl where act_nme like '" & Trim(M_INV_IDY) & "%' and inl.cst_idy=act.act_idy and inl.txn_typ ='PPO' and INL.INV_DAT > CTOD('" & DateDayCls & "')", con, adOpenKeyset, adLockPessimistic
    End If
Else
    If DateDayCls = Date Then
       REC_SET.Open "select inl.inv_idy,inl.inv_dat,inl.ord_idy,act.act_nme,act.act_ad4 from act,inl where act_ad4 like '" & Trim(M_INV_IDY) & "%' and inl.cst_idy=act.act_idy and inl.txn_typ ='PPO'", con, adOpenKeyset, adLockPessimistic
    Else
       REC_SET.Open "select inl.inv_idy,inl.inv_dat,inl.ord_idy,act.act_nme,act.act_ad4 from act,inl where act_ad4 like '" & Trim(M_INV_IDY) & "%' and inl.cst_idy=act.act_idy and inl.txn_typ ='PPO' and INL.INV_DAT > CTOD('" & DateDayCls & "')", con, adOpenKeyset, adLockPessimistic
    End If
End If
...
If REC_SET.RecordCount > 0 Then
    ...
    Next
    SSTab1.Tab = 4
    Label49 = "Select Purchase Order"
    list5.Visible = True
    list5.SetFocus
Else
    If SSTab1.Tab = 0 Then
        MsgBox "Purchase Order Number Not Found!", vbInformation, "DAS Version 4.0"
        SSTab1.Tab = 0
        M_INV_IDY.Enabled = True
        SendKeys "{HOME}+{END}"
        M_INV_IDY.SetFocus
...
If KeyCode > 111 And KeyCode < 120 Then If TypeOf M_FRM_POR.ActiveControl Is TextBox Then M_FRM_POR.ActiveControl.Text = FUNKEY(KeyCode)
If list1.Visible = False And List2.Visible = False And list3.Visible = False And list4.Visible = False And list5.Visible = False Then
    ...
    If KeyCode = 69 And Shift = 2 Then
        If M_FRM_POR.ActiveControl.name = "M_INV_IDY" Then
            V_INV_LST
        ElseIf M_FRM_POR.ActiveControl.name = "M_SUP_IDY" Then
            V_SUP_LST
        ElseIf M_FRM_POR.ActiveControl.name = "M_SMN_IDY" Then
            V_SMN_LST
        ElseIf M_FRM_POR.ActiveControl.name = "M_ACT_IDY" Then
            V_ACT_LST
        ElseIf M_FRM_POR.ActiveControl.name = "Text3" Then
            V_PRD_LST
        End If
    End If
End If
...
M_MDI.STS_BAR.Panels(1).Text = "Press Ctrl+N to Generate New Purchase ID by System, Press <Enter> to View Existing Purchase Orders"
End Sub
...
ElseIf Label49.Caption = "Select Supplier" Then
    V_SUP_LST
ElseIf Label49.Caption = "Select Purchase Order" Then
    V_INV_LST
...
ElseIf Button.KEY = "ed" Then
    ...
    ElseIf M_FRM_POR.ActiveControl.name = "M_ACT_IDY" Then
        Label49 = "Select Account"
        V_ACT_LST
    ElseIf M_FRM_POR.ActiveControl.name = "Text3" Or (MS.Col = 0 And SSTab1.Tab = 1) Then
        V_PRD_LST
    End If
...
If CHECKTB("prt.dbf") = 1 Then
        ...
        Exit Sub
End If
If check("prt", "prt_nme", "M_FRM_POR") = False Then
Check3.Value = 0
Else
Check3.Value = 1
End If
...
REC_SET.Open "select * from inl where inv_idy like 'PPO" & Tincrement(Trim(M_INV_IDY)) & "' and txn_typ like 'PPO'", con, adOpenKeyset
Else
REC_SET.Open "select * from inl where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ like 'PPO'", con, adOpenKeyset
End If
If REC_SET.RecordCount > 0 Then
    If Len(Trim(M_INV_IDY)) <> 10 Then
    M_INV_IDY = "PPO" & Tincrement(Trim(M_INV_IDY))
    End If
    ...
    End If
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from inv where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ = 'PPO'", con, adOpenKeyset, adLockPessimistic
...
ElseIf K = 13 Then
    If MS.Col = 1 Then                                                  'QUANTIY
        ...
        If Trim(M_INV_IDY) <> "" Then
            REC_SET2.Open "select PRD_QTY from inv where BAT_idy like '" & Trim(MS.TextMatrix(MS.Row, 13)) & "' and inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ like 'PPO'", con, adOpenKeyset, adLockPessimistic
            If REC_SET2.RecordCount > 0 Then
...
For A = 1 To MS.Rows - 1
    If Trim(BATID) = MS.TextMatrix(A, 13) And "Salable" = MS.TextMatrix(A, 21) Then
        SSTab1.Tab = 1
        list4.Visible = False
        MsgBox "Product Already Exists In Purchase Order!", vbInformation, "DAS Version 4.0"
        Text3.Visible = False
        MS.SetFocus
        MS.Col = 0
        MS.Row = A
...
Dim REC_SET As New ADODB.Recordset
If REC_SET.State = 1 Then REC_SET.Close
REC_SET.Open "select rou_off from inl where inv_idy like '" & Trim(M_INV_IDY) & "' AND TXN_TYP LIKE 'PPO'", con, adOpenKeyset, adLockPessimistic
