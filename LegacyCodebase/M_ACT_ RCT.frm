...
Begin VB.Form M_ACT_RCT 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(0).Control(7)=   "M_TXN_DAT"
      Tab(0).Control(7).Enabled=   0   'False
      Tab(0).Control(8)=   "M_DBT_IDY"
      Tab(0).Control(8).Enabled=   0   'False
      Tab(0).Control(9)=   "M_TXN_IDY"
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_ACT_ RCT.frx":0442
            Key             =   "p"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_ACT_ RCT.frx":0986
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_ACT_ RCT.frx":0D4E
            Key             =   "c"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_ACT_ RCT.frx":10A2
            Key             =   "e"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_ACT_ RCT.frx":16DA
            Key             =   "s"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_ACT_ RCT.frx":1A2E
            Key             =   "h"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_ACT_ RCT.frx":1E8E
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_ACT_ RCT.frx":2182
            Key             =   "pr"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_ACT_ RCT.frx":258E
            Key             =   "d"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_ACT_ RCT.frx":269A
            Key             =   "pre"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_ACT_ RCT.frx":29EE
            Key             =   "brw"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_ACT_ RCT.frx":2E02
            Key             =   "cpy"
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "M_ACT_ RCT.frx":334E
            Key             =   ""
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "M_ACT_RCT"
...
If check("PRT", "PRT_NME", "M_ACT_CRT") = True Then
    ...
    MDIForm1.RRReport1.ReportName = App.Path & "\CRT VOUCHER.RRW"
...
MDIForm1.sb.Panels(1).Text = "Select Date using UP or DOWN ARROW KEYS"
End Sub
...
If KeyAscii = 27 Then
    If M_ACT_RCT.ActiveControl.name = "M_TXN_IDY" And Trim(M_TXN_IDY.Text) = "" Then
    Unload Me
    Exit Sub
    End If
...
If MS.Col = 3 Then
    ...
    Next
    MDIForm1.sb.Panels(1).Text = "Enter Clearings 'Y' or 'N'"
ElseIf MS.Col = 0 Then
    MDIForm1.sb.Panels(1).Text = "Enter or Select Account"
ElseIf MS.Col = 2 Then
    MDIForm1.sb.Panels(1).Text = "Enter Amount"
ElseIf MS.Col = 4 Then
    MDIForm1.sb.Panels(1).Text = "Select Clearing Date Using Arrow Keys or Press F4"
ElseIf MS.Col = 5 Then
    MDIForm1.sb.Panels(1).Text = "Enter Remarks"
End If
End Sub
...
MDIForm1.sb.Panels(1).Text = "Enter Voucher Number"
End Sub
...
If REC_SET.State = 1 Then REC_SET.Close
    If Len(Trim(M_TXN_IDY)) <> 0 Then
        REC_SET.Open "select * from vch where txn_idy like 'CRT" & Tincrement(M_TXN_IDY) & "' and txn_typ='CRV'", con, adOpenStatic
        If REC_SET.RecordCount > 0 Then
            Label7 = "0"
            Label9 = "0"
            MOD_REC = True
...
MDIForm1.sb.Panels(1).Text = "Enter or Select Cash Account"
End Sub
...
prefix.Caption = "Prefix Cash Receipts"
prefix.Show 1
