...
Begin VB.Form M_FRE_LSL 
   BackColor       =   &H8000000A&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Sales - User Bill Serial"
   ClientHeight    =   5625
   ClientLeft      =   1425
   ClientTop       =   1845
   ClientWidth     =   8820
   ForeColor       =   &H00FFFFFF&
   Icon            =   "M_FRE_LSL.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin MSComctlLib.Toolbar Toolbar1 
      ...
      Begin VB.ListBox text1 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRE_LSL.frx":0442
         Left            =   6960
         List            =   "M_FRE_LSL.frx":045B
         TabIndex        =   106
         TabStop         =   0   'False
         Top             =   50
         Visible         =   0   'False
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "M_FRE_LSL.frx":049F
      ...
      TabPicture(1)   =   "M_FRE_LSL.frx":04BB
      ...
      TabPicture(2)   =   "M_FRE_LSL.frx":04D7
      ...
      TabPicture(3)   =   "M_FRE_LSL.frx":04F3
      ...
      TabCaption(4)   =   "View"
      TabPicture(4)   =   "M_FRE_LSL.frx":050F
      ...
      Begin VB.ListBox List6 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRE_LSL.frx":052B
         Left            =   -72960
         List            =   "M_FRE_LSL.frx":0538
         TabIndex        =   67
         TabStop         =   0   'False
         Top             =   720
         Visible         =   0   'False
      ...
      Begin VB.ListBox M_ROU_IDY 
         ...
         EndProperty
         Height          =   270
         ItemData        =   "M_FRE_LSL.frx":0545
         Left            =   -70080
         List            =   "M_FRE_LSL.frx":05B5
         TabIndex        =   63
         TabStop         =   0   'False
         Top             =   2640
         Width           =   495
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_LSL.frx":0625
               Key             =   "p"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_LSL.frx":0B69
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_LSL.frx":0F31
               Key             =   "c"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_LSL.frx":1285
               Key             =   "e"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_LSL.frx":18BD
               Key             =   "s"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_LSL.frx":1C11
               Key             =   "h"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_LSL.frx":2071
               Key             =   ""
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_LSL.frx":2365
               Key             =   "pr"
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_LSL.frx":2771
               Key             =   "d"
            EndProperty
            BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_LSL.frx":287D
               Key             =   "pre"
            EndProperty
            BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_LSL.frx":2BD1
               Key             =   "brw"
            EndProperty
            BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_LSL.frx":2FE5
               Key             =   "cpy"
            EndProperty
            BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_FRE_LSL.frx":3531
               Key             =   ""
            EndProperty
         EndProperty
      End
...
If MOD_REC = True Then
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from inv where inv_idy like '" & (M_INV_IDY) & "' and txn_typ IN('SAL','LSL') AND LEN(TRIM(ORD_IDY))<>10", con, adOpenKeyset
    ...
    Next
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from inv where inv_idy like '" & (M_INV_IDY) & "' and txn_typ IN('FRC','FRS') AND LEN(TRIM(ORD_IDY))<>10", con, adOpenKeyset
    For A = 1 To REC_SET.RecordCount
        con.Execute "update prd where prd_idy like '" & REC_SET("prd_idy") & "' set cur_lev = " & ADDQTY(Val(REC_SET("prd_qty")), REC_SET("prd_idy"))
        REC_SET.MoveNext
    Next
    con.Execute "delete from inv where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ IN('SAL','LSL') AND LEN(TRIM(ORD_IDY))<>10"
    con.Execute "delete from inv where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ IN('FRS','FRC') AND LEN(TRIM(ORD_IDY))<>10"
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from inl where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ IN('SAL','LSL')", con, adOpenKeyset, adLockOptimistic
    INC = Trim(M_INV_IDY)
Else
...
For A = 1 To MS.Rows - 1
    If Trim(MS.TextMatrix(A, 0)) <> "" And (Val(Trim(MS.TextMatrix(A, 3))) <> "0.000" Or Val(Trim(MS.TextMatrix(A, 13))) > 0) Then
        ...
        Else
            REC_SET("rat_app") = "A"
        End If
        If Trim(MS.TextMatrix(A, 7)) <> "" Then
            REC_SET("sch_amt") = MS.TextMatrix(A, 7)
        Else
            REC_SET("SCH_AMT") = "0.00"
        End If
        ...
        REC_SET1.Open "SELECT SUB_UNT,SAL_RAT FROM PRD WHERE PRD_IDY LIKE '" & Trim(MS.TextMatrix(A, 0)) & "'", con, adOpenKeyset, adLockOptimistic
...
'        REC_SET("ADD_AMT") = (PRDNET * Val(MS.TextMatrix(A, 7)) / 100)
        ...
        If Val(MS.TextMatrix(A, 13)) <> 0 Then
            ...
            REC_SET("txn_typ") = "FRS"
            REC_SET.Update
            con.Execute "update prd where prd_idy like '" & Trim(MS.TextMatrix(A, 0)) & "' set cur_lev = " & CONQTY(Trim(MS.TextMatrix(A, 13)), Trim(MS.TextMatrix(A, 0)))
        End If
    End If
Next
If check("PRT", "PRT_NME", "M_FRE_LSL") = True Then
    ...
    Openscopereport CURDIR & "\VOUCH.RP1", "INVOICE", 2, 2, Trim(INC), Trim(INC), "INV->INV_IDY='" & Trim(INC) & "'", 2
    'Openreport CURDIR & "\VOUCH.RP1", "INVOICE", 2, "INV->INV_IDY='" & Trim(INC) & "'", 0
    Cancelrecord
End If
Cancelrecord
End Sub
...
If k = 13 Or k = 40 Or k = 38 Then
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from act where act_idy like '" & Sincrement(M_CST_IDY) & "' AND (ACT_TYP LIKE 'BOT' OR ACT_TYP LIKE 'SAL') AND DBT_TYP='Y'", con, adOpenKeyset, adLockOptimistic
    If REC_SET.RecordCount > 0 Then
        ...
        If MOD_REC = False Then If REC_SET1.RecordCount > 0 Then M_SMN_NME = Trim(REC_SET1("smn_nme"))
...
If REC_SET.State = 1 Then REC_SET.Close
If Check1.Value = 1 Then
    REC_SET.Open "select inl.inv_idy,inl.inv_dat,act.act_nme,act.act_ad4 from act,inl where act_nme like '" & Trim(M_INV_IDY) & "%' and inl.cst_idy=act.act_idy and inl.txn_typ in ('SAL','LSL') and len(trim(ord_idy))<>10", con, adOpenKeyset, adLockOptimistic
Else
    REC_SET.Open "select inl.inv_idy,inl.inv_dat,act.act_nme,act.act_ad4 from act,inl where act_ad4 like '" & Trim(M_INV_IDY) & "%' and inl.cst_idy=act.act_idy and inl.txn_typ IN ('SAL','LSL') and len(trim(ord_idy))<>10", con, adOpenKeyset, adLockOptimistic
End If
...
Else
    If SSTab1.Tab = 0 Then
        If MsgBox("Create New Invoice?", vbQuestion + vbYesNo, "Effmcg") = vbYes Then
            SSTab1.Tab = 0
...
If list1.Visible = False And List2.Visible = False And list3.Visible = False And list4.Visible = False And list5.Visible = False Then
    ...
    If KeyCode = 69 And Shift = 2 Then
        If M_FRE_LSL.ActiveControl.name = "M_INV_IDY" Then
            V_INV_LST
        ElseIf M_FRE_LSL.ActiveControl.name = "M_CST_IDY" Then
            V_DLR_LST
        ElseIf M_FRE_LSL.ActiveControl.name = "M_SMN_IDY" Then
            V_SMN_LST
        ElseIf M_FRE_LSL.ActiveControl.name = "M_ACT_IDY" Then
            V_ACT_LST
        ElseIf M_FRE_LSL.ActiveControl.name = "Text3" Then
            V_PRD_LST
        End If
    End If
End If
If KeyCode > 111 And KeyCode < 120 Then If TypeOf M_FRE_LSL.ActiveControl Is TextBox Then M_FRE_LSL.ActiveControl.Text = FUNKEY(KeyCode)
End Sub
...
ElseIf Button.KEY = "ed" Then
    ...
    ElseIf M_FRE_LSL.ActiveControl.name = "M_ACT_IDY" Then
        V_LST_CAP = "Select Account"
        V_ACT_LST
    ElseIf M_FRE_LSL.ActiveControl.name = "Text3" Or (MS.Col = 0 And SSTab1.Tab = 1) Then
        V_PRD_LST
    End If
...
If check("prt", "prt_nme", "m_fre_lsl") = False Then
Check3.Value = 0
Else
Check3.Value = 1
End If
...
If REC_SET.State = 1 Then REC_SET.Close
REC_SET.Open "select * from inl where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ in('SAL','LSL') AND LEN(TRIM(ORD_IDY)) <> 10 AND SUBSTR(ORD_IDY,1,3) NOT IN('SAL','RSI')", con, adOpenKeyset
If REC_SET.RecordCount > 0 Then
    ...
    End If
    If REC_SET.State = 1 Then REC_SET.Close
    REC_SET.Open "select * from inv where inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ in('SAL','LSL') AND LEN(TRIM(ORD_IDY))<>10", con, adOpenKeyset, adLockOptimistic
    ...
    For A = 1 To MS.Rows - 1
        ...
        End If
        If REC_SET2.State = 1 Then REC_SET2.Close
        REC_SET2.Open "SELECT * FROM INV WHERE INV_IDY LIKE '" & M_INV_IDY & "' AND PRD_IDY LIKE '" & Trim(REC_SET("PRD_IDY")) & "' AND TXN_TYP IN('FRC','FRS') AND LEN(TRIM(ORD_IDY))<>10", con, adOpenKeyset, adLockOptimistic
        If REC_SET2.RecordCount > 0 Then
...
ElseIf k = 13 Then
    If MS.Col = 3 Then
        ...
        If MOD_REC = True Then
            REC_SET2.Open "select * from inv where PRD_IDY LIKE '" & Trim(MS.TextMatrix(MS.Row, 0)) & "' and inv_idy like '" & Trim(M_INV_IDY) & "' and txn_typ IN('LSL','SAL','FRS','FRC') AND LEN(TRIM(ORD_IDY))<>10", con, adOpenKeyset, adLockOptimistic
            For A = 1 To REC_SET2.RecordCount
                INVTOT = Val(INVTOT) + Val(P_SUB_UNT(QTY(REC_SET2!PRD_QTY), REC_SET!SUB_UNT))
                REC_SET2.MoveNext
            Next
            INVTOT = P_QTY_UNT(Val(INVTOT), REC_SET!SUB_UNT)
        End If
        B = InStr(M_FLX_AMT, ".")
        ...
        If B > 0 And Val(REC_SET("sub_unt")) > 0 Then
            ...
            Else
                ...
                M_QTY = STM(Val(F_S_UNT) + Val(M_S_UNT), REC_SET("SUB_UNT"))
            End If
        Else
            F_S_UNT = MTS(Val(MS.TextMatrix(MS.Row, 13)), REC_SET("SUB_UNT"))
            M_S_UNT = MTS(Val(M_FLX_AMT), REC_SET("SUB_UNT"))
...
'    MS.TextMatrix(MS.Row, 7) = REC_SET("sch_amt") & ""
...
Dim REC_SET As New ADODB.Recordset
If REC_SET.State = 1 Then REC_SET.Close
REC_SET.Open "select rou_off from inl where inv_idy like '" & Trim(M_INV_IDY) & "' AND TXN_TYP IN('SAL','LSL')", con, adOpenKeyset, adLockOptimistic
